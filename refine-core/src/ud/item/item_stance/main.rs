...
impl UStance {
    pub(crate) fn new(item_id: ItemId, type_aid: AItemId, fit_uid: UFitId, stance_state: bool, r_data: &RData) -> Self {
        Self {
            base: UItemBase::new(item_id, type_aid, bool_to_state_offline(stance_state), r_data),
            fit_uid,
        }
    }
...
impl UStance {
    ...
    pub(crate) fn set_stance_state(&mut self, state: bool) {
