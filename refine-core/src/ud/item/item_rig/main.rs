...
impl URig {
    pub(crate) fn new(item_id: ItemId, type_aid: AItemId, fit_uid: UFitId, rig_state: bool, r_data: &RData) -> Self {
        Self {
            base: UItemBase::new(item_id, type_aid, bool_to_state_offline(rig_state), r_data),
            fit_uid,
        }
    }
