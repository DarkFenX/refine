...
pub(crate) struct RAttrConsts {
    ...
    pub(crate) breacher_pod_dmg_resist: Option<RAttrId>,
    pub(crate) can_cloak: Option<RAttrId>,
    ...
    pub(crate) cap_need_bonus: Option<RAttrId>,
    ...
    pub(crate) conduit_jump_drive_consumption_amount: Option<RAttrId>,
    pub(crate) conduit_jump_passenger_count: Option<RAttrId>,
    ...
    pub(crate) disallow_cloaking: Option<RAttrId>,
    pub(crate) disallow_docking: Option<RAttrId>,
    pub(crate) disallow_drive_jumping: Option<RAttrId>,
    pub(crate) disallow_drive_jumping_only: Option<RAttrId>,
    ...
    pub(crate) disallow_repeating_activation: Option<RAttrId>,
    pub(crate) disallow_tethering: Option<RAttrId>,
    pub(crate) disallow_vs_ew_immune_tgt: Option<RAttrId>,
    pub(crate) disallow_warping: Option<RAttrId>,
    ...
    pub(crate) doomsday_dmg_radius: Option<RAttrId>,
    ...
    pub(crate) enable_open_jump_portal: Option<RAttrId>,
    pub(crate) enable_perform_conduit_jump: Option<RAttrId>,
    ...
    pub(crate) ftr_abil_atk_missile_dmg_em: Option<RAttrId>,
    pub(crate) ftr_abil_atk_missile_dmg_expl: Option<RAttrId>,
    ...
    pub(crate) ftr_abil_kamikaze_dmg_therm: Option<RAttrId>,
    pub(crate) ftr_abil_kamikaze_range: Option<RAttrId>,
    pub(crate) ftr_abil_kamikaze_sig_radius: Option<RAttrId>,
...
impl RAttrConsts {
    pub(in crate::rd::data) fn from_id_map(attr_aid_rid_map: &RMap<AAttrId, RAttrId>) -> Self {
        ...
        Self {
            ...
            breacher_pod_dmg_resist: attr_aid_rid_map.get(&AAttrId::BREACHER_POD_DMG_RESIST).copied(),
            can_cloak: attr_aid_rid_map.get(&AAttrId::CAN_CLOAK).copied(),
            ...
            cap_need_bonus: attr_aid_rid_map.get(&AAttrId::CAP_NEED_BONUS).copied(),
            ...
            conduit_jump_drive_consumption_amount: attr_aid_rid_map
                .get(&AAttrId::CONDUIT_JUMP_DRIVE_CONSUMPTION_AMOUNT)
                .copied(),
            conduit_jump_passenger_count: attr_aid_rid_map.get(&AAttrId::CONDUIT_JUMP_PASSENGER_COUNT).copied(),
            ...
            disallow_cloaking: attr_aid_rid_map.get(&AAttrId::DISALLOW_CLOAKING).copied(),
            ...
            disallow_drive_jumping_only: attr_aid_rid_map.get(&AAttrId::DISALLOW_DRIVE_JUMPING_ONLY).copied(),
            ...
            disallow_repeating_activation: attr_aid_rid_map.get(&AAttrId::DISALLOW_REPEATING_ACTIVATION).copied(),
            ...
            disallow_warping: attr_aid_rid_map.get(&AAttrId::DISALLOW_WARPING).copied(),
            ...
            doomsday_dmg_radius: attr_aid_rid_map.get(&AAttrId::DOOMSDAY_DMG_RADIUS).copied(),
            ...
            enable_open_jump_portal: attr_aid_rid_map.get(&AAttrId::ENABLE_OPEN_JUMP_PORTAL).copied(),
            enable_perform_conduit_jump: attr_aid_rid_map.get(&AAttrId::ENABLE_PERFORM_CONDUIT_JUMP).copied(),
            ...
            ftr_abil_atk_missile_dmg_em: attr_aid_rid_map.get(&AAttrId::FTR_ABIL_ATK_MISSILE_DMG_EM).copied(),
            ftr_abil_atk_missile_dmg_expl: attr_aid_rid_map.get(&AAttrId::FTR_ABIL_ATK_MISSILE_DMG_EXPL).copied(),
            ...
            ftr_abil_kamikaze_dmg_therm: attr_aid_rid_map.get(&AAttrId::FTR_ABIL_KAMIKAZE_DMG_THERM).copied(),
            ftr_abil_kamikaze_range: attr_aid_rid_map.get(&AAttrId::FTR_ABIL_KAMIKAZE_RANGE).copied(),
            ftr_abil_kamikaze_sig_radius: attr_aid_rid_map.get(&AAttrId::FTR_ABIL_KAMIKAZE_SIG_RADIUS).copied(),
