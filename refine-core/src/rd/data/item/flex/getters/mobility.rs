...
pub(in crate::rd::data::item::flex) fn get_is_mobile(
...
pub(in crate::rd::data::item::flex) fn get_entity_has_mwd(
    item_attrs: &RMap<RAttrId, Value>,
    attr_consts: &RAttrConsts,
) -> bool {
    match attr_consts
...
pub(in crate::rd::data::item::flex) fn get_jump_fuel_type_id(
    item_attrs: &RMap<RAttrId, Value>,
    attr_consts: &RAttrConsts,
) -> Option<AItemId> {
    attr_consts
...
pub(in crate::rd::data::item::flex) fn get_enables_conduit(
    item_attrs: &RMap<RAttrId, Value>,
    attr_consts: &RAttrConsts,
) -> bool {
...
pub(in crate::rd::data::item::flex) fn get_enables_portal(
    item_attrs: &RMap<RAttrId, Value>,
    attr_consts: &RAttrConsts,
) -> bool {
