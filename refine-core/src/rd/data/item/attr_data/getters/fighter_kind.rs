...
pub(in crate::rd::data::item::attr_data) fn get_light_fighter_flag(
...
pub(in crate::rd::data::item::attr_data) fn get_heavy_fighter_flag(
    item_attrs: &RMap<RAttrId, Value>,
    attr_consts: &RAttrConsts,
) -> bool {
...
pub(in crate::rd::data::item::attr_data) fn get_support_fighter_flag(
    item_attrs: &RMap<RAttrId, Value>,
    attr_consts: &RAttrConsts,
) -> bool {
...
pub(in crate::rd::data::item::attr_data) fn get_st_light_fighter_flag(
    item_attrs: &RMap<RAttrId, Value>,
    attr_consts: &RAttrConsts,
) -> bool {
...
pub(in crate::rd::data::item::attr_data) fn get_st_heavy_fighter_flag(
    item_attrs: &RMap<RAttrId, Value>,
    attr_consts: &RAttrConsts,
) -> bool {
...
pub(in crate::rd::data::item::attr_data) fn get_st_support_fighter_flag(
    item_attrs: &RMap<RAttrId, Value>,
    attr_consts: &RAttrConsts,
) -> bool {
