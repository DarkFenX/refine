...
pub(in crate::svc) struct VastFitData {
    ...
    pub(in crate::svc::vast) mods_active_block_cloak: RSet<UItemId>,
    pub(in crate::svc::vast) mods_active_block_in_assist: RSet<UItemId>,
...
impl VastFitData {
    pub(in crate::svc) fn new() -> Self {
        Self {
            ...
            mods_active_block_cloak: RSet::new(),
            mods_active_block_in_assist: RSet::new(),
