...
fn get_raw_mattr(sol: &SolarSystem, item_uid: UItemId, attr_aid: AAttrId) -> Result<RawMAttr<'_>, RawMAttrGetError> {
    match sol
        .u_data
        .items
        .get(item_uid)
        ...
        .get(&attr_aid)
    {
        ...
        None => Err(RawMAttrGetError::MutationNotFound(
...
fn get_raw_mattr_mut(
    ...
    item_uid: UItemId,
    attr_aid: AAttrId,
) -> Result<RawMAttrMut<'_>, RawMAttrGetError> {
    match sol
        .u_data
        .items
        .get(item_uid)
