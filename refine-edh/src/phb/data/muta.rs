...
impl KeyMergeTwo<rc::ed::EMutaItem, rc::ed::EMutaAttr> for PMuta {
    fn key_merge(self, key: Key, merged1: &mut Vec<rc::ed::EMutaItem>, merged2: &mut Vec<rc::ed::EMutaAttr>) {
        merged1.extend(self.input_output_mapping.into_iter().flat_map(|item_map| {
            item_map
                .applicable_types
                .into_iter()
