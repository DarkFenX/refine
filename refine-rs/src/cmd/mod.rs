pub use fit::{
    ...
    FitAddFwEffectCmd, FitAddImplantCmd, FitAddModuleCmd, FitAddRigCmd, FitAddServiceCmd, FitChangeAutochargeCmd,
    ...
    FitChangeServiceCmd, FitChangeShipCmd, FitRemoveItemCmd, FitSetCharacterCmd, FitSetShipCmd, FitUnsetCharacterCmd,
    FitUnsetShipCmd, RemoveFitCmd,
};
...
pub use inner::{
    ...
    FitChangeCharacterError, FitChangeFitError, FitChangeShipError, FleetChangeFleetError, GetFitAddBoosterError,
    GetFitAddDroneError, GetFitAddFighterError, GetFitAddFwEffectError, GetFitAddImplantError, GetFitAddModuleError,
    GetFitAddRigError, GetFitAddServiceError, GetFitChangeCharacterError, GetFitChangeFitError, GetFitChangeShipError,
    GetFitRemoveFitError, GetFitSetCharacterError, GetFitSetShipError, GetFitUnsetCharacterError, GetFitUnsetShipError,
...
pub use item::{
    ...
    ItemAddServiceCmd, ItemChangeAutochargeCmd, ItemChangeBoosterCmd, ItemChangeCharacterCmd, ItemChangeChargeCmd,
    ItemChangeDroneCmd, ItemChangeFighterCmd, ItemChangeFwEffectCmd, ItemChangeImplantCmd, ItemChangeModuleCmd,
    ItemChangeProjEffectCmd, ItemChangeRigCmd, ItemChangeServiceCmd, ItemChangeShipCmd, ItemSetCharacterCmd,
    ItemSetShipCmd, RemoveItemCmd,
};
pub use shared::{
...
pub use sol::{
    ...
    SolAddModuleCmd, SolAddProjEffectCmd, SolAddRigCmd, SolAddServiceCmd, SolChangeAutochargeCmd, SolChangeBoosterCmd,
