use crate::cmd::{
    ChangeFitEnumCmd,
    inner::{ICmdModuleAddICtxBIds, ICmdModuleAddShared, ICmdModuleChangeFCtxBIds},
    shared::{AddMutation, ChangeMutation, ItemIdBackref},
};
...
impl FitAddModuleCmd {
    pub fn new(rack: rc::ModRack, add_mode: rc::AddMode, type_id: rc::ItemTypeId, state: rc::ModuleState) -> Self {
        Self {
