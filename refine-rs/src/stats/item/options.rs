...
#[derive(Clone)]
pub(in crate::stats) struct ItemStatsOptions<O: StatOptionKind> {
    // Output
...
impl<O> Default for ItemStatsOptions<O>
where
    O: StatOptionKind,
...
// Conversions
////////////////////////////////////////////////////////////////////////////////////////////////////
impl ItemStatsOptions<StatOptionRaw> {
    pub(in crate::stats) fn resolve(self, default: bool) -> ItemStatsOptions<StatOptionResolved> {
        ItemStatsOptions {
            // Output
