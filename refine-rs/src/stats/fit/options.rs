...
#[derive(Clone)]
pub(in crate::stats) struct FitStatsOptions<O: StatOptionKind> {
    // Fit output stats
...
impl<O> Default for FitStatsOptions<O>
where
    O: StatOptionKind,
...
// Conversions
////////////////////////////////////////////////////////////////////////////////////////////////////
impl FitStatsOptions<StatOptionRaw> {
    pub(in crate::stats) fn resolve(self, default: bool) -> FitStatsOptions<StatOptionResolved> {
        FitStatsOptions {
            // Fit output stats
