...
pub(in crate::ctl) struct ICmdChargeChangeFCtxBIds {
    pub(in crate::ctl) item_id: ItemIdBackref,
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub(in crate::ctl) ictx_cmd: ICmdChargeChangeICtx = ICmdChargeChangeICtx { .. },
}
...
#[cfg_attr(feature = "serde", derive(serde::Deserialize))]
pub(in crate::ctl) struct ICmdChargeChangeICtx {
...
impl ICmdChargeChangeFCtxBIds {
    pub(in crate::ctl) fn render(self, resps: &CtlCmdResps) -> Result<ICmdChargeChangeFCtxRIds, BackrefRenderError> {
