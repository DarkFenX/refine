...
pub(in crate::ctl) struct ICmdFitChangeFCtxBIds {
    pub(in crate::ctl) fit_id: FitIdBackref,
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub(in crate::ctl) ictx_cmd: ICmdFitChangeICtxBIds = ICmdFitChangeICtxBIds { .. },
}
...
#[cfg_attr(feature = "serde", derive(serde::Deserialize))]
pub(in crate::ctl) struct ICmdFitChangeICtxBIds {
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub(in crate::ctl) shared: CmdFitChangeShared = CmdFitChangeShared { .. },
    #[cfg_attr(feature = "serde", serde(default))]
    pub(in crate::ctl) fleet_id: TriStateField<FleetIdBackref> = TriStateField::Absent,
}
...
#[cfg_attr(feature = "serde", derive(serde::Deserialize))]
pub(in crate::ctl) struct CmdFitChangeShared {
    pub(in crate::ctl) sec_status: Option<FitSecStatus> = None,
    #[cfg_attr(feature = "serde", serde(default))]
    pub(in crate::ctl) rah_incoming_dps: TriStateField<DpsProfile> = TriStateField::Absent,
}
...
impl ICmdFitChangeFCtxBIds {
    pub(in crate::ctl) fn render(self, resps: &CtlCmdResps) -> Result<ICmdFitChangeFCtxRIds, BackrefRenderError> {
...
impl ICmdFitChangeICtxBIds {
    pub(in crate::ctl) fn render(self, resps: &CtlCmdResps) -> Result<ICmdFitChangeICtxRIds, BackrefRenderError> {
...
impl ICmdFitChangeFCtxRIds {
    pub(in crate::ctl) fn execute(self, core_sol: &mut rc::SolarSystem) -> Result<(), GetFitChangeFitError> {
...
impl From<FitChangeFitError> for GetFitChangeFitError {
    fn from(err: FitChangeFitError) -> Self {
        match err {
            FitChangeFitError::FleetSet(inner) => Self::FleetSet(inner),
        }
    }
}

impl ICmdFitChangeICtxRIds {
    pub(in crate::ctl) fn execute(self, core_fit: &mut rc::FitMut) -> Result<(), FitChangeFitError> {
        match self.fleet_id {
