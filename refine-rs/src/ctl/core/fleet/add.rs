use crate::{AddedFleetIdResp, CmdResps, FitId, FitIdBr, err::BackrefRenderError};
...
////////////////////////////////////////////////////////////////////////////////////////////////////
impl FleetAddCmdBr {
    pub(in crate::ctl) fn render(self, resps: &CmdResps) -> Result<FleetAddCmd, BackrefRenderError> {
        Ok(FleetAddCmd {
