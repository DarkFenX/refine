...
pub type RigChangeCmdCtxItem = RigChangeCmdCtxItemGen<ItemId>;
pub type RigChangeCmdCtxItemBr = RigChangeCmdCtxItemGen<ItemIdBr>;
...
#[derive(Clone)]
pub struct RigChangeCmdCtxItemGen<I> {
    item_id: I,
