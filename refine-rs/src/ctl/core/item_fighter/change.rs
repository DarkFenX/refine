...
#[cfg_attr(feature = "serde", derive(serde::Deserialize))]
pub(in crate::ctl) struct ICmdFighterChangeICtxBIds {
    #[cfg_attr(feature = "serde", serde(flatten))]
...
#[cfg_attr(feature = "serde", derive(serde::Deserialize))]
pub(in crate::ctl) struct ICmdFighterChangeShared {
    pub(in crate::ctl) type_id: Option<ItemTypeId> = None,
    pub(in crate::ctl) state: Option<MinionState> = None,
    #[cfg_attr(feature = "serde", serde(default))]
    pub(in crate::ctl) count: TriStateField<CountNz> = TriStateField::Absent,
    #[cfg_attr(feature = "serde", serde(default))]
    pub(in crate::ctl) abilities: Abilities = Abilities::new(),
    #[cfg_attr(feature = "serde", serde(default))]
    pub(in crate::ctl) rearm_minion: TriStateField<RearmMinion> = TriStateField::Absent,
...
impl ICmdFighterChangeFCtxBIds {
    pub(in crate::ctl) fn render(self, resps: &CtlCmdResps) -> Result<ICmdFighterChangeFCtxRIds, BackrefRenderError> {
