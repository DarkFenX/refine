use crate::{
    AddedItemIdsResp, CtlCmdResps, FitId, FitIdBackref, ItemTypeId, ServiceState, ctl::shared::EffectModes,
    err::BackrefRenderError,
};

// Commands with full context
#[cfg_attr(feature = "serde", derive(serde::Deserialize))]
pub(in crate::ctl) struct ICmdServiceAddFCtxBIds {
    pub(in crate::ctl) fit_id: FitIdBackref,
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub(in crate::ctl) ictx_cmd: ICmdServiceAddICtx,
}
#[cfg_attr(feature = "serde", derive(serde::Deserialize))]
...
pub(crate) struct ICmdServiceAddICtx {
    ...
    pub(in crate::ctl) state: ServiceState,
...
impl ICmdServiceAddFCtxBIds {
    pub(in crate::ctl) fn render(self, resps: &CtlCmdResps) -> Result<ICmdServiceAddFCtxRIds, BackrefRenderError> {
