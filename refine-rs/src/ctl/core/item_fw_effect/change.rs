...
pub(in crate::ctl) struct ICmdFwEffectChangeFCtxBIds {
    pub(in crate::ctl) item_id: ItemIdBackref,
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub(in crate::ctl) ictx_cmd: ICmdFwEffectChangeICtx = ICmdFwEffectChangeICtx { .. },
}
...
#[cfg_attr(feature = "serde", derive(serde::Deserialize))]
pub(in crate::ctl) struct ICmdFwEffectChangeICtx {
...
impl ICmdFwEffectChangeFCtxBIds {
    pub(in crate::ctl) fn render(self, resps: &CtlCmdResps) -> Result<ICmdFwEffectChangeFCtxRIds, BackrefRenderError> {
