...
pub type CharacterSetCmdCtxFit = CharacterSetCmdCtxFitGen<FitId>;
pub type CharacterSetCmdCtxFitBr = CharacterSetCmdCtxFitGen<FitIdBr>;
...
#[derive(Clone)]
pub struct CharacterSetCmdCtxFitGen<F> {
    fit_id: F,
