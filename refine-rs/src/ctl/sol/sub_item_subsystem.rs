use crate::{
    ...
    ctl::core::{ICmdSubsystemAddFCtxBIds, ICmdSubsystemAddICtx, ICmdSubsystemChangeFCtxBIds},
};
...
impl From<SolAddSubsystemCmd> for SolCtlCmd {
...
impl From<SolChangeSubsystemCmd> for SolCtlCmd {
