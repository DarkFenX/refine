...
use crate::{FitId, FleetId, FleetInfoMode, info::FleetInfoModesInt};
...
////////////////////////////////////////////////////////////////////////////////////////////////////
impl FleetInfo {
    pub(in crate::info) fn from_core(core_fleet: &mut rc::FleetMut, fleet_info_modes: &FleetInfoModesInt) -> Self {
