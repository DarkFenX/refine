use crate::{
    ...
    SwEffectInfo, shared::OvrdMapLight,
};
...
impl ItemInfo {
    ...
    fn from_core_charge(core_charge: &mut rc::ChargeMut, item_info_modes: &OvrdMapLight<ItemId, ItemInfoMode>) -> Self {
        Self::Charge(ChargeInfo::from_core(core_charge, item_info_modes))
    }
    fn from_core_drone(core_drone: &mut rc::DroneMut, item_info_modes: &OvrdMapLight<ItemId, ItemInfoMode>) -> Self {
    ...
    fn from_core_module(core_module: &mut rc::ModuleMut, item_info_modes: &OvrdMapLight<ItemId, ItemInfoMode>) -> Self {
        Self::Module(ModuleInfo::from_core(core_module, item_info_modes))
    }
    fn from_core_proj_effect(
        core_proj_effect: &mut rc::ProjEffectMut,
        item_info_modes: &OvrdMapLight<ItemId, ItemInfoMode>,
    ) -> Self {
        Self::ProjEffect(ProjEffectInfo::from_core(core_proj_effect, item_info_modes))
    }
    fn from_core_rig(core_rig: &mut rc::RigMut, item_info_modes: &OvrdMapLight<ItemId, ItemInfoMode>) -> Self {
    ...
    fn from_core_ship(core_ship: &mut rc::ShipMut, item_info_modes: &OvrdMapLight<ItemId, ItemInfoMode>) -> Self {
        Self::Ship(ShipInfo::from_core(core_ship, item_info_modes))
    }
    fn from_core_skill(core_skill: &mut rc::SkillMut, item_info_modes: &OvrdMapLight<ItemId, ItemInfoMode>) -> Self {
        Self::Skill(SkillInfo::from_core(core_skill, item_info_modes))
    }
    fn from_core_stance(core_stance: &mut rc::StanceMut, item_info_modes: &OvrdMapLight<ItemId, ItemInfoMode>) -> Self {
        Self::Stance(StanceInfo::from_core(core_stance, item_info_modes))
    }
    fn from_core_subsystem(
        core_subsystem: &mut rc::SubsystemMut,
        item_info_modes: &OvrdMapLight<ItemId, ItemInfoMode>,
    ) -> Self {
        Self::Subsystem(SubsystemInfo::from_core(core_subsystem, item_info_modes))
    }
    fn from_core_sw_effect(
