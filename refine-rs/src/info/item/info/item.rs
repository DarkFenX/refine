...
impl ItemInfo {
    ...
    fn from_core_charge(core_charge: &mut rc::ChargeMut, item_info_modes: &InfoModes<ItemInfoMode, ItemId>) -> Self {
    ...
    fn from_core_skill(core_skill: &mut rc::SkillMut, item_info_modes: &InfoModes<ItemInfoMode, ItemId>) -> Self {
        Self::Skill(SkillInfo::from_core(core_skill, item_info_modes))
    }
    fn from_core_stance(core_stance: &mut rc::StanceMut, item_info_modes: &InfoModes<ItemInfoMode, ItemId>) -> Self {
