...
impl ItemInfo {
    ...
    fn from_core_drone(core_drone: &mut rc::DroneMut, item_info_modes: &OverridableMap<ItemId, ItemInfoMode>) -> Self {
    ...
    fn from_core_rig(core_rig: &mut rc::RigMut, item_info_modes: &OverridableMap<ItemId, ItemInfoMode>) -> Self {
    ...
    fn from_core_ship(core_ship: &mut rc::ShipMut, item_info_modes: &OverridableMap<ItemId, ItemInfoMode>) -> Self {
        Self::Ship(ShipInfo::from_core(core_ship, item_info_modes))
    }
    fn from_core_skill(core_skill: &mut rc::SkillMut, item_info_modes: &OverridableMap<ItemId, ItemInfoMode>) -> Self {
