use crate::{
    ...
    SwEffectInfo, info::InfoModesInt,
};
...
impl ItemInfo {
    ...
    fn from_core_charge(core_charge: &mut rc::ChargeMut, item_info_modes: &InfoModesInt<ItemInfoMode, ItemId>) -> Self {
        Self::Charge(ChargeInfo::from_core(core_charge, item_info_modes))
    }
    fn from_core_drone(core_drone: &mut rc::DroneMut, item_info_modes: &InfoModesInt<ItemInfoMode, ItemId>) -> Self {
    ...
    fn from_core_module(core_module: &mut rc::ModuleMut, item_info_modes: &InfoModesInt<ItemInfoMode, ItemId>) -> Self {
    ...
    fn from_core_rig(core_rig: &mut rc::RigMut, item_info_modes: &InfoModesInt<ItemInfoMode, ItemId>) -> Self {
    ...
    fn from_core_ship(core_ship: &mut rc::ShipMut, item_info_modes: &InfoModesInt<ItemInfoMode, ItemId>) -> Self {
        Self::Ship(ShipInfo::from_core(core_ship, item_info_modes))
    }
    fn from_core_skill(core_skill: &mut rc::SkillMut, item_info_modes: &InfoModesInt<ItemInfoMode, ItemId>) -> Self {
        Self::Skill(SkillInfo::from_core(core_skill, item_info_modes))
    }
    fn from_core_stance(core_stance: &mut rc::StanceMut, item_info_modes: &InfoModesInt<ItemInfoMode, ItemId>) -> Self {
