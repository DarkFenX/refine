...
impl AddedFleetIdResp {
    pub(crate) fn from_core_fleet(core_fleet: rc::FleetMut) -> Self {
        Self {
...
impl AddedFitIdResp {
    pub(crate) fn from_core_fit(core_fit: rc::FitMut) -> Self {
        Self {
...
impl AddedItemIdsResp {
    pub(crate) fn from_core_booster(core_booster: rc::BoosterMut) -> Self {
        Self {
            item_id: core_booster.get_item_id(),
            charge_item_id: None,
        }
    }
    pub(crate) fn from_core_character(core_character: rc::CharacterMut) -> Self {
        Self {
            item_id: core_character.get_item_id(),
            charge_item_id: None,
        }
    }
    pub(crate) fn from_core_drone(core_drone: rc::DroneMut) -> Self {
        Self {
            item_id: core_drone.get_item_id(),
            charge_item_id: None,
        }
    }
    pub(crate) fn from_core_fighter(core_fighter: rc::FighterMut) -> Self {
        Self {
            item_id: core_fighter.get_item_id(),
            charge_item_id: None,
        }
    }
    pub(crate) fn from_core_fw_effect(core_fw_effect: rc::FwEffectMut) -> Self {
        Self {
            item_id: core_fw_effect.get_item_id(),
            charge_item_id: None,
        }
    }
    pub(crate) fn from_core_implant(core_implant: rc::ImplantMut) -> Self {
        Self {
            item_id: core_implant.get_item_id(),
            charge_item_id: None,
        }
    }
    pub(crate) fn from_core_module(core_module: rc::ModuleMut) -> Self {
        Self {
            item_id: core_module.get_item_id(),
            charge_item_id: core_module.get_charge().map(|core_charge| core_charge.get_item_id()),
        }
    }
    pub(crate) fn from_core_proj_effect(core_proj_effect: rc::ProjEffectMut) -> Self {
        Self {
            item_id: core_proj_effect.get_item_id(),
            charge_item_id: None,
        }
    }
    pub(crate) fn from_core_rig(core_rig: rc::RigMut) -> Self {
        Self {
            item_id: core_rig.get_item_id(),
            charge_item_id: None,
        }
    }
    pub(crate) fn from_core_service(core_service: rc::ServiceMut) -> Self {
        Self {
            item_id: core_service.get_item_id(),
            charge_item_id: None,
        }
    }
    pub(crate) fn from_core_ship(core_ship: rc::ShipMut) -> Self {
        Self {
            item_id: core_ship.get_item_id(),
            charge_item_id: None,
        }
    }
    pub(crate) fn from_core_skill(core_skill: rc::SkillMut) -> Self {
        Self {
            item_id: core_skill.get_item_id(),
            charge_item_id: None,
        }
    }
    pub(crate) fn from_core_stance(core_stance: rc::StanceMut) -> Self {
        Self {
            item_id: core_stance.get_item_id(),
            charge_item_id: None,
        }
    }
    pub(crate) fn from_core_subsystem(core_subsystem: rc::SubsystemMut) -> Self {
        Self {
            item_id: core_subsystem.get_item_id(),
            charge_item_id: None,
        }
    }
    pub(crate) fn from_core_sw_effect(core_sw_effect: rc::SwEffectMut) -> Self {
        Self {
...
impl ChangedItemIdsResp {
    pub(crate) fn from_core_charge(core_charge: rc::ChargeMut) -> Self {
        Self {
