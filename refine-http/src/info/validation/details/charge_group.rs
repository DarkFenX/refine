...
impl HValChargeGroupFail {
    pub(in crate::info::validation) fn from_core(core_val_fail: rc::val::ValChargeGroupFail) -> Self {
        Self {
            charges: core_val_fail
                .charges
                .into_iter()
                .map(|(charge_item_id, core_charge_info)| {
                    (charge_item_id, HValChargeGroupItemInfo::from_core(core_charge_info))
                })
                .collect(),
        }
    }
...
impl HValChargeGroupItemInfo {
    fn from_core(core_val_charge_info: rc::val::ValChargeGroupChargeInfo) -> Self {
        Self {
