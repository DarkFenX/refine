...
pub(crate) async fn get_item_stats(
    ...
    WithRejection(payload, _): WithRejection<Option<Json<rs::stats::ItemStatsOptions>>, ApiError>,
) -> impl IntoResponse {
...
async fn internal_get_item_stats(
    ...
    sol_id: String,
    item_id: String,
    payload: rs::stats::ItemStatsOptions,
) -> Result<rs::stats::ItemStatsResult, ApiError> {
