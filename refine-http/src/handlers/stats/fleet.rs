...
pub(crate) async fn get_fleet_stats(
    ...
    WithRejection(payload, _): WithRejection<Option<Json<rs::stats::FleetStatsCmd>>, ApiError>,
) -> impl IntoResponse {
...
async fn internal_get_fleet_stats(
    ...
    sol_id: String,
    fleet_id: String,
    payload: rs::stats::FleetStatsCmd,
) -> Result<rs::stats::FleetStatsResp, ApiError> {
