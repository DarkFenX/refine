...
def test_no_attr_cycle_time(client, consts):
    ...
    # Verification - check that results were not rounded as well
    api_rah.update()
    assert api_rah.attrs[eve_res_em_attr_id].modified == approx(0.85000000001, accuracy=11)
    assert api_rah.attrs[eve_res_therm_attr_id].modified == approx(0.85000000001, accuracy=11)
    assert api_rah.attrs[eve_res_kin_attr_id].modified == approx(0.85000000001, accuracy=11)
    assert api_rah.attrs[eve_res_expl_attr_id].modified == approx(0.85000000001, accuracy=11)
    api_ship.update()
    assert api_ship.attrs[eve_res_em_attr_id].modified == approx(0.425)
    assert api_ship.attrs[eve_res_therm_attr_id].modified == approx(0.5525)
    assert api_ship.attrs[eve_res_kin_attr_id].modified == approx(0.6375)
    assert api_ship.attrs[eve_res_expl_attr_id].modified == approx(0.765)
    # Action
    api_fit.add_implant(type_id=eve_implant_id)
    # Verification - modified values should be exposed, despite having non-modified stored
    api_rah.update()
    assert api_rah.attrs[eve_res_em_attr_id].modified == approx(0.765)
    assert api_rah.attrs[eve_res_therm_attr_id].modified == approx(0.765)
    assert api_rah.attrs[eve_res_kin_attr_id].modified == approx(0.765)
    assert api_rah.attrs[eve_res_expl_attr_id].modified == approx(0.765)
    api_ship.update()
    assert api_ship.attrs[eve_res_em_attr_id].modified == approx(0.3825)
    assert api_ship.attrs[eve_res_therm_attr_id].modified == approx(0.49725)
    assert api_ship.attrs[eve_res_kin_attr_id].modified == approx(0.57375)
    assert api_ship.attrs[eve_res_expl_attr_id].modified == approx(0.6885)
...
def test_res_zero_base(client, consts):
    ...
    assert api_rah1.attrs[eve_basic_info.res_therm_attr_id].modified == approx(1)
    assert api_rah1.attrs[eve_basic_info.res_kin_attr_id].modified == approx(1)
    assert api_rah1.attrs[eve_basic_info.res_expl_attr_id].modified == approx(1)
    api_rah2.update()
    assert api_rah2.attrs[eve_basic_info.res_em_attr_id].modified == approx(1)
    assert api_rah2.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.925)
    assert api_rah2.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.82)
    assert api_rah2.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.655)
    api_ship.update()
    ...
    assert api_rah1.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.85)
    assert api_rah1.attrs[eve_basic_info.res_kin_attr_id].base == approx(1)
    assert api_rah1.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.7975)
    assert api_rah1.attrs[eve_basic_info.res_expl_attr_id].base == approx(1)
    assert api_rah1.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.7825)
    api_rah2.update()
    ...
    assert api_ship.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.509283)
    assert api_ship.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.4967557)
    assert api_ship.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.5218569)
...
def test_shift_non_positive_base(client, consts):
    ...
    assert api_rah1.attrs[eve_basic_info.res_shift_attr_id].modified == approx(-6)
    assert api_rah1.attrs[eve_basic_info.res_em_attr_id].base == approx(0.85)
    assert api_rah1.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.765)
    assert api_rah1.attrs[eve_basic_info.res_therm_attr_id].base == approx(0.85)
    assert api_rah1.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.765)
    assert api_rah1.attrs[eve_basic_info.res_kin_attr_id].base == approx(0.85)
    assert api_rah1.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.765)
    assert api_rah1.attrs[eve_basic_info.res_expl_attr_id].base == approx(0.85)
    assert api_rah1.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.765)
    api_rah2.update()
    assert api_rah2.attrs[eve_basic_info.res_shift_attr_id].base == approx(0)
    assert api_rah2.attrs[eve_basic_info.res_shift_attr_id].modified == approx(0)
    assert api_rah2.attrs[eve_basic_info.res_em_attr_id].base == approx(0.85)
    assert api_rah2.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.765)
    assert api_rah2.attrs[eve_basic_info.res_therm_attr_id].base == approx(0.85)
    assert api_rah2.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.765)
    assert api_rah2.attrs[eve_basic_info.res_kin_attr_id].base == approx(0.85)
    assert api_rah2.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.765)
    assert api_rah2.attrs[eve_basic_info.res_expl_attr_id].base == approx(0.85)
    assert api_rah2.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.765)
    api_rah3.update()
    assert api_rah3.attrs[eve_basic_info.res_shift_attr_id].base == approx(6)
    assert api_rah3.attrs[eve_basic_info.res_shift_attr_id].modified == approx(6)
    assert api_rah3.attrs[eve_basic_info.res_em_attr_id].base == approx(0.85)
    assert api_rah3.attrs[eve_basic_info.res_em_attr_id].modified == approx(1)
    assert api_rah3.attrs[eve_basic_info.res_therm_attr_id].base == approx(0.85)
    assert api_rah3.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.795)
    assert api_rah3.attrs[eve_basic_info.res_kin_attr_id].base == approx(0.85)
    assert api_rah3.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.6775)
    assert api_rah3.attrs[eve_basic_info.res_expl_attr_id].base == approx(0.85)
    assert api_rah3.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.5875)
    api_ship.update()
    assert api_ship.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.304377)
    assert api_ship.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.3494064)
    assert api_ship.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.3501266)
    assert api_ship.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.3643384)
    # Action
    api_fit.add_implant(type_id=eve_implant2_id)
    ...
    assert api_rah1.attrs[eve_basic_info.res_shift_attr_id].modified == approx(6)
    assert api_rah1.attrs[eve_basic_info.res_em_attr_id].base == approx(0.85)
    assert api_rah1.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.855)
    assert api_rah1.attrs[eve_basic_info.res_therm_attr_id].base == approx(0.85)
    assert api_rah1.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.795)
    assert api_rah1.attrs[eve_basic_info.res_kin_attr_id].base == approx(0.85)
    assert api_rah1.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.735)
    assert api_rah1.attrs[eve_basic_info.res_expl_attr_id].base == approx(0.85)
    assert api_rah1.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.675)
    api_rah2.update()
    assert api_rah2.attrs[eve_basic_info.res_shift_attr_id].base == approx(0)
    assert api_rah2.attrs[eve_basic_info.res_shift_attr_id].modified == approx(6)
    assert api_rah2.attrs[eve_basic_info.res_em_attr_id].base == approx(0.85)
    assert api_rah2.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.855)
    assert api_rah2.attrs[eve_basic_info.res_therm_attr_id].base == approx(0.85)
    assert api_rah2.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.795)
    assert api_rah2.attrs[eve_basic_info.res_kin_attr_id].base == approx(0.85)
    assert api_rah2.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.735)
    assert api_rah2.attrs[eve_basic_info.res_expl_attr_id].base == approx(0.85)
    ...
    assert api_rah3.attrs[eve_basic_info.res_shift_attr_id].modified == approx(6)
    assert api_rah3.attrs[eve_basic_info.res_em_attr_id].base == approx(0.85)
    assert api_rah3.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.855)
    assert api_rah3.attrs[eve_basic_info.res_therm_attr_id].base == approx(0.85)
    assert api_rah3.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.795)
    assert api_rah3.attrs[eve_basic_info.res_kin_attr_id].base == approx(0.85)
    assert api_rah3.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.735)
    assert api_rah3.attrs[eve_basic_info.res_expl_attr_id].base == approx(0.85)
    assert api_rah3.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.675)
    api_ship.update()
    assert api_ship.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.3427137)
    assert api_ship.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.3750061)
    assert api_ship.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.3601336)
    assert api_ship.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.3550695)
...
def test_cycle_non_positive_base(client, consts):
    ...
    assert api_rah1.attrs[eve_basic_info.cycle_time_attr_id].modified == approx(-10000)
    assert api_rah1.attrs[eve_basic_info.res_em_attr_id].base == approx(0.85)
    assert api_rah1.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.765)
    assert api_rah1.attrs[eve_basic_info.res_therm_attr_id].base == approx(0.85)
    assert api_rah1.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.765)
    ...
    assert api_rah2.attrs[eve_basic_info.cycle_time_attr_id].modified == approx(0)
    assert api_rah2.attrs[eve_basic_info.res_em_attr_id].base == approx(0.85)
    assert api_rah2.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.765)
    assert api_rah2.attrs[eve_basic_info.res_therm_attr_id].base == approx(0.85)
    assert api_rah2.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.765)
    ...
    assert api_rah3.attrs[eve_basic_info.cycle_time_attr_id].modified == approx(10000)
    assert api_rah3.attrs[eve_basic_info.res_em_attr_id].base == approx(0.85)
    assert api_rah3.attrs[eve_basic_info.res_em_attr_id].modified == approx(1)
    assert api_rah3.attrs[eve_basic_info.res_therm_attr_id].base == approx(0.85)
    assert api_rah3.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.795)
    ...
    api_rah2.update()
    assert api_rah2.attrs[eve_basic_info.cycle_time_attr_id].base == approx(0)
    assert api_rah2.attrs[eve_basic_info.cycle_time_attr_id].modified == approx(10000)
    assert api_rah2.attrs[eve_basic_info.res_em_attr_id].base == approx(0.85)
    assert api_rah2.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.855)
    assert api_rah2.attrs[eve_basic_info.res_therm_attr_id].base == approx(0.85)
    assert api_rah2.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.795)
