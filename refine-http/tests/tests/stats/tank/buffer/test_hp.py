...
def test_buffer_ship(client, consts):
    ...
    assert api_fit_stats.hp.one().shield == (approx(3000), 0, 0)
    assert api_fit_stats.hp.one().armor == (approx(2000), 0, 0)
    assert api_fit_stats.hp.one().hull == (approx(1000), 0, 0)
    api_ship_stats = api_ship.get_stats(options=ItemStatsOptions(hp=True))
    assert api_ship_stats.hp.one().shield == (approx(3000), 0, 0)
    assert api_ship_stats.hp.one().armor == (approx(2000), 0, 0)
    assert api_ship_stats.hp.one().hull == (approx(1000), 0, 0)
    # Action
    api_fw_effect = api_fit.add_fw_effect(type_id=eve_fw_effect_id)
    # Verification
    api_fit_stats = api_fit.get_stats(options=FitStatsOptions(hp=True))
    assert api_fit_stats.hp.one().shield == (approx(3750), 0, 0)
    assert api_fit_stats.hp.one().armor == (approx(2500), 0, 0)
    assert api_fit_stats.hp.one().hull == (approx(1250), 0, 0)
    api_ship_stats = api_ship.get_stats(options=ItemStatsOptions(hp=True))
    assert api_ship_stats.hp.one().shield == (approx(3750), 0, 0)
    assert api_ship_stats.hp.one().armor == (approx(2500), 0, 0)
    assert api_ship_stats.hp.one().hull == (approx(1250), 0, 0)
    # Action
...
def test_buffer_drone(client, consts):
    ...
    assert api_drone_stats.hp.one().shield == (approx(1728), 0, 0)
    assert api_drone_stats.hp.one().armor == (approx(672), 0, 0)
    assert api_drone_stats.hp.one().hull == (approx(600), 0, 0)
    # Action
    api_fw_effect = api_fit.add_fw_effect(type_id=eve_fw_effect_id)
    # Verification
    api_drone_stats = api_drone.get_stats(options=ItemStatsOptions(hp=True))
    assert api_drone_stats.hp.one().shield == (approx(2160), 0, 0)
    assert api_drone_stats.hp.one().armor == (approx(840), 0, 0)
    assert api_drone_stats.hp.one().hull == (approx(750), 0, 0)
    # Action
    api_fw_effect.remove()
    # Verification
    api_drone_stats = api_drone.get_stats(options=ItemStatsOptions(hp=True))
...
def test_buffer_fighter(client, consts):
    ...
    assert api_fighter_stats.hp.one().shield == (approx(2190), 0, 0)
    assert api_fighter_stats.hp.one().armor == (0, 0, 0)
    assert api_fighter_stats.hp.one().hull == (approx(100), 0, 0)
    # Action
    api_fw_effect = api_fit.add_fw_effect(type_id=eve_fw_effect_id)
    # Verification
    api_fighter_stats = api_fighter.get_stats(options=ItemStatsOptions(hp=True))
    assert api_fighter_stats.hp.one().shield == (approx(2737.5), 0, 0)
    assert api_fighter_stats.hp.one().armor == (0, 0, 0)
    assert api_fighter_stats.hp.one().hull == (approx(125), 0, 0)
    # Action
    api_fw_effect.remove()
    # Verification
    api_fighter_stats = api_fighter.get_stats(options=ItemStatsOptions(hp=True))
...
def test_local_asb_ship_accuracy_and_charge_switch(client, consts):
    ...
    # Verification
    api_fit_stats = api_fit.get_stats(options=FitStatsOptions(hp=True))
    assert api_fit_stats.hp.one().shield == (approx(3000), approx(6900), 0)
    assert api_fit_stats.hp.one().armor == (approx(2000), 0, 0)
    assert api_fit_stats.hp.one().hull == (approx(1000), 0, 0)
    api_ship_stats = api_ship.get_stats(options=ItemStatsOptions(hp=True))
    assert api_ship_stats.hp.one().shield == (approx(3000), approx(6900), 0)
    assert api_ship_stats.hp.one().armor == (approx(2000), 0, 0)
    assert api_ship_stats.hp.one().hull == (approx(1000), 0, 0)
    # Action
...
def test_local_asb_ship_state_switch(client, consts):
    ...
    # Verification
    api_fit_stats = api_fit.get_stats(options=FitStatsOptions(hp=True))
    assert api_fit_stats.hp.one().shield == (approx(3000), approx(900), 0)
    assert api_fit_stats.hp.one().armor == (approx(2000), 0, 0)
    assert api_fit_stats.hp.one().hull == (approx(1000), 0, 0)
    api_ship_stats = api_ship.get_stats(options=ItemStatsOptions(hp=True))
    assert api_ship_stats.hp.one().shield == (approx(3000), approx(900), 0)
    assert api_ship_stats.hp.one().armor == (approx(2000), 0, 0)
    assert api_ship_stats.hp.one().hull == (approx(1000), 0, 0)
    # Action
...
def test_local_asb_ship_modified_and_rep_hp_limit(client, consts):
    ...
    api_fit_stats = api_fit.get_stats(options=FitStatsOptions(hp=True))
    assert api_fit_stats.hp.one().shield == (approx(1000), approx(9000), 0)
    assert api_fit_stats.hp.one().armor == (approx(500), 0, 0)
    assert api_fit_stats.hp.one().hull == (approx(250), 0, 0)
    api_ship_stats = api_ship.get_stats(options=ItemStatsOptions(hp=True))
    assert api_ship_stats.hp.one().shield == (approx(1000), approx(9000), 0)
    assert api_ship_stats.hp.one().armor == (approx(500), 0, 0)
    assert api_ship_stats.hp.one().hull == (approx(250), 0, 0)
    # Action
    api_fit.add_rig(type_id=eve_hp_rig)
    # Verification - no limit now, with shield HP increased
    api_fit_stats = api_fit.get_stats(options=FitStatsOptions(hp=True))
    assert api_fit_stats.hp.one().shield == (approx(1700), approx(13500), 0)
    assert api_fit_stats.hp.one().armor == (approx(500), 0, 0)
    assert api_fit_stats.hp.one().hull == (approx(250), 0, 0)
    api_ship_stats = api_ship.get_stats(options=ItemStatsOptions(hp=True))
    assert api_ship_stats.hp.one().shield == (approx(1700), approx(13500), 0)
    assert api_ship_stats.hp.one().armor == (approx(500), 0, 0)
    assert api_ship_stats.hp.one().hull == (approx(250), 0, 0)
    # Action
    ...
    api_fit_stats = api_fit.get_stats(options=FitStatsOptions(hp=True))
    assert api_fit_stats.hp.one().shield == (approx(1700), approx(15300), 0)
    assert api_fit_stats.hp.one().armor == (approx(500), 0, 0)
    assert api_fit_stats.hp.one().hull == (approx(250), 0, 0)
    api_ship_stats = api_ship.get_stats(options=ItemStatsOptions(hp=True))
    assert api_ship_stats.hp.one().shield == (approx(1700), approx(15300), 0)
    assert api_ship_stats.hp.one().armor == (approx(500), 0, 0)
    assert api_ship_stats.hp.one().hull == (approx(250), 0, 0)
...
def test_local_aar_ship_accuracy_and_charge_switch(client, consts):
    ...
    api_fit_stats = api_fit.get_stats(options=FitStatsOptions(hp=True))
    assert api_fit_stats.hp.one().shield == (approx(3000), 0, 0)
    assert api_fit_stats.hp.one().armor == (approx(2000), approx(6900), 0)
    assert api_fit_stats.hp.one().hull == (approx(1000), 0, 0)
    api_ship_stats = api_ship.get_stats(options=ItemStatsOptions(hp=True))
    assert api_ship_stats.hp.one().shield == (approx(3000), 0, 0)
    assert api_ship_stats.hp.one().armor == (approx(2000), approx(6900), 0)
    assert api_ship_stats.hp.one().hull == (approx(1000), 0, 0)
    # Action
...
def test_local_aar_ship_chargedness_and_state_switch(client, consts):
    ...
    api_fit_stats = api_fit.get_stats(options=FitStatsOptions(hp=True))
    assert api_fit_stats.hp.one().shield == (approx(3000), 0, 0)
    assert api_fit_stats.hp.one().armor == (approx(2000), approx(1150), 0)
    assert api_fit_stats.hp.one().hull == (approx(1000), 0, 0)
    api_ship_stats = api_ship.get_stats(options=ItemStatsOptions(hp=True))
    assert api_ship_stats.hp.one().shield == (approx(3000), 0, 0)
    assert api_ship_stats.hp.one().armor == (approx(2000), approx(1150), 0)
    assert api_ship_stats.hp.one().hull == (approx(1000), 0, 0)
    # Action
...
def test_local_aar_ship_modified_and_rep_hp_limit(client, consts):
    ...
    # Verification - reps are limited from 1500 / cycle to 1000 / cycle
    api_fit_stats = api_fit.get_stats(options=FitStatsOptions(hp=True))
    assert api_fit_stats.hp.one().shield == (approx(2000), 0, 0)
    assert api_fit_stats.hp.one().armor == (approx(1000), approx(8000), 0)
    assert api_fit_stats.hp.one().hull == (approx(500), 0, 0)
    api_ship_stats = api_ship.get_stats(options=ItemStatsOptions(hp=True))
    assert api_ship_stats.hp.one().shield == (approx(2000), 0, 0)
    assert api_ship_stats.hp.one().armor == (approx(1000), approx(8000), 0)
    assert api_ship_stats.hp.one().hull == (approx(500), 0, 0)
    # Action
    api_fit.add_rig(type_id=eve_hp_rig)
    # Verification - no limit now, with armor HP increased
    api_fit_stats = api_fit.get_stats(options=FitStatsOptions(hp=True))
    assert api_fit_stats.hp.one().shield == (approx(2000), 0, 0)
    assert api_fit_stats.hp.one().armor == (approx(1700), approx(12000), 0)
    assert api_fit_stats.hp.one().hull == (approx(500), 0, 0)
    api_ship_stats = api_ship.get_stats(options=ItemStatsOptions(hp=True))
    assert api_ship_stats.hp.one().shield == (approx(2000), 0, 0)
    assert api_ship_stats.hp.one().armor == (approx(1700), approx(12000), 0)
    assert api_ship_stats.hp.one().hull == (approx(500), 0, 0)
    # Action
    api_fit.add_rig(type_id=eve_rep_rig)
    # Verification - limited again from 2550 / cycle to 1700 / cycle
    api_fit_stats = api_fit.get_stats(options=FitStatsOptions(hp=True))
    assert api_fit_stats.hp.one().shield == (approx(2000), 0, 0)
    assert api_fit_stats.hp.one().armor == (approx(1700), approx(13600), 0)
    assert api_fit_stats.hp.one().hull == (approx(500), 0, 0)
    api_ship_stats = api_ship.get_stats(options=ItemStatsOptions(hp=True))
    assert api_ship_stats.hp.one().shield == (approx(2000), 0, 0)
    assert api_ship_stats.hp.one().armor == (approx(1700), approx(13600), 0)
    assert api_ship_stats.hp.one().hull == (approx(500), 0, 0)
...
def test_remote_asb_ship_accuracy_and_charge_switch(client, consts):
    ...
    assert api_tgt_fit_stats.hp.one().shield == (approx(3000), 0, approx(6900))
    assert api_tgt_fit_stats.hp.one().armor == (approx(2000), 0, 0)
    assert api_tgt_fit_stats.hp.one().hull == (approx(1000), 0, 0)
    api_tgt_ship_stats = api_tgt_ship.get_stats(options=ItemStatsOptions(hp=True))
    assert api_tgt_ship_stats.hp.one().shield == (approx(3000), 0, approx(6900))
    assert api_tgt_ship_stats.hp.one().armor == (approx(2000), 0, 0)
    assert api_tgt_ship_stats.hp.one().hull == (approx(1000), 0, 0)
    # Action
    api_rasb.change_module(charge_type_id=None)
    # Verification
    api_tgt_fit_stats = api_tgt_fit.get_stats(options=FitStatsOptions(hp=True))
    assert api_tgt_fit_stats.hp.one().shield == (approx(3000), 0, 0)
    assert api_tgt_fit_stats.hp.one().armor == (approx(2000), 0, 0)
    assert api_tgt_fit_stats.hp.one().hull == (approx(1000), 0, 0)
    api_tgt_ship_stats = api_tgt_ship.get_stats(options=ItemStatsOptions(hp=True))
    assert api_tgt_ship_stats.hp.one().shield == (approx(3000), 0, 0)
    assert api_tgt_ship_stats.hp.one().armor == (approx(2000), 0, 0)
    assert api_tgt_ship_stats.hp.one().hull == (approx(1000), 0, 0)
    # Action
...
def test_remote_asb_ship_state_switch(client, consts):
    ...
    # Verification
    api_tgt_fit_stats = api_tgt_fit.get_stats(options=FitStatsOptions(hp=True))
    assert api_tgt_fit_stats.hp.one().shield == (approx(3000), 0, approx(900))
    assert api_tgt_fit_stats.hp.one().armor == (approx(2000), 0, 0)
    assert api_tgt_fit_stats.hp.one().hull == (approx(1000), 0, 0)
    api_tgt_ship_stats = api_tgt_ship.get_stats(options=ItemStatsOptions(hp=True))
    assert api_tgt_ship_stats.hp.one().shield == (approx(3000), 0, approx(900))
    assert api_tgt_ship_stats.hp.one().armor == (approx(2000), 0, 0)
    assert api_tgt_ship_stats.hp.one().hull == (approx(1000), 0, 0)
    # Action
...
def test_remote_asb_ship_resist_and_rep_hp_limit(client, consts):
    ...
    # Verification
    api_tgt_fit_stats = api_tgt_fit.get_stats(options=FitStatsOptions(hp=True))
    assert api_tgt_fit_stats.hp.one().shield == (approx(1000), 0, 0)
    assert api_tgt_fit_stats.hp.one().armor == (approx(500), 0, 0)
    assert api_tgt_fit_stats.hp.one().hull == (approx(250), 0, 0)
    api_tgt_ship_stats = api_tgt_ship.get_stats(options=ItemStatsOptions(hp=True))
    assert api_tgt_ship_stats.hp.one().shield == (approx(1000), 0, 0)
    assert api_tgt_ship_stats.hp.one().armor == (approx(500), 0, 0)
    assert api_tgt_ship_stats.hp.one().hull == (approx(250), 0, 0)
    # Action
    api_rasb.change_module(add_proj_item_ids=[api_tgt_ship.id])
    # Verification - reps are limited from 1500 / cycle to 1000 / cycle
    api_tgt_fit_stats = api_tgt_fit.get_stats(options=FitStatsOptions(hp=True))
    assert api_tgt_fit_stats.hp.one().shield == (approx(1000), 0, approx(9000))
    assert api_tgt_fit_stats.hp.one().armor == (approx(500), 0, 0)
    assert api_tgt_fit_stats.hp.one().hull == (approx(250), 0, 0)
    api_tgt_ship_stats = api_tgt_ship.get_stats(options=ItemStatsOptions(hp=True))
    assert api_tgt_ship_stats.hp.one().shield == (approx(1000), 0, approx(9000))
    assert api_tgt_ship_stats.hp.one().armor == (approx(500), 0, 0)
    assert api_tgt_ship_stats.hp.one().hull == (approx(250), 0, 0)
    # Action
    ...
    api_tgt_fit_stats = api_tgt_fit.get_stats(options=FitStatsOptions(hp=True))
    assert api_tgt_fit_stats.hp.one().shield == (approx(1000), 0, approx(4050))
    assert api_tgt_fit_stats.hp.one().armor == (approx(500), 0, 0)
    assert api_tgt_fit_stats.hp.one().hull == (approx(250), 0, 0)
    api_tgt_ship_stats = api_tgt_ship.get_stats(options=ItemStatsOptions(hp=True))
    assert api_tgt_ship_stats.hp.one().shield == (approx(1000), 0, approx(4050))
    assert api_tgt_ship_stats.hp.one().armor == (approx(500), 0, 0)
    assert api_tgt_ship_stats.hp.one().hull == (approx(250), 0, 0)
    # Action
...
def test_remote_asb_ship_proj_range_and_rep_hp_limit(client, consts):
    ...
    api_tgt_fit_stats = api_tgt_fit.get_stats(options=FitStatsOptions(hp=True))
    assert api_tgt_fit_stats.hp.one().shield == (approx(1000), 0, approx(6750))
    assert api_tgt_fit_stats.hp.one().armor == (approx(500), 0, 0)
    assert api_tgt_fit_stats.hp.one().hull == (approx(250), 0, 0)
    api_tgt_ship_stats = api_tgt_ship.get_stats(options=ItemStatsOptions(hp=True))
    assert api_tgt_ship_stats.hp.one().shield == (approx(1000), 0, approx(6750))
    assert api_tgt_ship_stats.hp.one().armor == (approx(500), 0, 0)
    assert api_tgt_ship_stats.hp.one().hull == (approx(250), 0, 0)
...
def test_remote_asb_drone_fighter(client, consts):
    ...
    assert api_tgt_drone_stats.hp.one().shield == (approx(1728), 0, approx(3000))
    assert api_tgt_drone_stats.hp.one().armor == (approx(672), 0, 0)
    assert api_tgt_drone_stats.hp.one().hull == (approx(600), 0, 0)
    api_tgt_fighter_stats = api_tgt_fighter.get_stats(options=ItemStatsOptions(hp=True))
    assert api_tgt_fighter_stats.hp.one().shield == (approx(2190), 0, approx(3000))
    assert api_tgt_fighter_stats.hp.one().armor == (0, 0, 0)
    assert api_tgt_fighter_stats.hp.one().hull == (approx(100), 0, 0)
...
def test_remote_aar_ship_accuracy_and_charge_switch(client, consts):
    ...
    api_tgt_fit_stats = api_tgt_fit.get_stats(options=FitStatsOptions(hp=True))
    assert api_tgt_fit_stats.hp.one().shield == (approx(3000), 0, 0)
    assert api_tgt_fit_stats.hp.one().armor == (approx(2000), 0, approx(6900))
    assert api_tgt_fit_stats.hp.one().hull == (approx(1000), 0, 0)
    api_tgt_ship_stats = api_tgt_ship.get_stats(options=ItemStatsOptions(hp=True))
    assert api_tgt_ship_stats.hp.one().shield == (approx(3000), 0, 0)
    assert api_tgt_ship_stats.hp.one().armor == (approx(2000), 0, approx(6900))
    assert api_tgt_ship_stats.hp.one().hull == (approx(1000), 0, 0)
    # Action
...
def test_remote_aar_ship_chargedness_and_state_switch(client, consts):
    ...
    api_tgt_fit_stats = api_tgt_fit.get_stats(options=FitStatsOptions(hp=True))
    assert api_tgt_fit_stats.hp.one().shield == (approx(3000), 0, 0)
    assert api_tgt_fit_stats.hp.one().armor == (approx(2000), 0, approx(1150))
    assert api_tgt_fit_stats.hp.one().hull == (approx(1000), 0, 0)
    api_tgt_ship_stats = api_tgt_ship.get_stats(options=ItemStatsOptions(hp=True))
    assert api_tgt_ship_stats.hp.one().shield == (approx(3000), 0, 0)
    assert api_tgt_ship_stats.hp.one().armor == (approx(2000), 0, approx(1150))
    assert api_tgt_ship_stats.hp.one().hull == (approx(1000), 0, 0)
    # Action
...
def test_remote_aar_ship_resist_and_rep_hp_limit(client, consts):
    ...
    # Verification
    api_tgt_fit_stats = api_tgt_fit.get_stats(options=FitStatsOptions(hp=True))
    assert api_tgt_fit_stats.hp.one().shield == (approx(2000), 0, 0)
    assert api_tgt_fit_stats.hp.one().armor == (approx(1000), 0, 0)
    assert api_tgt_fit_stats.hp.one().hull == (approx(500), 0, 0)
    api_tgt_ship_stats = api_tgt_ship.get_stats(options=ItemStatsOptions(hp=True))
    assert api_tgt_ship_stats.hp.one().shield == (approx(2000), 0, 0)
    assert api_tgt_ship_stats.hp.one().armor == (approx(1000), 0, 0)
    assert api_tgt_ship_stats.hp.one().hull == (approx(500), 0, 0)
    # Action
    api_raar.change_module(add_proj_item_ids=[api_tgt_ship.id])
    # Verification - reps are limited from 1500 / cycle to 1000 / cycle
    api_tgt_fit_stats = api_tgt_fit.get_stats(options=FitStatsOptions(hp=True))
    assert api_tgt_fit_stats.hp.one().shield == (approx(2000), 0, 0)
    assert api_tgt_fit_stats.hp.one().armor == (approx(1000), 0, approx(8000))
    assert api_tgt_fit_stats.hp.one().hull == (approx(500), 0, 0)
    api_tgt_ship_stats = api_tgt_ship.get_stats(options=ItemStatsOptions(hp=True))
    assert api_tgt_ship_stats.hp.one().shield == (approx(2000), 0, 0)
    assert api_tgt_ship_stats.hp.one().armor == (approx(1000), 0, approx(8000))
    assert api_tgt_ship_stats.hp.one().hull == (approx(500), 0, 0)
    # Action
    api_tgt_fit.add_rig(type_id=eve_resist_rig)
    # Verification - reps are reduced by RR resistance, and are no longer limited by HP:
    ...
    api_tgt_fit_stats = api_tgt_fit.get_stats(options=FitStatsOptions(hp=True))
    assert api_tgt_fit_stats.hp.one().shield == (approx(2000), 0, 0)
    assert api_tgt_fit_stats.hp.one().armor == (approx(1000), 0, approx(3600))
    assert api_tgt_fit_stats.hp.one().hull == (approx(500), 0, 0)
    api_tgt_ship_stats = api_tgt_ship.get_stats(options=ItemStatsOptions(hp=True))
    assert api_tgt_ship_stats.hp.one().shield == (approx(2000), 0, 0)
    assert api_tgt_ship_stats.hp.one().armor == (approx(1000), 0, approx(3600))
    assert api_tgt_ship_stats.hp.one().hull == (approx(500), 0, 0)
    # Action
...
def test_remote_aar_ship_proj_range_and_rep_hp_limit(client, consts):
    ...
    api_tgt_fit_stats = api_tgt_fit.get_stats(options=FitStatsOptions(hp=True))
    assert api_tgt_fit_stats.hp.one().shield == (approx(2000), 0, 0)
    assert api_tgt_fit_stats.hp.one().armor == (approx(1000), 0, approx(6000))
    assert api_tgt_fit_stats.hp.one().hull == (approx(500), 0, 0)
    api_tgt_ship_stats = api_tgt_ship.get_stats(options=ItemStatsOptions(hp=True))
    assert api_tgt_ship_stats.hp.one().shield == (approx(2000), 0, 0)
    assert api_tgt_ship_stats.hp.one().armor == (approx(1000), 0, approx(6000))
    assert api_tgt_ship_stats.hp.one().hull == (approx(500), 0, 0)
...
def test_remote_aar_drone_fighter(client, consts):
    ...
    api_tgt_drone_stats = api_tgt_drone.get_stats(options=ItemStatsOptions(hp=True))
    assert api_tgt_drone_stats.hp.one().shield == (approx(1728), 0, 0)
    assert api_tgt_drone_stats.hp.one().armor == (approx(672), 0, approx(3000))
    assert api_tgt_drone_stats.hp.one().hull == (approx(600), 0, 0)
    api_tgt_fighter_stats = api_tgt_fighter.get_stats(options=ItemStatsOptions(hp=True))
    assert api_tgt_fighter_stats.hp.one().shield == (approx(2190), 0, 0)
    assert api_tgt_fighter_stats.hp.one().armor == (0, 0, 0)
    assert api_tgt_fighter_stats.hp.one().hull == (approx(100), 0, 0)
...
def test_not_requested(client, consts):
    ...
    with check_no_field():
        api_fit_stats.hp  # ruff:ignore[useless-expression]
    api_ship_stats = api_ship.get_stats(options=ItemStatsOptions(hp=False))
    with check_no_field():
        api_ship_stats.hp  # ruff:ignore[useless-expression]
