...
pub(in crate::info::valid) struct HValChargeSizeFail {
    ...
    data: HashMap<rc::SolItemId, HValChargeSizeItemInfo>,
}
...
impl From<&Vec<rc::SolValChargeSizeFail>> for HValChargeSizeFail {
    fn from(core_val_fails: &Vec<rc::SolValChargeSizeFail>) -> Self {
        Self {
...
impl From<&rc::SolValChargeSizeFail> for HValChargeSizeItemInfo {
    fn from(core_val_fail: &rc::SolValChargeSizeFail) -> Self {
        Self {
