...
pub(in crate::info::valid) struct HValChargeVolumeFail {
    ...
    data: HashMap<rc::SolItemId, HValChargeVolumeItemInfo>,
}
...
impl From<&Vec<rc::SolValChargeVolumeFail>> for HValChargeVolumeFail {
    fn from(core_val_fails: &Vec<rc::SolValChargeVolumeFail>) -> Self {
        Self {
...
impl From<&rc::SolValChargeVolumeFail> for HValChargeVolumeItemInfo {
    fn from(core_val_fail: &rc::SolValChargeVolumeFail) -> Self {
        Self {
