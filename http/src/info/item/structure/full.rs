...
use super::HStructureInfoPartial;

#[derive(serde::Serialize)]
pub(crate) struct HStructureInfoFull {
    #[serde(flatten)]
    pub(crate) partial_info: HStructureInfoPartial,
...
impl HStructureInfoFull {
    pub(super) fn mk_info(core_sol: &mut rc::SolarSystem, core_structure_info: &rc::SolStructureInfo) -> Self {
        let partial_info = HStructureInfoPartial::from(core_structure_info);
