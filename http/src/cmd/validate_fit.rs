    ...
    pub(crate) fn execute(
        ...
        for option in options {
            match option.as_str() {
                ...
                "launched_fighter_count" => core_options.launched_fighter_count = alt_value,
                "launched_support_fighter_count" => core_options.launched_support_fighter_count = alt_value,
                "launched_light_fighter_count" => core_options.launched_light_fighter_count = alt_value,
                "launched_heavy_fighter_count" => core_options.launched_heavy_fighter_count = alt_value,
                "launched_standup_support_fighter_count" => {
                    core_options.launched_standup_support_fighter_count = alt_value
                }
                "launched_standup_light_fighter_count" => core_options.launched_standup_light_fighter_count = alt_value,
                "launched_standup_heavy_fighter_count" => core_options.launched_standup_heavy_fighter_count = alt_value,
                "turret_slot_count" => core_options.turret_slot_count = alt_value,
                "launcher_slot_count" => core_options.launcher_slot_count = alt_value,
                "high_slot_count" => core_options.high_slot_count = alt_value,
                "mid_slot_count" => core_options.mid_slot_count = alt_value,
                "low_slot_count" => core_options.low_slot_count = alt_value,
