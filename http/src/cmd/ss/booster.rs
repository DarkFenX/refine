...
impl HChangeBoosterCmd {
    pub(in crate::cmd::ss) fn from_item_cmd(item_id: rc::SsItemId, item_cmd: item::HChangeBoosterCmd) -> Self {
        Self {
            fit_cmd: fit::HChangeBoosterCmd::from_item_cmd(item_id, item_cmd),
        }
    }
