...
pub(crate) struct HSetStanceCmd {
    ...
    fit_id: rc::FitId,
    #[serde(flatten)]
    fit_cmd: old_change_fit::HSetStanceCmd,
}
impl HSetStanceCmd {
...
pub(crate) struct HChangeStanceViaItemIdCmd {
    #[serde(flatten)]
    fit_cmd: old_change_fit::HChangeStanceViaItemIdCmd,
}
...
pub(crate) struct HChangeStanceViaFitIdCmd {
    ...
    fit_id: rc::FitId,
    #[serde(flatten)]
    fit_cmd: old_change_fit::HChangeStanceViaFitIdCmd,
}
...
pub(crate) struct HUnsetStanceCmd {
    ...
    fit_id: rc::FitId,
    #[serde(flatten)]
    fit_cmd: old_change_fit::HUnsetStanceCmd,
}
