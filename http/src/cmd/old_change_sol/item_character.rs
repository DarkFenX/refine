...
pub(crate) struct HSetCharacterCmd {
    ...
    fit_id: rc::FitId,
    #[serde(flatten)]
    fit_cmd: old_change_fit::HSetCharacterCmd,
}
...
pub(crate) struct HChangeCharacterViaItemIdCmd {
    #[serde(flatten)]
    fit_cmd: old_change_fit::HChangeCharacterViaItemIdCmd,
}
...
pub(crate) struct HChangeCharacterViaFitIdCmd {
    ...
    fit_id: rc::FitId,
    #[serde(flatten)]
    fit_cmd: old_change_fit::HChangeCharacterViaFitIdCmd,
}
...
pub(crate) struct HUnsetCharacterCmd {
    ...
    fit_id: rc::FitId,
    #[serde(flatten)]
    fit_cmd: old_change_fit::HUnsetCharacterCmd,
}
