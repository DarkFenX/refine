...
async fn main() {
    ...
    let app = NormalizePathLayer::trim_trailing_slash().layer(
        Router::new()
            ...
            .route("/solar_system/:ssid/item", post(handlers::create_item))
            .route("/solar_system/:ssid/item/:iid", get(handlers::get_item))
            .route("/solar_system/:ssid/item/:iid", patch(handlers::change_item))
            .route("/solar_system/:ssid/item/:iid", delete(handlers::delete_item))
