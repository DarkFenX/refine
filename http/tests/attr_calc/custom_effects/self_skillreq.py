...
def test_missile_damage_em(client, consts):
    ...
    api_fit.add_skill(type_id=eve_skill1.id, level=5)
    api_fit.add_skill(type_id=eve_skill2.id, level=5)
    api_launcher1 = api_fit.add_mod(type_id=eve_launcher.id, state=consts.State.offline, charge_type_id=eve_charge1.id)
    api_launcher2 = api_fit.add_mod(type_id=eve_launcher.id, state=consts.State.offline, charge_type_id=eve_charge2.id)
