...
def test_affected_multiple(client, consts):
    ...
    api_affectee_item1 = api_fit1.set_struct(type_id=eve_affectee_item.id)
    api_affectee_item2 = api_fit2.set_struct(type_id=eve_affectee_item.id)
...
def test_replace_root(client, consts):
    ...
    api_sol = client.create_sol()
    api_fit = api_sol.create_fit()
    api_affectee_item1 = api_fit.set_struct(type_id=eve_affectee_item1.id)
    api_sol.add_sw_effect(type_id=eve_affector_item.id)
    assert api_affectee_item1.update().attrs[eve_affectee_attr.id].dogma == approx(120)
    api_affectee_item2 = api_fit.set_struct(type_id=eve_affectee_item2.id)
