...
def test_affected_multiple(client, consts):
    ...
    api_tgt_item1 = api_fit1.set_struct(type_id=eve_tgt_item.id)
    api_tgt_item2 = api_fit2.set_struct(type_id=eve_tgt_item.id)
    api_src_item = api_sol.add_sw_effect(type_id=eve_src_item.id)
