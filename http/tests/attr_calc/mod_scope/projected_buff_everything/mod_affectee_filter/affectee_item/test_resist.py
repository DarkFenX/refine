...
def test_resisted_value_change_root(client, consts):
    ...
    eve_proj_effect_buff_id = client.mk_eve_buff(
    ...
    eve_proj_effect_id = client.mk_eve_item(
        attrs={eve_buff_type_attr_id: eve_proj_effect_buff_id, eve_buff_val_attr_id: 5},
        eff_ids=[eve_proj_effect_effect_id], defeff_id=eve_proj_effect_effect_id)
...
def test_resisted_value_change_child(client, consts):
    ...
    eve_rig_effect_id = client.mk_eve_effect(cat_id=consts.EveEffCat.passive, mod_info=[eve_rig_mod])
    eve_rig_id = client.mk_eve_item(attrs={eve_boost_attr_id: -25}, eff_ids=[eve_rig_effect_id])
    eve_drone_id = client.mk_eve_item(attrs={eve_affectee_attr_id: 7.5, eve_resist_attr_id: 0.4}, srqs={eve_skill_id: 1})
    client.create_sources()
    api_sol = client.create_sol()
    api_fit = api_sol.create_fit()
