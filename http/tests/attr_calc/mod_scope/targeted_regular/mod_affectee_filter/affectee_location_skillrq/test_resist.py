...
def test_value_change(client, consts):
    ...
    api_affectee_module = api_affectee_fit.add_rig(type_id=eve_affectee_module.id)
    ...
    assert api_affectee_module.update().attrs[eve_affectee_attr.id].dogma == approx(365)
