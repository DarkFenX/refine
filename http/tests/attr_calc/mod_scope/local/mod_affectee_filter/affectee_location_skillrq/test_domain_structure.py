...
def test_src_switch_to_ship(client, consts):
    ...
    eve_affectee_id = eve_d1.mk_item(attrs={eve_affectee_attr_id: 100}, srqs={eve_skill_id: 1}).id
    eve_d2.mk_item(id_=eve_affectee_id, attrs={eve_affectee_attr_id: 100}, srqs={eve_skill_id: 1})
    eve_root_id = eve_d1.mk_struct().id
    eve_d2.mk_ship(id_=eve_root_id)
    client.create_sources()
