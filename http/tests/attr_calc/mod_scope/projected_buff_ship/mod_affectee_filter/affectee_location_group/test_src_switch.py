...
def test_to_struct(client, consts):
    ...
    eve_rig_id = eve_d1.mk_item(grp_id=eve_grp_id, attrs={eve_affectee_attr_id: 200}).id
    eve_d2.mk_item(id_=eve_rig_id, grp_id=eve_grp_id, attrs={eve_affectee_attr_id: 200})
