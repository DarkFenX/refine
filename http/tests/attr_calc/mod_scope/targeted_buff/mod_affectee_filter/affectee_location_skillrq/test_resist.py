...
def test_resisted_value_change(client, consts):
    ...
    eve_affectee_module = client.mk_eve_item(attrs={eve_affectee_attr.id: 200}, srqs={eve_skill.id: 1})
    ...
    eve_affectee_struct = client.mk_eve_struct(attrs={eve_resist_attr.id: 0.4})
