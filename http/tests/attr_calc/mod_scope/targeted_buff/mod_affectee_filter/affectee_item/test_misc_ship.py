...
def test_propagation(client, consts):
    ...
    eve_affectee_item = client.mk_eve_ship(attrs={eve_affectee_attr.id: 200})
    client.create_sources()
    api_sol = client.create_sol()
    api_fit1 = api_sol.create_fit()
    api_fit2 = api_sol.create_fit()
    api_fit1.set_ship(type_id=eve_affectee_item.id)
...
def test_replace_proj(client, consts):
    ...
    api_ship1 = api_affectee_fit.set_ship(type_id=eve_ship1.id)
    ...
    api_ship2 = api_affectee_fit.set_ship(type_id=eve_ship2.id)
