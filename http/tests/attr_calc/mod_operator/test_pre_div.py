...
def test_deep_stacking(client, consts):
    ...
    eve_mod = client.mk_eve_effect_mod(
        ...
        affectee_attr_id=eve_affectee_attr.id)
    eve_effect = client.mk_eve_effect(mod_info=[eve_mod])
    eve_affector1 = client.mk_eve_item(attrs={eve_affector_attr.id: 0.3}, eff_ids=[eve_effect.id])
    eve_affector2 = client.mk_eve_item(attrs={eve_affector_attr.id: 0.31}, eff_ids=[eve_effect.id])
    eve_affector3 = client.mk_eve_item(attrs={eve_affector_attr.id: 0.32}, eff_ids=[eve_effect.id])
    eve_affector4 = client.mk_eve_item(attrs={eve_affector_attr.id: 0.33}, eff_ids=[eve_effect.id])
    eve_affector5 = client.mk_eve_item(attrs={eve_affector_attr.id: 0.34}, eff_ids=[eve_effect.id])
    eve_affector6 = client.mk_eve_item(attrs={eve_affector_attr.id: 0.35}, eff_ids=[eve_effect.id])
    eve_affector7 = client.mk_eve_item(attrs={eve_affector_attr.id: 0.36}, eff_ids=[eve_effect.id])
    eve_affector8 = client.mk_eve_item(attrs={eve_affector_attr.id: 0.37}, eff_ids=[eve_effect.id])
    eve_affector9 = client.mk_eve_item(attrs={eve_affector_attr.id: 0.38}, eff_ids=[eve_effect.id])
    eve_affector10 = client.mk_eve_item(attrs={eve_affector_attr.id: 0.39}, eff_ids=[eve_effect.id])
    eve_affector11 = client.mk_eve_item(attrs={eve_affector_attr.id: 0.4}, eff_ids=[eve_effect.id])
    eve_affector12 = client.mk_eve_item(attrs={eve_affector_attr.id: 0.41}, eff_ids=[eve_effect.id])
    ...
    api_affectee.update()
    assert api_affectee.attrs[eve_affectee_attr.id].dogma == approx(4395.538972)
