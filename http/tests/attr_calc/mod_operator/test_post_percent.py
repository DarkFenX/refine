...
def test_insignificant_stacking(client, consts):
    ...
    eve_effect = client.mk_eve_effect(mod_info=[eve_mod])
    eve_affector1 = client.mk_eve_item(attrs={eve_affector_attr.id: -50}, eff_ids=[eve_effect.id])
    eve_affector2 = client.mk_eve_item(attrs={eve_affector_attr.id: 100}, eff_ids=[eve_effect.id])
    eve_affectee = client.mk_eve_ship(attrs={eve_affectee_attr.id: 100})
    client.create_sources()
    api_sol = client.create_sol()
    api_fit = api_sol.create_fit()
...
def test_insignificant_base(client, consts):
    ...
    eve_mod = client.mk_eve_effect_mod(
        ...
        affectee_attr_id=eve_affectee_attr.id)
    eve_effect = client.mk_eve_effect(mod_info=[eve_mod])
    eve_affector = client.mk_eve_item(attrs={eve_affector_attr.id: 300}, eff_ids=[eve_effect.id])
...
def test_insignificant_modified_base(client, consts):
    ...
    eve_affector2 = client.mk_eve_item(attrs={eve_affector_attr.id: 300}, eff_ids=[eve_effect2.id])
    eve_affectee = client.mk_eve_ship(attrs={eve_affectee_attr.id: 100})
    client.create_sources()
    api_sol = client.create_sol()
    api_fit = api_sol.create_fit()
