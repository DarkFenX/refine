...
def test_fail_multiple_ship(client, consts):
    ...
    assert api_val.details.drone_bandwidth.used == approx(150)
    assert api_val.details.drone_bandwidth.output == approx(125)
    assert api_val.details.drone_bandwidth.users == {api_drone1.id: approx(50), api_drone2.id: approx(100)}
...
def test_rounding(client, consts):
    ...
    assert api_val.details.drone_bandwidth.users == {api_drone1.id: approx(0.002), api_drone2.id: approx(5.227)}
