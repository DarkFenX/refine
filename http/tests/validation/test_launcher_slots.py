...
def test_fail_single(client, consts):
    ...
    assert len(api_val.details.launcher_slots.users) == 1
    assert api_module.id in api_val.details.launcher_slots.users
...
def test_fail_multiple_ship(client, consts):
    ...
    assert len(api_val.details.launcher_slots.users) == 2
    assert api_module1.id in api_val.details.launcher_slots.users
    assert api_module2.id in api_val.details.launcher_slots.users
