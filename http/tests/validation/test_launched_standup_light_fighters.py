...
def test_fail_single(client, consts):
    ...
    assert api_val.details.launched_standup_light_fighters.used == 1
    assert api_val.details.launched_standup_light_fighters.total == 0
    assert len(api_val.details.launched_standup_light_fighters.users) == 1
    assert api_fighter.id in api_val.details.launched_standup_light_fighters.users
...
def test_fail_multiple_ship(client, consts):
    ...
    api_val = api_fit.validate(include=[consts.ApiValType.launched_standup_light_fighters])
    assert api_val.passed is False
    assert api_val.details.launched_standup_light_fighters.used == 2
    assert api_val.details.launched_standup_light_fighters.total == 1
    assert len(api_val.details.launched_standup_light_fighters.users) == 2
    assert api_fighter1.id in api_val.details.launched_standup_light_fighters.users
    assert api_fighter2.id in api_val.details.launched_standup_light_fighters.users
...
def test_fractional_fighter_type(client, consts):
    ...
    api_val = api_fit.validate(include=[consts.ApiValType.launched_standup_light_fighters])
    assert api_val.passed is False
    assert api_val.details.launched_standup_light_fighters.used == 3
    assert api_val.details.launched_standup_light_fighters.total == 2
    assert len(api_val.details.launched_standup_light_fighters.users) == 3
    assert api_fighter1.id in api_val.details.launched_standup_light_fighters.users
    assert api_fighter2.id in api_val.details.launched_standup_light_fighters.users
    assert api_fighter3.id in api_val.details.launched_standup_light_fighters.users
...
def test_no_ship(client, consts):
    ...
    assert api_val.passed is False
    assert api_val.details.launched_standup_light_fighters.used == 1
    assert api_val.details.launched_standup_light_fighters.total is None
    assert len(api_val.details.launched_standup_light_fighters.users) == 1
    assert api_fighter.id in api_val.details.launched_standup_light_fighters.users
