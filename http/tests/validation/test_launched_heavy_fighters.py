...
def test_fail_single(client, consts):
    ...
    assert len(api_val.details.launched_heavy_fighters.users) == 1
    assert api_fighter.id in api_val.details.launched_heavy_fighters.users
...
def test_fail_multiple_ship(client, consts):
    ...
    assert len(api_val.details.launched_heavy_fighters.users) == 2
    assert api_fighter1.id in api_val.details.launched_heavy_fighters.users
    assert api_fighter2.id in api_val.details.launched_heavy_fighters.users
...
def test_fractional_fighter_type(client, consts):
    ...
    assert len(api_val.details.launched_heavy_fighters.users) == 3
    assert api_fighter1.id in api_val.details.launched_heavy_fighters.users
    assert api_fighter2.id in api_val.details.launched_heavy_fighters.users
    assert api_fighter3.id in api_val.details.launched_heavy_fighters.users
