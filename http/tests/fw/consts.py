...
class EveAttr(IntEnum):
    ...
    ftr_abil_missiles_expl_radius = 2125
    ftr_abil_missiles_expl_velocity = 2126
    ftr_abil_missiles_dmg_reduction_factor = 2127
    ftr_abil_missiles_dmg_reduction_sens = 2128
    ftr_abil_missiles_dmg_mult = 2130
    ftr_abil_missiles_dmg_em = 2131
    ftr_abil_missiles_dmg_therm = 2132
    ftr_abil_missiles_dmg_kin = 2133
    ...
    ftr_abil_atkm_dmg_mult = 2226
    ftr_abil_atkm_dmg_em = 2227
    ftr_abil_atkm_dmg_therm = 2228
    ftr_abil_atkm_dmg_kin = 2229
    ftr_abil_atkm_dmg_expl = 2230
    ftr_abil_atkm_reduction_factor = 2231
    ftr_abil_atkm_reduction_sens = 2232
    ftr_abil_atkm_duration = 2233
    ftr_abil_atkm_expl_radius = 2234
    ftr_abil_atkm_expl_velocity = 2235
    ftr_abil_atkm_range_optimal = 2236
    ftr_abil_atkm_range_falloff = 2237
