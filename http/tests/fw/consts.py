...
class ApiValType(StrEnum):
    ...
    launched_fighter_count = 'launched_fighter_count'
    launched_support_fighter_count = 'launched_support_fighter_count'
    launched_light_fighter_count = 'launched_light_fighter_count'
    launched_heavy_fighter_count = 'launched_heavy_fighter_count'
    launched_standup_support_fighter_count = 'launched_standup_support_fighter_count'
    launched_standup_light_fighter_count = 'launched_standup_light_fighter_count'
    launched_standup_heavy_fighter_count = 'launched_standup_heavy_fighter_count'
    turret_slot_count = 'turret_slot_count'
    launcher_slot_count = 'launcher_slot_count'
    high_slot_count = 'high_slot_count'
    mid_slot_count = 'mid_slot_count'
    low_slot_count = 'low_slot_count'
