...
def test_random(client, consts):
    ...
    assert api_ship.attrs[eve_res_therm_attr_id].dogma == approx(0.65)
    assert api_ship.attrs[eve_res_kin_attr_id].dogma == approx(0.75)
    assert api_ship.attrs[eve_res_expl_attr_id].dogma == approx(0.36)
    api_rah.update()
    assert api_rah.attrs[eve_res_em_attr_id].dogma == approx(1.0)
    assert api_rah.attrs[eve_res_therm_attr_id].dogma == approx(1.0)
