...
def test_complete_single(client, consts):
    ...
    assert api_rah.attrs[eve_rah_info.res_em_attr_id].extra == approx(1)
    ...
    assert api_rah.attrs[eve_rah_info.res_therm_attr_id].extra == approx(0.925)
    ...
    assert api_rah.attrs[eve_rah_info.res_kin_attr_id].extra == approx(0.82)
    ...
    assert api_rah.attrs[eve_rah_info.res_expl_attr_id].extra == approx(0.655)
    api_ship.update()
