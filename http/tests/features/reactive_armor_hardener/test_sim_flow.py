...
def test_complete_double_unsynced(client, consts):
    ...
    assert api_rah1.attrs[eve_basic_info.res_kin_attr_id].dogma == approx(0.8297059)
    ...
    api_ship.update()
    assert api_ship.attrs[eve_basic_info.res_em_attr_id].dogma == approx(0.4787468)
    assert api_ship.attrs[eve_basic_info.res_therm_attr_id].dogma == approx(0.5002957)
    assert api_ship.attrs[eve_basic_info.res_kin_attr_id].dogma == approx(0.5086404)
    assert api_ship.attrs[eve_basic_info.res_expl_attr_id].dogma == approx(0.5092731)
...
def test_no_loop(client, consts):
    ...
    assert api_rah1.attrs[eve_basic_info.res_therm_attr_id].dogma == approx(0.8812493)
    assert api_rah1.attrs[eve_basic_info.res_kin_attr_id].dogma == approx(0.7767873)
    assert api_rah1.attrs[eve_basic_info.res_expl_attr_id].dogma == approx(0.7645734)
    api_rah2.update()
    assert api_rah2.attrs[eve_basic_info.res_em_attr_id].dogma == approx(0.9787356)
    assert api_rah2.attrs[eve_basic_info.res_therm_attr_id].dogma == approx(0.8735057)
    assert api_rah2.attrs[eve_basic_info.res_kin_attr_id].dogma == approx(0.8393966)
    assert api_rah2.attrs[eve_basic_info.res_expl_attr_id].dogma == approx(0.7083621)
    api_ship.update()
    assert api_ship.attrs[eve_basic_info.res_em_attr_id].dogma == approx(0.4796633)
    assert api_ship.attrs[eve_basic_info.res_therm_attr_id].dogma == approx(0.5091791)
    assert api_ship.attrs[eve_basic_info.res_kin_attr_id].dogma == approx(0.5012704)
    assert api_ship.attrs[eve_basic_info.res_expl_attr_id].dogma == approx(0.5070792)
...
def test_no_loop_history_ignore_limit(client, consts):
    ...
    assert api_rah2.attrs[eve_basic_info.res_therm_attr_id].dogma == approx(0.9244231)
    assert api_rah2.attrs[eve_basic_info.res_kin_attr_id].dogma == approx(0.8997308)
    ...
    assert api_ship.attrs[eve_basic_info.res_therm_attr_id].dogma == approx(0.5617076)
    assert api_ship.attrs[eve_basic_info.res_kin_attr_id].dogma == approx(0.5614052)
    assert api_ship.attrs[eve_basic_info.res_expl_attr_id].dogma == approx(0.5612421)
...
def test_already_adapted_accuracy(client, consts):
    ...
    # Verification
    api_rah.update()
    assert api_rah.attrs[eve_basic_info.res_em_attr_id].dogma == approx(1, accuracy=12)
    assert api_rah.attrs[eve_basic_info.res_therm_attr_id].dogma == approx(1, accuracy=12)
    assert api_rah.attrs[eve_basic_info.res_kin_attr_id].dogma == approx(0.40000000001, accuracy=12)
    assert api_rah.attrs[eve_basic_info.res_expl_attr_id].dogma == approx(1, accuracy=12)
    api_ship.update()
    assert api_ship.attrs[eve_basic_info.res_em_attr_id].dogma == approx(0.5)
    assert api_ship.attrs[eve_basic_info.res_therm_attr_id].dogma == approx(0.65)
    assert api_ship.attrs[eve_basic_info.res_kin_attr_id].dogma == approx(0.3)
