...
def test_drone(client, consts):
    ...
    api_item = api_fit.add_drone(type_id=eve_base_item_id, mutation=(eve_mutator_id, {
        eve_change_roll_attr_id: {consts.ApiAttrMutation.roll: 0.6},
        eve_change_absolute_attr_id: {consts.ApiAttrMutation.absolute: 111},
        eve_remove_attr_id: {consts.ApiAttrMutation.roll: 0.8}}))
    # Verification
    api_item.update()
    assert len(api_item.mutation.attrs) == 5
    ...
    api_item.change_drone(mutation={
        eve_add_roll_attr_id: {consts.ApiAttrMutation.roll: 0.3},
        eve_add_absolute_attr_id: {consts.ApiAttrMutation.absolute: 105},
        eve_change_roll_attr_id: {consts.ApiAttrMutation.roll: 0.55},
        eve_change_absolute_attr_id: {consts.ApiAttrMutation.absolute: 109},
        eve_remove_attr_id: None})
    # Verification
    api_item.update()
    assert len(api_item.mutation.attrs) == 5
