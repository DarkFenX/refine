...
def test_main_module(client, consts):
    ...
    api_fit.add_module(type_id=eve_module5_id, state=consts.ApiModuleState.active)
    api_fit.add_module(type_id=eve_module6_id, state=consts.ApiModuleState.active)
    api_module7 = api_fit.add_module(type_id=eve_module7_id, state=consts.ApiModuleState.active)
    api_module8 = api_fit.add_module(type_id=eve_module8_id, state=consts.ApiModuleState.active)
    api_module9 = api_fit.add_module(type_id=eve_module9_id, state=consts.ApiModuleState.active)
    api_module10 = api_fit.add_module(type_id=eve_module10_id, state=consts.ApiModuleState.active)
    api_module11 = api_fit.add_module(type_id=eve_module11_id, state=consts.ApiModuleState.active)
    api_module12 = api_fit.add_module(type_id=eve_module12_id, state=consts.ApiModuleState.active)
    api_module13 = api_fit.add_module(type_id=eve_module13_id, state=consts.ApiModuleState.active)
    api_module14 = api_fit.add_module(type_id=eve_module14_id, state=consts.ApiModuleState.active)
    api_module15 = api_fit.add_module(type_id=eve_module15_id, state=consts.ApiModuleState.active)
    api_fit.add_module(type_id=eve_module16_id, state=consts.ApiModuleState.active)
    api_module17 = api_fit.add_module(type_id=eve_module17_id, state=consts.ApiModuleState.active)
    api_module18 = api_fit.add_module(type_id=eve_module18_id, state=consts.ApiModuleState.active)
    api_module19 = api_fit.add_module(type_id=eve_module19_id, state=consts.ApiModuleState.active)
    api_module20 = api_fit.add_module(type_id=eve_module20_id, state=consts.ApiModuleState.active)
    api_module21 = api_fit.add_module(type_id=eve_module21_id, state=consts.ApiModuleState.active)
    api_module22 = api_fit.add_module(type_id=eve_module22_id, state=consts.ApiModuleState.active)
    api_module23 = api_fit.add_module(type_id=eve_module23_id, state=consts.ApiModuleState.active)
    api_module24 = api_fit.add_module(type_id=eve_module24_id, state=consts.ApiModuleState.active)
    api_module25 = api_fit.add_module(type_id=eve_module25_id, state=consts.ApiModuleState.active)
    api_module26 = api_fit.add_module(type_id=eve_module26_id, state=consts.ApiModuleState.active)
    api_module27 = api_fit.add_module(type_id=eve_module27_id, state=consts.ApiModuleState.active)
    api_module28 = api_fit.add_module(type_id=eve_module28_id, state=consts.ApiModuleState.active)
    api_module29 = api_fit.add_module(type_id=eve_module29_id, state=consts.ApiModuleState.active)
    api_module30 = api_fit.add_module(type_id=eve_module30_id, state=consts.ApiModuleState.active)
    api_module31 = api_fit.add_module(type_id=eve_module31_id, state=consts.ApiModuleState.active)
    api_module32 = api_fit.add_module(type_id=eve_module32_id, state=consts.ApiModuleState.active)
    # Verification
    api_val = api_fit.validate(options=FitValOptions(sec_zone_active=True))
    ...
    api_val = api_fit.validate(options=FitValOptions(sec_zone_active=True))
    assert api_val.passed is False
    assert api_val.details.sec_zone_active.zone == consts.ApiSecZone.hisec_c5
    assert api_val.details.sec_zone_active.items == {
        api_module2.id: sorted([consts.ApiSecZone.nullsec, consts.ApiSecZone.wspace, consts.ApiSecZone.hazard]),
        api_module3.id: sorted([
            consts.ApiSecZone.lowsec,
    ...
    api_val = api_fit.validate(options=FitValOptions(sec_zone_active=True))
    assert api_val.passed is False
    assert api_val.details.sec_zone_active.zone == consts.ApiSecZone.lowsec
    assert api_val.details.sec_zone_active.items == {
        api_module2.id: sorted([consts.ApiSecZone.nullsec, consts.ApiSecZone.wspace, consts.ApiSecZone.hazard]),
        api_module7.id: sorted([consts.ApiSecZone.nullsec, consts.ApiSecZone.wspace, consts.ApiSecZone.hazard]),
        api_module8.id: sorted([consts.ApiSecZone.nullsec, consts.ApiSecZone.wspace.wspace]),
    ...
    api_val = api_fit.validate(options=FitValOptions(sec_zone_active=True))
    assert api_val.passed is False
    assert api_val.details.sec_zone_active.zone == consts.ApiSecZone.lowsec_c5
    assert api_val.details.sec_zone_active.items == {
        api_module2.id: sorted([consts.ApiSecZone.nullsec, consts.ApiSecZone.wspace, consts.ApiSecZone.hazard]),
        api_module7.id: sorted([consts.ApiSecZone.nullsec, consts.ApiSecZone.wspace, consts.ApiSecZone.hazard]),
        api_module8.id: sorted([consts.ApiSecZone.nullsec, consts.ApiSecZone.wspace.wspace]),
    ...
    api_val = api_fit.validate(options=FitValOptions(sec_zone_active=True))
    assert api_val.passed is False
    assert api_val.details.sec_zone_active.zone == consts.ApiSecZone.hazard
    assert api_val.details.sec_zone_active.items == {
...
def test_known_failures(client, consts):
    ...
    api_module2 = api_fit.add_module(type_id=eve_module1_id, state=consts.ApiModuleState.active)
    api_module3 = api_fit.add_module(type_id=eve_module2_id, state=consts.ApiModuleState.active)
    api_module4 = api_fit.add_module(type_id=eve_module2_id, state=consts.ApiModuleState.active)
    # Verification
    api_val = api_fit.validate(options=FitValOptions(sec_zone_active=(True, [api_module1.id])))
    assert api_val.passed is False
    assert api_val.details.sec_zone_active.zone == consts.ApiSecZone.hisec
    assert api_val.details.sec_zone_active.items == {
        api_module2.id: sorted([consts.ApiSecZone.nullsec, consts.ApiSecZone.wspace, consts.ApiSecZone.hazard])}
    api_val = api_fit.validate(options=FitValOptions(sec_zone_active=(True, [api_module2.id])))
    assert api_val.passed is False
    assert api_val.details.sec_zone_active.zone == consts.ApiSecZone.hisec
    assert api_val.details.sec_zone_active.items == {
        api_module1.id: sorted([consts.ApiSecZone.nullsec, consts.ApiSecZone.wspace, consts.ApiSecZone.hazard])}
    api_val = api_fit.validate(options=FitValOptions(sec_zone_active=(True, [api_module1.id, api_module2.id])))
    assert api_val.passed is True
    with check_no_field():
        api_val.details  # noqa: B018
    api_val = api_fit.validate(options=FitValOptions(
        sec_zone_active=(True, [api_module1.id, api_other.id, api_module2.id])))
    assert api_val.passed is True
    with check_no_field():
        api_val.details  # noqa: B018
    # Action
    ...
    api_sol.change(sec_zone=consts.ApiSecZone.hazard)
    # Verification
    api_val = api_fit.validate(options=FitValOptions(sec_zone_active=(True, [api_module3.id])))
    assert api_val.passed is False
    assert api_val.details.sec_zone_active.zone == consts.ApiSecZone.hazard
    assert api_val.details.sec_zone_active.items == {api_module4.id: sorted([
        consts.ApiSecZone.hisec,
        consts.ApiSecZone.lowsec,
        consts.ApiSecZone.nullsec,
        consts.ApiSecZone.wspace])}
    api_val = api_fit.validate(options=FitValOptions(sec_zone_active=(True, [api_module4.id])))
    assert api_val.passed is False
    assert api_val.details.sec_zone_active.zone == consts.ApiSecZone.hazard
    assert api_val.details.sec_zone_active.items == {api_module3.id: sorted([
        consts.ApiSecZone.hisec,
        consts.ApiSecZone.lowsec,
        consts.ApiSecZone.nullsec,
        consts.ApiSecZone.wspace])}
    api_val = api_fit.validate(options=FitValOptions(sec_zone_active=(True, [api_module3.id, api_module4.id])))
    assert api_val.passed is True
    with check_no_field():
        api_val.details  # noqa: B018
    api_val = api_fit.validate(options=FitValOptions(
        sec_zone_active=(True, [api_module3.id, api_other.id, api_module4.id])))
    assert api_val.passed is True
    with check_no_field():
        api_val.details  # noqa: B018
...
def test_state(client, consts):
    ...
    assert api_val.details.sec_zone_active.items == {
        api_module1.id: sorted([consts.ApiSecZone.nullsec, consts.ApiSecZone.wspace, consts.ApiSecZone.hazard])}
    # Action
    api_module1.change_module(state=consts.ApiModuleState.online)
    # Verification
    api_val = api_fit.validate(options=FitValOptions(sec_zone_active=True))
    assert api_val.passed is True
    with check_no_field():
