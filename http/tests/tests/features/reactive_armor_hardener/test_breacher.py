...
def test_damage_kind(client, consts):
    ...
    # Verification
    api_rah.update()
    assert api_rah.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.4)
    ...
    api_ship.update()
    assert api_ship.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.2)
...
def test_absolute_relative_min(client, consts):
    ...
    api_rah.update()
    assert api_rah.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.97)
    ...
    assert api_rah.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.685)
    api_ship.update()
    assert api_ship.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.485)
    ...
    assert api_ship.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.6165)
    # Action
...
def test_ignore_resists(client, consts):
    ...
    # Verification
    api_rah.update()
    assert api_rah.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.745)
    assert api_rah.attrs[eve_basic_info.res_therm_attr_id].modified == approx(1.0)
    assert api_rah.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.91)
    assert api_rah.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.745)
    api_ship.update()
    assert api_ship.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.3725)
    assert api_ship.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.65)
    assert api_ship.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.6825)
    assert api_ship.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.6705)
    # Action
    ...
    assert api_rah.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.745)
    api_ship.update()
    assert api_ship.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.03725)
    assert api_ship.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.65)
    assert api_ship.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.6825)
    assert api_ship.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.6705)
    # Action
    ...
    api_ship.update()
    assert api_ship.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.27875)
    assert api_ship.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.065)
    assert api_ship.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.75)
    assert api_ship.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.75825)
    # Action
    ...
    # Verification
    api_rah.update()
    assert api_rah.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.655)
    assert api_rah.attrs[eve_basic_info.res_therm_attr_id].modified == approx(1.0)
    assert api_rah.attrs[eve_basic_info.res_kin_attr_id].modified == approx(1.0)
    assert api_rah.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.745)
    api_ship.update()
    assert api_ship.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.3275)
    assert api_ship.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.65)
    assert api_ship.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.75)
    assert api_ship.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.6705)
    # Action
    ...
    assert api_ship.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.3275)
    assert api_ship.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.65)
    assert api_ship.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.075)
    assert api_ship.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.6705)
    # Action
    api_kin_rig.remove()
    ...
    # Verification
    api_rah.update()
    assert api_rah.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.5125)
    assert api_rah.attrs[eve_basic_info.res_therm_attr_id].modified == approx(1.0)
    assert api_rah.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.8875)
    assert api_rah.attrs[eve_basic_info.res_expl_attr_id].modified == approx(1)
    api_ship.update()
    assert api_ship.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.25625)
    assert api_ship.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.65)
    assert api_ship.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.665625)
    assert api_ship.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.9)
    # Action
    ...
    assert api_ship.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.65)
    assert api_ship.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.665625)
    assert api_ship.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.09)
...
def test_hp_changed(client, consts):
    ...
    assert api_rah.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.685)
    api_ship.update()
    assert api_ship.attrs[eve_basic_info.shield_hp_attr_id].modified == approx(100)
    assert api_ship.attrs[eve_basic_info.armor_hp_attr_id].modified == approx(100)
    assert api_ship.attrs[eve_basic_info.hull_hp_attr_id].modified == approx(100)
    assert api_ship.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.485)
    assert api_ship.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.60125)
    assert api_ship.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.615)
    assert api_ship.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.6165)
    ...
    assert api_rah.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.8425)
    api_ship.update()
    assert api_ship.attrs[eve_basic_info.shield_hp_attr_id].modified == approx(800)
    assert api_ship.attrs[eve_basic_info.armor_hp_attr_id].modified == approx(100)
    assert api_ship.attrs[eve_basic_info.hull_hp_attr_id].modified == approx(100)
    assert api_ship.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.27875)
    assert api_ship.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.65)
    ...
    api_ship.update()
    assert api_ship.attrs[eve_basic_info.shield_hp_attr_id].modified == approx(100)
    assert api_ship.attrs[eve_basic_info.armor_hp_attr_id].modified == approx(800)
    assert api_ship.attrs[eve_basic_info.hull_hp_attr_id].modified == approx(100)
    assert api_ship.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.27875)
    assert api_ship.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.65)
    assert api_ship.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.75)
    ...
    assert api_ship.attrs[eve_basic_info.shield_hp_attr_id].modified == approx(100)
    assert api_ship.attrs[eve_basic_info.armor_hp_attr_id].modified == approx(100)
    assert api_ship.attrs[eve_basic_info.hull_hp_attr_id].modified == approx(800)
    assert api_ship.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.27875)
    assert api_ship.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.65)
    assert api_ship.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.75)
    assert api_ship.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.75825)
