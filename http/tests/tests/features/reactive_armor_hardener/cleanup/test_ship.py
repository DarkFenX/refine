...
def test_res_changed_em(client, consts):
    ...
    # Verification
    api_rah.update()
    assert api_rah.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.94)
    assert api_rah.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.76)
    assert api_rah.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.76)
    assert api_rah.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.94)
    api_ship.update()
    ...
    assert api_rah.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.715)
    assert api_rah.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.79)
    assert api_rah.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.895)
    api_ship.update()
    assert api_ship.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.35)
    assert api_ship.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.46475)
    assert api_ship.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.4661)
    assert api_ship.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.45645)
...
def test_res_changed_therm(client, consts):
    ...
    # Verification
    api_rah.update()
    assert api_rah.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.88)
    assert api_rah.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.94)
    assert api_rah.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.76)
    assert api_rah.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.82)
    api_ship.update()
    assert api_ship.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.44)
    assert api_ship.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.4277)
    assert api_ship.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.4484)
    assert api_ship.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.4182)
...
def test_res_changed_kin(client, consts):
    ...
    api_rah.update()
    assert api_rah.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.88)
    assert api_rah.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.685)
    assert api_rah.attrs[eve_basic_info.res_kin_attr_id].modified == approx(1)
    assert api_rah.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.835)
    api_ship.update()
    assert api_ship.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.44)
    assert api_ship.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.44525)
    assert api_ship.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.413)
    assert api_ship.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.42585)
...
def test_res_changed_expl(client, consts):
    ...
    # Verification
    api_rah.update()
    assert api_rah.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.925)
    assert api_rah.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.715)
    assert api_rah.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.76)
    assert api_rah.attrs[eve_basic_info.res_expl_attr_id].modified == approx(1)
    api_ship.update()
    assert api_ship.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.4625)
    assert api_ship.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.46475)
    assert api_ship.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.4484)
    assert api_ship.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.357)
