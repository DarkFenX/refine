...
def test_no_loop(client, consts):
    ...
    # Verification
    api_rah1.update()
    assert api_rah1.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.9773899)
    assert api_rah1.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.8812493)
    assert api_rah1.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.7767873)
    assert api_rah1.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.7645734)
    api_rah2.update()
    assert api_rah2.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.9787356)
    assert api_rah2.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.8735057)
    assert api_rah2.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.8393966)
    assert api_rah2.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.7083621)
    api_ship.update()
    assert api_ship.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.4796633)
    assert api_ship.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.5091791)
    assert api_ship.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.5012704)
    assert api_ship.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.5070792)
