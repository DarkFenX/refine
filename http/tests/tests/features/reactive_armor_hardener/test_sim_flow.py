...
def test_already_adapted_accuracy(client, consts):
    ...
    assert api_rah.attrs[eve_basic_info.res_therm_attr_id].dogma == approx(1, accuracy=11)
    assert api_rah.attrs[eve_basic_info.res_kin_attr_id].dogma == approx(0.40000000001, accuracy=11)
    assert api_rah.attrs[eve_basic_info.res_expl_attr_id].dogma == approx(1, accuracy=11)
    api_ship.update()
    assert api_ship.attrs[eve_basic_info.res_em_attr_id].dogma == approx(0.5)
