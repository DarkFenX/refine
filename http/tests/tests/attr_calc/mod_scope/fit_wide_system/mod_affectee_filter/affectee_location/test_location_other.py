...
def test_unaffected(client, consts):
    ...
    eve_root_affectee_item_id = client.mk_eve_ship(attrs={eve_affectee_attr_id: 100})
    eve_child_affectee_item_id = client.mk_eve_item(attrs={eve_affectee_attr_id: 100})
