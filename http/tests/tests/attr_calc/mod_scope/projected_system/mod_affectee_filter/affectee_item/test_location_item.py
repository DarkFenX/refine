...
def test_affected(client, consts):
    ...
    assert api_proj_effect.update().attrs[eve_affectee_attr_id].modified == approx(120)
...
def test_unaffected_other_proj_effect(client, consts):
    ...
    assert api_proj_effect_affectee.update().attrs[eve_affectee_attr_id].modified == approx(100)
