...
def setup_test(*, client, consts):
    ...
    eve_loaded_onlist_id = client.mk_eve_ship(attrs={eve_affectee_attr_id: 200})
    eve_loaded_offlist_id = client.mk_eve_ship(attrs={eve_affectee_attr_id: 100})
...
def test_loaded_offlist_to_loaded_onlist_remove(client, consts):
    ...
    api_module.remove()
    # Verification
    assert api_root.update().attrs[eve_affectee_attr_id].modified == approx(200)
