...
def test_affected_root_ship_ship(client, consts):
    ...
    assert api_ship.update().attrs[eve_affectee_attr_id].modified == approx(90)
    api_module.remove()
...
def test_affected_root_ship_struct(client, consts):
    ...
    assert api_struct.update().attrs[eve_affectee_attr_id].modified == approx(90)
    api_module.remove()
    assert api_struct.update().attrs[eve_affectee_attr_id].modified == approx(200)
...
def test_affected_child(client, consts):
    ...
    assert api_drone.update().attrs[eve_affectee_attr_id].modified == approx(90)
    api_module.remove()
...
def test_unaffected_root_char(client, consts):
    ...
    api_module = api_fit1.add_module(type_id=eve_module_id, state=consts.ApiModuleState.active)
    api_module.change_module(add_proj_item_ids=[api_ship.id])
    assert api_char.update().attrs[eve_affectee_attr_id].modified == approx(200)
    api_module.remove()
    assert api_char.update().attrs[eve_affectee_attr_id].modified == approx(200)
...
def test_unaffected_root_other_fit(client, consts):
    ...
    assert api_ship3.update().attrs[eve_affectee_attr_id].modified == approx(200)
    api_module.remove()
    assert api_ship3.update().attrs[eve_affectee_attr_id].modified == approx(200)
...
def test_unaffected_child_other_fit(client, consts):
    ...
    api_module = api_fit1.add_module(type_id=eve_module_id, state=consts.ApiModuleState.active)
    api_module.change_module(add_proj_item_ids=[api_drone2.id])
    assert api_drone3.update().attrs[eve_affectee_attr_id].modified == approx(200)
    api_module.remove()
    assert api_drone3.update().attrs[eve_affectee_attr_id].modified == approx(200)
...
def test_unaffected_carrier(client, consts):
    ...
    api_module = api_fit1.add_module(type_id=eve_module_id, state=consts.ApiModuleState.active)
    api_module.change_module(add_proj_item_ids=[api_ship2.id])
    assert api_ship1.update().attrs[eve_affectee_attr_id].modified == approx(200)
    api_module.remove()
    assert api_ship1.update().attrs[eve_affectee_attr_id].modified == approx(200)
