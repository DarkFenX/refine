...
def test_child_add_afor_afee_proj_remove_state_proj_fit(client, consts):
    ...
    assert api_affectee_drone.update().attrs[eve_affectee_attr_id].modified == approx(90)
    api_affector_module.change_module(state=consts.ApiModuleState.online)
    assert api_affectee_drone.update().attrs[eve_affectee_attr_id].modified == approx(200)
...
def test_child_add_afee_afor_proj_remove_afee(client, consts):
    ...
    assert api_affectee_fighter.update().attrs[eve_affectee_attr_id].modified == approx(90)
