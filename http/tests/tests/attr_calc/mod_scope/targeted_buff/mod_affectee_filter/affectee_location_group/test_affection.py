...
def test_unaffected_child_of_char_via_ship(client, consts):
    ...
    eve_module_id = client.mk_eve_item(
        ...
        eff_ids=[eve_effect_id],
        defeff_id=eve_effect_id)
    eve_implant_id = client.mk_eve_item(grp_id=eve_grp_id, attrs={eve_affectee_attr_id: 200})
    eve_ship_id = client.mk_eve_ship()
    ...
    api_module.change_module(add_projs=[api_ship.id])
    assert api_implant.update().attrs[eve_affectee_attr_id].modified == approx(200)
    api_module.remove()
    assert api_implant.update().attrs[eve_affectee_attr_id].modified == approx(200)
...
def test_unaffected_root(client, consts):
    ...
    eve_module_id = client.mk_eve_item(
        ...
        eff_ids=[eve_effect_id],
        defeff_id=eve_effect_id)
    eve_ship_id = client.mk_eve_ship(grp_id=eve_grp_id, attrs={eve_affectee_attr_id: 200})
    client.create_sources()
    api_sol = client.create_sol()
    api_fit1 = api_sol.create_fit()
    api_fit2 = api_sol.create_fit()
...
def test_unaffected_targeted_child(client, consts):
    ...
    assert api_drone.update().attrs[eve_affectee_attr_id].modified == approx(200)


def test_unaffected_via_child(client, consts):
    eve_item_grp_id = client.mk_eve_item_group()
    ...
    client.mk_eve_buff(
        ...
        op=consts.EveBuffOp.post_percent,
        loc_grp_mods=[
            client.mk_eve_buff_mod(attr_id=eve_affectee_attr_id, group_id=eve_item_grp_id),
    ...
    eve_module_id = client.mk_eve_item(
        ...
        eff_ids=[eve_effect_id],
        defeff_id=eve_effect_id)
    eve_rig_id = client.mk_eve_item(grp_id=eve_item_grp_id, attrs={eve_affectee_attr_id: 200})
    eve_drone_id = client.mk_eve_drone(grp_id=eve_drone_grp_id, attrs={eve_affectee_attr_id: 200})
    eve_ship_id = client.mk_eve_ship(grp_id=eve_ship_grp_id, attrs={eve_affectee_attr_id: 200})
    client.create_sources()
    api_sol = client.create_sol()
    api_fit1 = api_sol.create_fit()
    api_fit2 = api_sol.create_fit()
...
def test_unaffected_carrier_child(client, consts):
    eve_grp_id = client.mk_eve_item_group()
    eve_affector_attr_id = client.mk_eve_attr(id_=consts.EveAttr.speed_factor)
    eve_affectee_attr_id = client.mk_eve_attr()
    client.mk_eve_buff(
    ...
    api_fit1 = api_sol.create_fit()
    api_fit2 = api_sol.create_fit()
    api_rig = api_fit1.add_rig(type_id=eve_rig_id)
    api_module = api_fit1.add_module(type_id=eve_module_id, state=consts.ApiModuleState.active)
    api_ship = api_fit2.set_ship(type_id=eve_ship_id)
    api_module.change_module(add_projs=[api_ship.id])
    assert api_rig.update().attrs[eve_affectee_attr_id].modified == approx(200)
...
def test_unaffected_other_group(client, consts):
    ...
    eve_module_id = client.mk_eve_item(
        ...
        eff_ids=[eve_effect_id],
        defeff_id=eve_effect_id)
    eve_rig_id = client.mk_eve_item(grp_id=eve_grp2_id, attrs={eve_affectee_attr_id: 200})
    eve_ship_id = client.mk_eve_ship()
    client.create_sources()
    api_sol = client.create_sol()
    api_fit1 = api_sol.create_fit()
