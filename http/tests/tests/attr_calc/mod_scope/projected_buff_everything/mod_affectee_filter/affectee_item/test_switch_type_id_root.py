...
def setup_root_test(*, client, consts):
    ...
    eve_root_unknown_id = client.mk_eve_item(attrs={eve_affectee_attr_id: 2.5})
...
def test_root_ship_to_struct_remove_pe_remove_root(client, consts):
    (eve_affectee_attr_id,
     eve_root_ship_id,
     eve_root_struct_id,
     _,
...
def test_root_ship_to_struct_remove_root_remove_pe(client, consts):
    (eve_affectee_attr_id,
     eve_root_ship_id,
     eve_root_struct_id,
     _,
...
def test_root_ship_to_unknown_remove_pe_remove_root(client, consts):
    (eve_affectee_attr_id,
     eve_root_ship_id,
     _,
     eve_root_unknown_id,
    ...
    # Verification
    assert api_root.update().attrs[eve_affectee_attr_id].dogma == approx(2.5)
    # Action
    api_proj_effect.remove()
    # Verification
    assert api_root.update().attrs[eve_affectee_attr_id].dogma == approx(2.5)
...
def test_root_ship_to_unknown_remove_root_remove_pe(client, consts):
    (eve_affectee_attr_id,
     eve_root_ship_id,
     _,
     eve_root_unknown_id,
...
def test_root_ship_to_not_loaded_remove_pe_remove_root(client, consts):
    (eve_affectee_attr_id,
     eve_root_ship_id,
     _,
     _,
...
def test_root_ship_to_not_loaded_remove_root_remove_pe(client, consts):
    (eve_affectee_attr_id,
     eve_root_ship_id,
     _,
     _,
...
def test_root_struct_to_ship_remove_pe_remove_root(client, consts):
    (eve_affectee_attr_id,
     eve_root_ship_id,
     eve_root_struct_id,
     _,
...
def test_root_struct_to_ship_remove_root_remove_pe(client, consts):
    (eve_affectee_attr_id,
     eve_root_ship_id,
     eve_root_struct_id,
     _,
...
def test_root_unknown_to_ship_remove_pe_remove_root(client, consts):
    (eve_affectee_attr_id,
     eve_root_ship_id,
     _,
     eve_root_unknown_id,
...
def test_root_unknown_to_ship_remove_root_remove_pe(client, consts):
    (eve_affectee_attr_id,
     eve_root_ship_id,
     _,
     eve_root_unknown_id,
...
def test_root_not_loaded_to_ship_remove_pe_remove_root(client, consts):
    (eve_affectee_attr_id,
     eve_root_ship_id,
     _,
     _,
...
def test_root_not_loaded_to_ship_remove_root_remove_pe(client, consts):
    (eve_affectee_attr_id,
     eve_root_ship_id,
     _,
     _,
