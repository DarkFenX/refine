...
def setup_child_test(*, client, consts):
    ...
    eve_loaded_onlist_id = client.mk_eve_item(attrs={eve_affectee_attr_id: 7.5})
    eve_loaded_offlist_id = client.mk_eve_item(attrs={eve_affectee_attr_id: 7.5})
...
def test_loaded_onlist_to_loaded_offlist_remove(client, consts):
    (eve_affectee_attr_id,
     ...
     _,
     api_fit,
     api_fw_effect) = setup_child_test(client=client, consts=consts)
