...
def setup_root_test(*, client, consts):
    ...
    return eve_affectee_attr_id, eve_root_ship_id, eve_root_struct_id, api_fit, api_fw_effect
...
def test_affectee_root_ship(client, consts):
    ...
    # Verification
    assert api_ship.update().attrs[eve_affectee_attr_id].dogma == approx(130)
    # Action
