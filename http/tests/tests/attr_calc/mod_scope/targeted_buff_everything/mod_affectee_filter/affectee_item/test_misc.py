...
def test_propagation(client, consts):
    ...
    api_middle_item = api_affector_fit.add_mod(type_id=eve_middle_item_id, state=consts.ApiModuleState.active)
...
def test_replace_proj_ship_to_ship(client, consts):
    ...
    api_module = api_affector_fit.add_mod(type_id=eve_module_id, state=consts.ApiModuleState.active)
