...
def setup_root_test(*, client, consts):
    ...
    eve_rig_id = client.mk_eve_item(grp_id=eve_grp_id, attrs={eve_affectee_attr_id: 7.5})
...
def test_root_loaded_onlist_to_loaded_offlist_remove_self(client, consts):
    (eve_affectee_attr_id,
     eve_module_id,
     eve_rig_id,
     eve_loaded_onlist_id,
...
def test_affectee_self(client, consts):
    ...
    eve_module_id = client.mk_eve_item(
        attrs={eve_buff_type_attr_id: eve_buff_id, eve_buff_val_attr_id: 5},
        eff_ids=[eve_effect_id], defeff_id=eve_effect_id)
    eve_rig1_id = client.mk_eve_item(grp_id=eve_grp_id, attrs={eve_affectee_attr_id: 7.5})
    eve_rig2_id = client.mk_eve_item(grp_id=eve_grp_id, attrs={eve_affectee_attr_id: 5})
