...
def test_add_with_change_without_remove(client, consts):
    ...
    eve_affectee_rig_id = client.mk_eve_item(attrs={eve_affectee_attr_id: 500}, srqs={eve_skill_id: 1})
...
def test_value_change_optimal(client, consts):
    ...
    eve_affectee_module_id = client.mk_eve_item(attrs={eve_affectee_attr_id: 500}, srqs={eve_skill_id: 1})
    client.create_sources()
    api_sol = client.create_sol()
    api_affector_fit = api_sol.create_fit()
