...
def test_propagation(client, consts):
    ...
    eve_affectee_item_id = client.mk_eve_item(grp_id=eve_grp_id, attrs={eve_affectee_attr_id: 80})
    ...
    api_middle_item.change_module(add_proj_item_ids=[api_ship.id])
...
def test_non_target_effect(client, consts):
    ...
    eve_affectee_module_id = client.mk_eve_item(grp_id=eve_grp_id, attrs={eve_affectee_attr_id: 80})
