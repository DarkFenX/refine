...
def test_almost_all_in(client, consts):
    ...
    assert api_pre_assign_mod.initial_str == approx(pre_ass_val)
    assert api_pre_assign_mod.stacking_mult is None
    assert api_pre_assign_mod.applied_str == approx(pre_ass_val)
    ...
    assert api_pre_div_mod.initial_str == approx(pre_div_val)
    assert api_pre_div_mod.stacking_mult == approx(consts.PenaltyStr.p1)
    assert api_pre_div_mod.applied_str == approx(pre_div_val)
    ...
    assert api_post_perc_immune_mod.initial_str == approx(post_perc_immune_val)
    assert api_post_perc_immune_mod.stacking_mult is None
    assert api_post_perc_immune_mod.applied_str == approx(post_perc_immune_val)
