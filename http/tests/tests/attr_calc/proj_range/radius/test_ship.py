...
def test_outgoing_switch_type_id(client, consts):
    ...
    assert api_affectee_ship.update().attrs[eve_affectee_attr_id].dogma == approx(316.285838)
    # Action
    ...
    assert api_affectee_ship.update().attrs[eve_affectee_attr_id].dogma == approx(343.358896)
    # Action
