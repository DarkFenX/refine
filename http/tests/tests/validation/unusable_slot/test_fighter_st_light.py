...
def test_fail_single(client, consts):
    ...
    # Verification
    api_val = api_fit.validate(options=ValOptions(unlaunchable_st_light_fighter=True))
    assert api_val.passed is False
    assert api_val.details.unlaunchable_st_light_fighter.max == 0
    assert api_val.details.unlaunchable_st_light_fighter.users == [api_fighter.id]
...
def test_fail_multiple_ship(client, consts):
    ...
    assert api_val.passed is False
    assert api_val.details.unlaunchable_st_light_fighter.max == 0
    assert api_val.details.unlaunchable_st_light_fighter.users == sorted([api_fighter1.id, api_fighter2.id])
...
def test_fractional_fighter_type(client, consts):
    ...
    assert api_val.passed is False
    assert api_val.details.unlaunchable_st_light_fighter.max == 0
    assert api_val.details.unlaunchable_st_light_fighter.users == sorted([
...
def test_no_ship(client, consts):
    ...
    api_val = api_fit.validate(options=ValOptions(unlaunchable_st_light_fighter=True))
    assert api_val.passed is False
    assert api_val.details.unlaunchable_st_light_fighter.max is None
    assert api_val.details.unlaunchable_st_light_fighter.users == [api_fighter.id]
