...
motherships/supercarriers when they were transitioned into fighter drones, before fighters were
implemented as we know them today. Nevertheless, the lib supports this validation, just in case it
ever gets back.
"""
