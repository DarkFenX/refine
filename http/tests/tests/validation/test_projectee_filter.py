...
def test_src_breacher_tgt_ship_project_unproject(client, consts):
    ...
    eve_ship_item_id = client.mk_eve_ship()
    ...
    api_tgt_ship = api_tgt_fit.set_ship(type_id=eve_ship_item_id)
    # Verification
...
#     api_val = api_src_fit.validate(options=ValOptions(projectee_filter=True))
#     assert api_val.passed is False
#     assert api_val.details.projectee_filter == {api_src_drone.id: [api_tgt_item.id]}
#     # Action
#     api_src_fighter.change_fighter(add_projs=[api_tgt_item.id])
#     # Verification
#     api_val = api_src_fit.validate(options=ValOptions(projectee_filter=True))
#     assert api_val.passed is False
#     assert api_val.details.projectee_filter == {
...
#     api_val = api_src_fit.validate(options=ValOptions(projectee_filter=True))
#     assert api_val.passed is False
#     assert api_val.details.projectee_filter == {api_src_fighter.id: [api_tgt_item.id]}
#     # Action
...
#     # Verification
#     api_val = api_sol.validate(fit_ids=[api_src_fit.id], options=ValOptions(projectee_filter=True))
#     assert api_val.passed is True
#     with check_no_field():
#         api_val.details  # noqa: B018
#
...
#     api_val = api_src_fit.validate(options=ValOptions(projectee_filter=True))
#     assert api_val.passed is False
#     assert api_val.details.projectee_filter == {api_src_item.id: sorted([api_tgt_drone.id, api_tgt_fighter.id])}
#
#
...
#     api_val = api_src_fit.validate(options=ValOptions(projectee_filter=True))
#     assert api_val.passed is False
#     assert api_val.details.projectee_filter == {api_src_item.id: [api_tgt_item1.id, api_tgt_item3.id, api_tgt_item4.id]}
#
#
...
#
#
# def test_projectee_filter(client, consts):
