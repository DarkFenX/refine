...
def test_fail_multiple_ship(client, consts):
    ...
    assert api_val.details.launched_light_fighters.users == sorted([api_fighter1.id, api_fighter2.id])
...
def test_fractional_fighter_type(client, consts):
    ...
    assert api_val.details.launched_light_fighters.users == sorted([api_fighter1.id, api_fighter2.id, api_fighter3.id])
