...
def test_main_module(client, consts):
    ...
    api_fit.add_module(type_id=eve_module1_id, state=consts.ApiModuleState.ghost)
    api_module2 = api_fit.add_module(type_id=eve_module2_id, state=consts.ApiModuleState.ghost)
    api_module3 = api_fit.add_module(type_id=eve_module3_id, state=consts.ApiModuleState.ghost)
    api_module4 = api_fit.add_module(type_id=eve_module4_id, state=consts.ApiModuleState.ghost)
    api_fit.add_module(type_id=eve_module5_id, state=consts.ApiModuleState.ghost)
    api_fit.add_module(type_id=eve_module6_id, state=consts.ApiModuleState.ghost)
    api_module7 = api_fit.add_module(type_id=eve_module7_id, state=consts.ApiModuleState.ghost)
    api_module8 = api_fit.add_module(type_id=eve_module8_id, state=consts.ApiModuleState.ghost)
    api_module9 = api_fit.add_module(type_id=eve_module9_id, state=consts.ApiModuleState.ghost)
    api_module10 = api_fit.add_module(type_id=eve_module10_id, state=consts.ApiModuleState.ghost)
    api_module11 = api_fit.add_module(type_id=eve_module11_id, state=consts.ApiModuleState.ghost)
    api_module12 = api_fit.add_module(type_id=eve_module12_id, state=consts.ApiModuleState.ghost)
    api_module13 = api_fit.add_module(type_id=eve_module13_id, state=consts.ApiModuleState.ghost)
    api_module14 = api_fit.add_module(type_id=eve_module14_id, state=consts.ApiModuleState.ghost)
    api_module15 = api_fit.add_module(type_id=eve_module15_id, state=consts.ApiModuleState.ghost)
    api_fit.add_module(type_id=eve_module16_id, state=consts.ApiModuleState.ghost)
    api_module17 = api_fit.add_module(type_id=eve_module17_id, state=consts.ApiModuleState.ghost)
    api_module18 = api_fit.add_module(type_id=eve_module18_id, state=consts.ApiModuleState.ghost)
    api_module19 = api_fit.add_module(type_id=eve_module19_id, state=consts.ApiModuleState.ghost)
    api_module20 = api_fit.add_module(type_id=eve_module20_id, state=consts.ApiModuleState.ghost)
    api_module21 = api_fit.add_module(type_id=eve_module21_id, state=consts.ApiModuleState.ghost)
    api_module22 = api_fit.add_module(type_id=eve_module22_id, state=consts.ApiModuleState.ghost)
    api_module23 = api_fit.add_module(type_id=eve_module23_id, state=consts.ApiModuleState.ghost)
    api_module24 = api_fit.add_module(type_id=eve_module24_id, state=consts.ApiModuleState.ghost)
    api_module25 = api_fit.add_module(type_id=eve_module25_id, state=consts.ApiModuleState.ghost)
    api_module26 = api_fit.add_module(type_id=eve_module26_id, state=consts.ApiModuleState.ghost)
    api_module27 = api_fit.add_module(type_id=eve_module27_id, state=consts.ApiModuleState.ghost)
    api_module28 = api_fit.add_module(type_id=eve_module28_id, state=consts.ApiModuleState.ghost)
    api_module29 = api_fit.add_module(type_id=eve_module29_id, state=consts.ApiModuleState.ghost)
    api_module30 = api_fit.add_module(type_id=eve_module30_id, state=consts.ApiModuleState.ghost)
...
def test_known_failures(client, consts):
    ...
    api_module1 = api_fit.add_module(type_id=eve_module1_id, state=consts.ApiModuleState.ghost)
    api_module2 = api_fit.add_module(type_id=eve_module1_id, state=consts.ApiModuleState.ghost)
...
def test_values(client, consts):
    ...
    api_fit = api_sol.create_fit()
    api_fit.add_module(type_id=eve_module1_id, state=consts.ApiModuleState.ghost)
    api_fit.add_module(type_id=eve_module2_id, state=consts.ApiModuleState.ghost)
    api_module3 = api_fit.add_module(type_id=eve_module3_id, state=consts.ApiModuleState.ghost)
    api_module4 = api_fit.add_module(type_id=eve_module4_id, state=consts.ApiModuleState.ghost)
