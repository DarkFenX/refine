...
def test_fail_single(client, consts):
    ...
    assert api_val.details.launched_standup_heavy_fighter_count.total == 0
...
def test_fail_multiple_ship(client, consts):
    ...
    assert api_val.details.launched_standup_heavy_fighter_count.total == 1
...
def test_fractional_fighter_type(client, consts):
    ...
    assert api_val.details.launched_standup_heavy_fighter_count.total == 2
...
def test_no_ship(client, consts):
    ...
    assert api_val.passed is False
    assert api_val.details.launched_standup_heavy_fighter_count.used == 1
    assert api_val.details.launched_standup_heavy_fighter_count.total is None
    assert api_val.details.launched_standup_heavy_fighter_count.users == [api_fighter.id]
...
def test_no_attr_total(client, consts):
    ...
    # irrelevant
    eve_ftr_type_attr_id = client.mk_eve_attr(id_=consts.EveAttr.ftr_sq_is_standup_heavy)
    eve_total_attr_id = consts.EveAttr.ftr_standup_heavy_slots
    eve_fighter_id = client.mk_eve_item(attrs={eve_ftr_type_attr_id: 1})
    eve_ship_id = client.mk_eve_ship(attrs={eve_total_attr_id: 0})
    client.create_sources()
    api_sol = client.create_sol()
