...
def test_fail_single(client, consts):
    ...
    assert api_val.details.launched_heavy_fighter_count.total == 0
...
def test_fail_multiple_ship(client, consts):
    ...
    assert api_val.details.launched_heavy_fighter_count.total == 1
...
def test_fractional_fighter_type(client, consts):
    ...
    assert api_val.details.launched_heavy_fighter_count.total == 2
...
def test_no_ship(client, consts):
    ...
    assert api_val.passed is False
    assert api_val.details.launched_heavy_fighter_count.used == 1
    assert api_val.details.launched_heavy_fighter_count.total is None
    assert api_val.details.launched_heavy_fighter_count.users == [api_fighter.id]
