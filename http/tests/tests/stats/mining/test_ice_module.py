...
def test_state(client, consts):
    ...
    assert api_fleet_stats.mps.one().ice == [approx(23.942308), approx(14.769231)]
    api_fit_stats = api_fit.get_stats(options=FitStatsOptions(mps=True))
    assert api_fit_stats.mps.one().ice == [approx(23.942308), approx(14.769231)]
    api_module_stats = api_module.get_stats(options=ItemStatsOptions(mps=True))
    assert api_module_stats.mps.one().ice == [approx(23.942308), approx(14.769231)]
    # Action
    ...
    assert api_module_mps_ignored.ice == [approx(23.942308), approx(14.769231)]
    # Action
...
def test_stacking(client, consts):
    ...
    # Verification
    api_fleet_stats = api_fleet.get_stats(options=FleetStatsOptions(mps=True))
    assert api_fleet_stats.mps.one().ice == [approx(71.826923), approx(44.307692)]
    api_fit1_stats = api_fit1.get_stats(options=FitStatsOptions(mps=True))
    assert api_fit1_stats.mps.one().ice == [approx(47.884615), approx(29.538462)]
    api_fit2_stats = api_fit2.get_stats(options=FitStatsOptions(mps=True))
    assert api_fit2_stats.mps.one().ice == [approx(23.942308), approx(14.769231)]
...
def test_no_waste(client, consts):
    ...
    # Verification
    api_fleet_stats = api_fleet.get_stats(options=FleetStatsOptions(mps=True))
    assert api_fleet_stats.mps.one().ice == [approx(47.884615), 0]
    api_fit_stats = api_fit.get_stats(options=FitStatsOptions(mps=True))
    assert api_fit_stats.mps.one().ice == [approx(47.884615), 0]
    api_module1_stats = api_module1.get_stats(options=ItemStatsOptions(mps=True))
    assert api_module1_stats.mps.one().ice == [approx(23.942308), 0]
    api_module2_stats = api_module2.get_stats(options=ItemStatsOptions(mps=True))
    assert api_module2_stats.mps.one().ice == [approx(23.942308), 0]
