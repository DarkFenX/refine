...
def test_module_targeted_struct(client, consts):
    ...
    eve_tgt_ship1_id = client.mk_eve_ship(attrs={eve_sensor_grav_attr_id: 50, eve_radius_attr_id: 150})
    eve_tgt_ship2_id = client.mk_eve_ship(attrs={eve_sensor_ladar_attr_id: 35, eve_radius_attr_id: 150})
    client.create_sources()
    api_sol = client.create_sol()
    api_src_fit = api_sol.create_fit()
    ...
    # Verification
    api_tgt_fit_stats = api_tgt_fit.get_stats(options=FitStatsOptions(jam_chance=True))
    assert api_tgt_fit_stats.jam_chance == approx(0.78)
    api_tgt_ship_stats = api_tgt_ship.get_stats(options=ItemStatsOptions(jam_chance=True))
    assert api_tgt_ship_stats.jam_chance == approx(0.78)
    # Action
    api_tgt_ship.change_ship(type_id=eve_tgt_ship2_id)
    # Verification
    api_tgt_fit_stats = api_tgt_fit.get_stats(options=FitStatsOptions(jam_chance=True))
...
def test_module_doomsday(client, consts):
    ...
    eve_tgt_ship1_id = client.mk_eve_ship(attrs={eve_sensor_grav_attr_id: 50, eve_radius_attr_id: 150})
    eve_tgt_ship2_id = client.mk_eve_ship(attrs={eve_sensor_radar_attr_id: 35, eve_radius_attr_id: 150})
    client.create_sources()
    api_sol = client.create_sol()
    api_src_fit = api_sol.create_fit()
    api_src_fit.set_ship(type_id=eve_src_ship_id, coordinates=(0, 0, 0))
    ...
    # Verification
    api_tgt_fit_stats = api_tgt_fit.get_stats(options=FitStatsOptions(jam_chance=True))
    assert api_tgt_fit_stats.jam_chance == approx(0.1)
    api_tgt_ship_stats = api_tgt_ship.get_stats(options=ItemStatsOptions(jam_chance=True))
    assert api_tgt_ship_stats.jam_chance == approx(0.1)
    # Action
    api_tgt_ship.change_ship(type_id=eve_tgt_ship2_id)
    # Verification
    api_tgt_fit_stats = api_tgt_fit.get_stats(options=FitStatsOptions(jam_chance=True))
...
def test_module_burst(client, consts):
    ...
    eve_tgt_ship1_id = client.mk_eve_ship(attrs={eve_sensor_magnet_attr_id: 32, eve_radius_attr_id: 150})
    eve_tgt_ship2_id = client.mk_eve_ship(attrs={eve_sensor_radar_attr_id: 36, eve_radius_attr_id: 150})
    client.create_sources()
    api_sol = client.create_sol()
    api_src_fit = api_sol.create_fit()
    api_src_fit.set_ship(type_id=eve_src_ship_id, coordinates=(0, 0, 0))
    ...
    # Verification
    api_tgt_fit_stats = api_tgt_fit.get_stats(options=FitStatsOptions(jam_chance=True))
    assert api_tgt_fit_stats.jam_chance == approx(0.9375)
    api_tgt_ship_stats = api_tgt_ship.get_stats(options=ItemStatsOptions(jam_chance=True))
    assert api_tgt_ship_stats.jam_chance == approx(0.9375)
    # Action
    api_tgt_ship.change_ship(type_id=eve_tgt_ship2_id)
    # Verification
    api_tgt_fit_stats = api_tgt_fit.get_stats(options=FitStatsOptions(jam_chance=True))
