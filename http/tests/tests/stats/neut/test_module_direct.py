...
def test_state(client, consts):
    ...
    api_stat_options = [StatsOptionItemRemoteNps(ignore_state=False), StatsOptionItemRemoteNps(ignore_state=True)]
    api_module_stats = api_module.get_stats(options=ItemStatsOptions(remote_nps=(True, api_stat_options)))
