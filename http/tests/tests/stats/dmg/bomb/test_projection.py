...
from tests.tests.stats.dmg import make_eve_bomb, make_eve_launcher, make_eve_ship, setup_dmg_basics
...
def test_attr_exp_range_absent(client, consts):
    eve_basic_info = setup_dmg_basics(client=client, consts=consts)
    eve_module_id = make_eve_launcher(
        client=client, basic_info=eve_basic_info, capacity=300,
        cycle_time=10000, reload_time=10000, reactivation_delay=67500)
...
def test_attr_exp_radius_absent(client, consts):
    eve_basic_info = setup_dmg_basics(client=client, consts=consts)
    eve_module_id = make_eve_launcher(
        client=client, basic_info=eve_basic_info, capacity=300,
        cycle_time=10000, reload_time=10000, reactivation_delay=67500)
