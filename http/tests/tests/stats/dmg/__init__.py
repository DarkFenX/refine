...
def setup_dmg_basics(
    ...
    eve_proj_fired_effect_id = client.mk_eve_effect(
    ...
    client.mk_eve_item(eff_ids=[eve_proj_fired_effect_id])
    return DmgBasicInfo(
        ...
        proj_fired_effect_id=eve_proj_fired_effect_id)
...
def make_eve_turret_proj(
    ...
    return client.mk_eve_item(
        attrs=attrs,
        eff_ids=[basic_info.proj_fired_effect_id],
        defeff_id=basic_info.proj_fired_effect_id)
...
def make_eve_turret_proj_charge(
    ...
    if dmgs is not None:
        ...
        attrs.update({k: v for k, v in zip(shield_res_attr_ids, dmgs, strict=True) if v is not None})
