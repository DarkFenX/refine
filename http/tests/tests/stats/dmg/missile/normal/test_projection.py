...
from tests.tests.stats.dmg import make_eve_drone, make_eve_launcher, make_eve_missile, make_eve_ship, setup_dmg_basics
...
def test_range(client, consts):
    ...
    api_tgt_ship = api_tgt_fit.set_ship(type_id=eve_tgt_ship_id, coordinates=(0, 66980, 0), movement=(0, 0, 0))
