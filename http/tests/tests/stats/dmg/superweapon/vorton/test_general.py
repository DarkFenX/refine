...
from tests.tests.stats.dmg import make_eve_dd_vorton, setup_dmg_basics
...
def test_state(client, consts):
    ...
    assert api_module_dps_ignored == [
        approx(1851.851852), approx(1851.851852), approx(1851.851852), approx(1851.851852)]
    api_module_volley_normal, api_module_volley_ignored = api_module_stats.volley
    assert api_module_volley_normal == [0, 0, 0, 0]
    assert api_module_volley_ignored == [approx(1000000), approx(1000000), approx(1000000), approx(1000000)]
    # Action
...
def test_stacking(client, consts):
    ...
    assert api_fleet_stats.volley.one() == [approx(3000000), approx(3000000), approx(3000000), approx(3000000)]
    api_fit1_stats = api_fit1.get_stats(options=FitStatsOptions(dps=True, volley=True))
    assert api_fit1_stats.dps.one() == [
        approx(3703.703704), approx(3703.703704), approx(3703.703704), approx(3703.703704)]
    assert api_fit1_stats.volley.one() == [approx(2000000), approx(2000000), approx(2000000), approx(2000000)]
    api_fit2_stats = api_fit2.get_stats(options=FitStatsOptions(dps=True, volley=True))
    assert api_fit2_stats.dps.one() == [
        approx(1851.851852), approx(1851.851852), approx(1851.851852), approx(1851.851852)]
    assert api_fit2_stats.volley.one() == [approx(1000000), approx(1000000), approx(1000000), approx(1000000)]
...
def test_item_kind(client, consts):
    ...
    assert api_fleet_dps_default == [
        approx(1851.851852), approx(1851.851852), approx(1851.851852), approx(1851.851852)]
    assert api_fleet_dps_disabled == [0, 0, 0, 0]
    assert api_fleet_dps_enabled == [
        approx(1851.851852), approx(1851.851852), approx(1851.851852), approx(1851.851852)]
    api_fleet_volley_default, api_fleet_volley_disabled, api_fleet_volley_enabled = api_fleet_stats.volley
    assert api_fleet_volley_default == [approx(1000000), approx(1000000), approx(1000000), approx(1000000)]
    assert api_fleet_volley_disabled == [0, 0, 0, 0]
    assert api_fleet_volley_enabled == [approx(1000000), approx(1000000), approx(1000000), approx(1000000)]
    ...
    assert api_fit_dps_default == [
        approx(1851.851852), approx(1851.851852), approx(1851.851852), approx(1851.851852)]
    assert api_fit_dps_disabled == [0, 0, 0, 0]
    assert api_fit_dps_enabled == [
        approx(1851.851852), approx(1851.851852), approx(1851.851852), approx(1851.851852)]
