...
from tests.tests.stats.dmg import make_eve_dd_reaper, make_eve_drone, make_eve_ship, setup_dmg_basics
...
def test_range(client, consts):
    ...
    api_tgt_ship = api_tgt_fit.set_ship(type_id=eve_tgt_ship_id, coordinates=(0, 5899, 0), movement=(0, 0, 0))
    ...
    # Action
    api_tgt_ship.change_ship(coordinates=(0, 5901, 0))
    # Verification - slightly goes out of attacking ship radius
    api_fleet_stats = api_fleet.get_stats(options=FleetStatsOptions(
        dps=(True, [StatsOptionFitDps(projectee_item_id=api_tgt_ship.id)]),
        volley=(True, [StatsOptionFitVolley(projectee_item_id=api_tgt_ship.id)])))
    assert api_fleet_stats.dps.one() == [0, 0, 0, approx(1718.75)]
    assert api_fleet_stats.volley.one() == [0, 0, 0, approx(412500)]
    api_fit_stats = api_src_fit.get_stats(options=FitStatsOptions(
        dps=(True, [StatsOptionFitDps(projectee_item_id=api_tgt_ship.id)]),
        volley=(True, [StatsOptionFitVolley(projectee_item_id=api_tgt_ship.id)])))
    assert api_fit_stats.dps.one() == [0, 0, 0, approx(1718.75)]
    assert api_fit_stats.volley.one() == [0, 0, 0, approx(412500)]
    api_module_proj_stats = api_src_module_proj.get_stats(options=ItemStatsOptions(
        dps=(True, [StatsOptionItemDps(projectee_item_id=api_tgt_ship.id)]),
        volley=(True, [StatsOptionItemVolley(projectee_item_id=api_tgt_ship.id)])))
    assert api_module_proj_stats.dps.one() == [0, 0, 0, approx(859.375)]
    assert api_module_proj_stats.volley.one() == [0, 0, 0, approx(206250)]
    api_module_nonproj_stats = api_src_module_nonproj.get_stats(options=ItemStatsOptions(
        dps=(True, [StatsOptionItemDps(projectee_item_id=api_tgt_ship.id)]),
        volley=(True, [StatsOptionItemVolley(projectee_item_id=api_tgt_ship.id)])))
    assert api_module_nonproj_stats.dps.one() == [0, 0, 0, approx(859.375)]
    assert api_module_nonproj_stats.volley.one() == [0, 0, 0, approx(206250)]
    # Action
...
def test_application(client, consts):
    ...
    api_fleet_stats = api_fleet.get_stats(options=FleetStatsOptions(
        dps=(True, [StatsOptionFitDps(projectee_item_id=api_tgt_ship.id)]),
        volley=(True, [StatsOptionFitVolley(projectee_item_id=api_tgt_ship.id)])))
    assert api_fleet_stats.dps.one() == [0, 0, 0, approx(145.357143)]
    assert api_fleet_stats.volley.one() == [0, 0, 0, approx(34885.714286)]
    api_fit_stats = api_src_fit.get_stats(options=FitStatsOptions(
        dps=(True, [StatsOptionFitDps(projectee_item_id=api_tgt_ship.id)]),
        volley=(True, [StatsOptionFitVolley(projectee_item_id=api_tgt_ship.id)])))
    assert api_fit_stats.dps.one() == [0, 0, 0, approx(145.357143)]
    assert api_fit_stats.volley.one() == [0, 0, 0, approx(34885.714286)]
    api_module_proj_stats = api_src_module_proj.get_stats(options=ItemStatsOptions(
        dps=(True, [StatsOptionItemDps(projectee_item_id=api_tgt_ship.id)]),
        volley=(True, [StatsOptionItemVolley(projectee_item_id=api_tgt_ship.id)])))
    assert api_module_proj_stats.dps.one() == [0, 0, 0, approx(72.678571)]
    assert api_module_proj_stats.volley.one() == [0, 0, 0, approx(17442.857143)]
    api_module_nonproj_stats = api_src_module_nonproj.get_stats(options=ItemStatsOptions(
        dps=(True, [StatsOptionItemDps(projectee_item_id=api_tgt_ship.id)]),
        volley=(True, [StatsOptionItemVolley(projectee_item_id=api_tgt_ship.id)])))
    assert api_module_nonproj_stats.dps.one() == [0, 0, 0, approx(72.678571)]
    assert api_module_nonproj_stats.volley.one() == [0, 0, 0, approx(17442.857143)]
    # Action
...
def test_npc_prop_mode(client, consts):
    ...
    assert api_module_proj_stats.dps.one() == [0, 0, 0, approx(24.553571)]
    assert api_module_proj_stats.volley.one() == [0, 0, 0, approx(5892.857143)]
    api_module_nonproj_stats = api_src_module_nonproj.get_stats(options=ItemStatsOptions(
        dps=(True, [StatsOptionItemDps(projectee_item_id=api_tgt_drone.id)]),
        volley=(True, [StatsOptionItemVolley(projectee_item_id=api_tgt_drone.id)])))
    assert api_module_nonproj_stats.dps.one() == [0, 0, 0, approx(24.553571)]
    assert api_module_nonproj_stats.volley.one() == [0, 0, 0, approx(5892.857143)]
    # Action
    ...
    api_module_proj_stats = api_src_module_proj.get_stats(options=ItemStatsOptions(
        dps=(True, [StatsOptionItemDps(projectee_item_id=api_tgt_drone.id)]),
        volley=(True, [StatsOptionItemVolley(projectee_item_id=api_tgt_drone.id)])))
    assert api_module_proj_stats.dps.one() == [0, 0, 0, approx(122.767857)]
    assert api_module_proj_stats.volley.one() == [0, 0, 0, approx(29464.285714)]
    api_module_nonproj_stats = api_src_module_nonproj.get_stats(options=ItemStatsOptions(
        dps=(True, [StatsOptionItemDps(projectee_item_id=api_tgt_drone.id)]),
        volley=(True, [StatsOptionItemVolley(projectee_item_id=api_tgt_drone.id)])))
    assert api_module_nonproj_stats.dps.one() == [0, 0, 0, approx(122.767857)]
    assert api_module_nonproj_stats.volley.one() == [0, 0, 0, approx(29464.285714)]
    # Action
...
def test_dd_attr_range_absent(client, consts):
    ...
    assert api_module_nonproj_stats.volley.one() == [0, 0, 0, approx(206250)]
    # Action
    api_tgt_ship.change_ship(coordinates=(0, 11899, 0))
    # Verification
    api_module_proj_stats = api_src_module_proj.get_stats(options=ItemStatsOptions(
        dps=(True, [StatsOptionItemDps(projectee_item_id=api_tgt_ship.id)]),
        volley=(True, [StatsOptionItemVolley(projectee_item_id=api_tgt_ship.id)])))
    ...
    assert api_module_nonproj_stats.volley.one() == [0, 0, 0, approx(206250)]
    # Action
    api_tgt_ship.change_ship(coordinates=(0, 11901, 0))
    # Verification
    api_module_proj_stats = api_src_module_proj.get_stats(options=ItemStatsOptions(
        dps=(True, [StatsOptionItemDps(projectee_item_id=api_tgt_ship.id)]),
        volley=(True, [StatsOptionItemVolley(projectee_item_id=api_tgt_ship.id)])))
