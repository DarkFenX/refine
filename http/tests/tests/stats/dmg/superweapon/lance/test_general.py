...
def test_state(client, consts):
    ...
    assert api_fleet_stats.dps.one() == [approx(6445.3125), 0, 0, 0]
    assert api_fleet_stats.volley.one() == [approx(103125), 0, 0, 0]
    api_fit_stats = api_fit.get_stats(options=FitStatsOptions(dps=True, volley=True))
    assert api_fit_stats.dps.one() == [approx(6445.3125), 0, 0, 0]
    assert api_fit_stats.volley.one() == [approx(103125), 0, 0, 0]
    api_module_stats = api_module.get_stats(options=ItemStatsOptions(dps=True, volley=True))
    assert api_module_stats.dps.one() == [approx(6445.3125), 0, 0, 0]
    assert api_module_stats.volley.one() == [approx(103125), 0, 0, 0]
    # Action
...
def test_stacking(client, consts):
    ...
    # Verification
    api_fleet_stats = api_fleet.get_stats(options=FleetStatsOptions(dps=True, volley=True))
    assert api_fleet_stats.dps.one() == [approx(19335.9375), 0, 0, 0]
    assert api_fleet_stats.volley.one() == [approx(309375), 0, 0, 0]
    api_fit1_stats = api_fit1.get_stats(options=FitStatsOptions(dps=True, volley=True))
    assert api_fit1_stats.dps.one() == [approx(12890.625), 0, 0, 0]
    assert api_fit1_stats.volley.one() == [approx(206250), 0, 0, 0]
    api_fit2_stats = api_fit2.get_stats(options=FitStatsOptions(dps=True, volley=True))
    assert api_fit2_stats.dps.one() == [approx(6445.3125), 0, 0, 0]
    assert api_fit2_stats.volley.one() == [approx(103125), 0, 0, 0]
...
def test_item_kind(client, consts):
    ...
    assert api_fleet_dps_default == [approx(6445.3125), 0, 0, 0]
    assert api_fleet_dps_disabled == [0, 0, 0, 0]
    assert api_fleet_dps_enabled == [approx(6445.3125), 0, 0, 0]
    api_fleet_volley_default, api_fleet_volley_disabled, api_fleet_volley_enabled = api_fleet_stats.volley
    assert api_fleet_volley_default == [approx(103125), 0, 0, 0]
    assert api_fleet_volley_disabled == [0, 0, 0, 0]
    assert api_fleet_volley_enabled == [approx(103125), 0, 0, 0]
    ...
    assert api_fit_dps_default == [approx(6445.3125), 0, 0, 0]
    assert api_fit_dps_disabled == [0, 0, 0, 0]
    assert api_fit_dps_enabled == [approx(6445.3125), 0, 0, 0]
    api_fit_volley_default, api_fit_volley_disabled, api_fit_volley_enabled = api_fit_stats.volley
    assert api_fit_volley_default == [approx(103125), 0, 0, 0]
    assert api_fit_volley_disabled == [0, 0, 0, 0]
    assert api_fit_volley_enabled == [approx(103125), 0, 0, 0]
...
def test_time(client, consts):
    ...
    assert api_fleet_stats.dps.one() == [approx(6829.470199), 0, 0, 0]
    assert api_fleet_stats.volley.one() == [approx(103125), 0, 0, 0]
    api_fit_stats = api_fit.get_stats(options=FitStatsOptions(
        dps=(True, [StatsOptionFitDps(time_options=StatTimeSim(time=15.1))]),
        volley=(True, [StatsOptionFitVolley(time_options=StatTimeSim(time=15.1))])))
    assert api_fit_stats.dps.one() == [approx(6829.470199), 0, 0, 0]
    assert api_fit_stats.volley.one() == [approx(103125), 0, 0, 0]
    api_module_stats = api_module.get_stats(options=ItemStatsOptions(
    ...
    assert api_module_stats.dps.one() == [approx(6829.470199), 0, 0, 0]
    assert api_module_stats.volley.one() == [approx(103125), 0, 0, 0]
    ...
    assert api_fleet_stats.dps.one() == [approx(6485.849057), 0, 0, 0]
    assert api_fleet_stats.volley.one() == [approx(103125), 0, 0, 0]
    api_fit_stats = api_fit.get_stats(options=FitStatsOptions(
        dps=(True, [StatsOptionFitDps(time_options=StatTimeSim(time=15.9))]),
        volley=(True, [StatsOptionFitVolley(time_options=StatTimeSim(time=15.9))])))
    assert api_fit_stats.dps.one() == [approx(6485.849057), 0, 0, 0]
    assert api_fit_stats.volley.one() == [approx(103125), 0, 0, 0]
    api_module_stats = api_module.get_stats(options=ItemStatsOptions(
    ...
    assert api_module_stats.dps.one() == [approx(6485.849057), 0, 0, 0]
    assert api_module_stats.volley.one() == [approx(103125), 0, 0, 0]
    ...
    assert api_fleet_stats.dps.one() == [approx(12810.559006), 0, 0, 0]
    assert api_fleet_stats.volley.one() == [approx(103125), 0, 0, 0]
    api_fit_stats = api_fit.get_stats(options=FitStatsOptions(
        dps=(True, [StatsOptionFitDps(time_options=StatTimeSim(time=16.1))]),
        volley=(True, [StatsOptionFitVolley(time_options=StatTimeSim(time=16.1))])))
    assert api_fit_stats.dps.one() == [approx(12810.559006), 0, 0, 0]
    assert api_fit_stats.volley.one() == [approx(103125), 0, 0, 0]
    api_module_stats = api_module.get_stats(options=ItemStatsOptions(
    ...
    assert api_module_stats.dps.one() == [approx(12810.559006), 0, 0, 0]
    assert api_module_stats.volley.one() == [approx(103125), 0, 0, 0]
    ...
    assert api_fleet_stats.dps.one() == [approx(53157.216495), 0, 0, 0]
    assert api_fleet_stats.volley.one() == [approx(103125), 0, 0, 0]
    api_fit_stats = api_fit.get_stats(options=FitStatsOptions(
        dps=(True, [StatsOptionFitDps(time_options=StatTimeSim(time=29.1))]),
        volley=(True, [StatsOptionFitVolley(time_options=StatTimeSim(time=29.1))])))
    assert api_fit_stats.dps.one() == [approx(53157.216495), 0, 0, 0]
    assert api_fit_stats.volley.one() == [approx(103125), 0, 0, 0]
    api_module_stats = api_module.get_stats(options=ItemStatsOptions(
    ...
    assert api_module_stats.dps.one() == [approx(53157.216495), 0, 0, 0]
    assert api_module_stats.volley.one() == [approx(103125), 0, 0, 0]
    ...
    assert api_fleet_stats.dps.one() == [approx(6068.556297), 0, 0, 0]
    assert api_fleet_stats.volley.one() == [approx(103125), 0, 0, 0]
    api_fit_stats = api_fit.get_stats(options=FitStatsOptions(
        dps=(True, [StatsOptionFitDps(time_options=StatTimeSim(time=254.9))]),
        volley=(True, [StatsOptionFitVolley(time_options=StatTimeSim(time=254.9))])))
    assert api_fit_stats.dps.one() == [approx(6068.556297), 0, 0, 0]
    assert api_fit_stats.volley.one() == [approx(103125), 0, 0, 0]
    api_module_stats = api_module.get_stats(options=ItemStatsOptions(
    ...
    assert api_module_stats.dps.one() == [approx(6068.556297), 0, 0, 0]
    assert api_module_stats.volley.one() == [approx(103125), 0, 0, 0]
    ...
    assert api_fleet_stats.dps.one() == [approx(6468.051744), 0, 0, 0]
    assert api_fleet_stats.volley.one() == [approx(103125), 0, 0, 0]
    api_fit_stats = api_fit.get_stats(options=FitStatsOptions(
        dps=(True, [StatsOptionFitDps(time_options=StatTimeSim(time=255.1))]),
        volley=(True, [StatsOptionFitVolley(time_options=StatTimeSim(time=255.1))])))
    assert api_fit_stats.dps.one() == [approx(6468.051744), 0, 0, 0]
    assert api_fit_stats.volley.one() == [approx(103125), 0, 0, 0]
    api_module_stats = api_module.get_stats(options=ItemStatsOptions(
    ...
    assert api_module_stats.dps.one() == [approx(6468.051744), 0, 0, 0]
    assert api_module_stats.volley.one() == [approx(103125), 0, 0, 0]
