...
def test_time(client, consts):
    ...
    assert api_fleet_stats.dps.one() == [approx(45), approx(45), approx(45), approx(45)]
    assert api_fleet_stats.volley.one() == [approx(45), approx(45), approx(45), approx(45)]
    api_fit_stats = api_fit.get_stats(options=FitStatsOptions(
        dps=(True, [StatsOptionFitDps(time_options=StatTimeSim(time=1))]),
        volley=(True, [StatsOptionFitVolley(time_options=StatTimeSim(time=1))])))
    assert api_fit_stats.dps.one() == [approx(45), approx(45), approx(45), approx(45)]
    assert api_fit_stats.volley.one() == [approx(45), approx(45), approx(45), approx(45)]
    api_module_stats = api_module.get_stats(options=ItemStatsOptions(
    ...
    assert api_module_stats.dps.one() == [approx(45), approx(45), approx(45), approx(45)]
    assert api_module_stats.volley.one() == [approx(45), approx(45), approx(45), approx(45)]
    ...
    assert api_fleet_stats.dps.one() == [approx(6.428571), approx(6.428571), approx(6.428571), approx(6.428571)]
    assert api_fleet_stats.volley.one() == [approx(45), approx(45), approx(45), approx(45)]
    api_fit_stats = api_fit.get_stats(options=FitStatsOptions(
        dps=(True, [StatsOptionFitDps(time_options=StatTimeSim(time=7))]),
        volley=(True, [StatsOptionFitVolley(time_options=StatTimeSim(time=7))])))
    assert api_fit_stats.dps.one() == [approx(6.428571), approx(6.428571), approx(6.428571), approx(6.428571)]
    assert api_fit_stats.volley.one() == [approx(45), approx(45), approx(45), approx(45)]
    api_module_stats = api_module.get_stats(options=ItemStatsOptions(
    ...
    assert api_module_stats.dps.one() == [approx(6.428571), approx(6.428571), approx(6.428571), approx(6.428571)]
    assert api_module_stats.volley.one() == [approx(45), approx(45), approx(45), approx(45)]
    ...
    assert api_fleet_stats.dps.one() == [approx(11.25), approx(11.25), approx(11.25), approx(11.25)]
    assert api_fleet_stats.volley.one() == [approx(45), approx(45), approx(45), approx(45)]
    api_fit_stats = api_fit.get_stats(options=FitStatsOptions(
        dps=(True, [StatsOptionFitDps(time_options=StatTimeSim(time=8))]),
        volley=(True, [StatsOptionFitVolley(time_options=StatTimeSim(time=8))])))
    assert api_fit_stats.dps.one() == [approx(11.25), approx(11.25), approx(11.25), approx(11.25)]
    assert api_fit_stats.volley.one() == [approx(45), approx(45), approx(45), approx(45)]
    api_module_stats = api_module.get_stats(options=ItemStatsOptions(
    ...
    assert api_module_stats.dps.one() == [approx(11.25), approx(11.25), approx(11.25), approx(11.25)]
    assert api_module_stats.volley.one() == [approx(45), approx(45), approx(45), approx(45)]
