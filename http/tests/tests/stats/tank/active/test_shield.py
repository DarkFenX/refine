...
def test_state_ship(client, consts):
    ...
    api_tgt_fit_rps, = api_tgt_fit_stats.rps
    assert api_tgt_fit_rps.shield == [approx(124.666667), approx(196.65), ANY_VALUE]
    assert api_tgt_fit_rps.armor == [0, 0, ANY_VALUE]
    assert api_tgt_fit_rps.hull == [0, 0, ANY_VALUE]
    api_tgt_ship_stats = api_tgt_ship.get_stats(options=ItemStatsOptions(rps=True))
    api_tgt_ship_rps, = api_tgt_ship_stats.rps
    assert api_tgt_ship_rps.shield == [approx(124.666667), approx(196.65), ANY_VALUE]
    assert api_tgt_ship_rps.armor == [0, 0, ANY_VALUE]
    assert api_tgt_ship_rps.hull == [0, 0, ANY_VALUE]
    # Action
    ...
    api_tgt_fit_stats = api_tgt_fit.get_stats(options=FitStatsOptions(rps=True))
    api_tgt_fit_rps, = api_tgt_fit_stats.rps
    assert api_tgt_fit_rps.shield == [0, 0, ANY_VALUE]
    assert api_tgt_fit_rps.armor == [0, 0, ANY_VALUE]
    assert api_tgt_fit_rps.hull == [0, 0, ANY_VALUE]
    api_tgt_ship_stats = api_tgt_ship.get_stats(options=ItemStatsOptions(rps=True))
    api_tgt_ship_rps, = api_tgt_ship_stats.rps
    assert api_tgt_ship_rps.shield == [0, 0, ANY_VALUE]
    assert api_tgt_ship_rps.armor == [0, 0, ANY_VALUE]
    assert api_tgt_ship_rps.hull == [0, 0, ANY_VALUE]
    # Action
...
def test_drone(client, consts):
    ...
    api_tgt_drone_rps, = api_tgt_drone_stats.rps
    assert api_tgt_drone_rps.shield == [0, approx(196.65), ANY_VALUE]
    assert api_tgt_drone_rps.armor == [0, 0, ANY_VALUE]
    assert api_tgt_drone_rps.hull == [0, 0, ANY_VALUE]
...
def test_hp_limit_and_resist(client, consts):
    ...
    api_tgt_fit_stats = api_tgt_fit.get_stats(options=FitStatsOptions(rps=True))
    api_tgt_fit_rps, = api_tgt_fit_stats.rps
    assert api_tgt_fit_rps.shield == [approx(33.333333), approx(13.94), ANY_VALUE]
    assert api_tgt_fit_rps.armor == [0, 0, ANY_VALUE]
    assert api_tgt_fit_rps.hull == [0, 0, ANY_VALUE]
    api_tgt_ship_stats = api_tgt_ship.get_stats(options=ItemStatsOptions(rps=True))
    api_tgt_ship_rps, = api_tgt_ship_stats.rps
    assert api_tgt_ship_rps.shield == [approx(33.333333), approx(13.94), ANY_VALUE]
    assert api_tgt_ship_rps.armor == [0, 0, ANY_VALUE]
    assert api_tgt_ship_rps.hull == [0, 0, ANY_VALUE]
...
def test_hp_limit_and_range(client, consts):
    ...
    api_tgt_fit_stats = api_tgt_fit.get_stats(options=FitStatsOptions(rps=True))
    api_tgt_fit_rps, = api_tgt_fit_stats.rps
    assert api_tgt_fit_rps.shield == [approx(124.666667), approx(69.25), ANY_VALUE]
    assert api_tgt_fit_rps.armor == [0, 0, ANY_VALUE]
    assert api_tgt_fit_rps.hull == [0, 0, ANY_VALUE]
    api_tgt_ship_stats = api_tgt_ship.get_stats(options=ItemStatsOptions(rps=True))
    api_tgt_ship_rps, = api_tgt_ship_stats.rps
    assert api_tgt_ship_rps.shield == [approx(124.666667), approx(69.25), ANY_VALUE]
    assert api_tgt_ship_rps.armor == [0, 0, ANY_VALUE]
    assert api_tgt_ship_rps.hull == [0, 0, ANY_VALUE]
...
def test_item_not_loaded(client, consts):
    ...
    api_src_drone.change_drone(add_projs=[api_tgt_ship.id, api_tgt_drone.id, api_tgt_fighter.id])
    # Verification
    api_tgt_fit_stats = api_tgt_fit.get_stats(options=FitStatsOptions(rps=True))
