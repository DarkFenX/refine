...
def test_ship_dps_profiles(client, consts):
    ...
    assert api_fit_uniform.shield == [approx(5714.285714), approx(2455.428571), approx(2455.428571), approx(1.428571)]
    ...
    assert api_ship_uniform.shield == [approx(5714.285714), approx(2455.428571), approx(2455.428571), approx(1.428571)]
    ...
    assert api_fit_default.shield == [approx(4444.444444), approx(1909.777778), approx(1909.777778), approx(1.111111)]
    ...
    assert api_ship_default.shield == [approx(4444.444444), approx(1909.777778), approx(1909.777778), approx(1.111111)]
    ...
    assert api_fit_negative.shield == [approx(4444.444444), approx(1909.777778), approx(1909.777778), approx(1.111111)]
    ...
    assert api_ship_negative.shield == [approx(4444.444444), approx(1909.777778), approx(1909.777778), approx(1.111111)]
    ...
    assert api_fit_zero is None
    assert api_ship_zero is None
    # Kin-explosive
    assert api_fit_kin_exp.shield == [approx(8000), approx(3437.6), approx(3437.6), approx(2)]
    ...
    assert api_ship_kin_exp.shield == [approx(8000), approx(3437.6), approx(3437.6), approx(2)]
...
def test_drone_dps_profiles(client, consts):
    ...
    assert api_drone_uniform.shield == [0, approx(78.16092), approx(78.16092), approx(1.37931)]
    ...
    # No dps profile was specified, so default one was used
    assert api_drone_default.shield == [0, approx(62.962963), approx(62.962963), approx(1.111111)]
    ...
    # Negative values were clamped to 0
    assert api_drone_negative.shield == [0, approx(62.962963), approx(62.962963), approx(1.111111)]
    ...
    # Total damage = 0 means no stats returned
    assert api_drone_zero is None
    # Kin-explosive
    assert api_drone_kin_exp.shield == [0, approx(103.030303), approx(103.030303), approx(1.818182)]
...
def test_immunity(client, consts):
    ...
    assert api_fit_em is None
    assert api_fit_uniform is None
    ...
    assert api_ship_em is None
    assert api_ship_uniform is None
    # Action
