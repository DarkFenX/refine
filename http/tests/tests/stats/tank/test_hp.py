...
def test_buffer(client, consts):
    ...
    # Verification
    api_fit_stats = api_fit.get_stats(options=StatsFitOptions(hp=True))
    ...
    api_ship_stats = api_ship.get_stats(options=StatsItemOptions(hp=True))
...
def test_remote_asb_accuracy_and_charge_switch(client, consts):
    ...
    # Verification
    api_tgt_fit_stats = api_tgt_fit.get_stats(options=StatsFitOptions(hp=True))
    ...
    api_tgt_ship_stats = api_tgt_ship.get_stats(options=StatsItemOptions(hp=True))
