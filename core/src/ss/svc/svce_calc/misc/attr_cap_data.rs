...
pub(in crate::ss::svc::svce_calc) struct AttrCapData {
...
impl AttrCapData {
    ...
    // Query methods
    pub(in crate::ss::svc::svce_calc) fn get_capped_attr_ids(
        &mut self,
        item_id: &SsItemId,
    ...
    pub(in crate::ss::svc::svce_calc) fn add_cap(
        &mut self,
        item_id: SsItemId,
        capping_attr_id: EAttrId,
    ...
    pub(in crate::ss::svc::svce_calc) fn clear_item_caps(&mut self, item_id: &SsItemId) {
