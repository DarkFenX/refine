use crate::{
    ...
    ss::{
        item::SsItem,
        svc::svce_calc::modifier::{extend_with_custom_mods, SsAttrMod},
    },
};

pub(in crate::ss::svc::svce_calc) struct CategorizedMods {
    pub(in crate::ss::svc::svce_calc) local: Vec<SsAttrMod>,
    pub(in crate::ss::svc::svce_calc) system_wide: Vec<SsAttrMod>,
    pub(in crate::ss::svc::svce_calc) projected: Vec<SsAttrMod>,
    pub(in crate::ss::svc::svce_calc) fleet: Vec<SsAttrMod>,
}
impl CategorizedMods {
    ...
    pub(in crate::ss::svc::svce_calc) fn from_item_effects(item: &SsItem, effects: &Vec<ad::ArcEffect>) -> Self {
    ...
    pub(in crate::ss::svc::svce_calc) fn iter_all(&self) -> impl Iterator<Item = &SsAttrMod> {
