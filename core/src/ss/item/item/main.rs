...
impl SsItem {
    pub(in crate::ss) fn get_name(&self) -> &'static str {
        match self {
            ...
            Self::FwEffect(_) => SsFwEffect::get_name(),
    ...
    pub(in crate::ss) fn get_id(&self) -> SsItemId {
        match self {
            ...
            Self::FwEffect(fw_effect) => fw_effect.id,
    ...
    pub(in crate::ss) fn get_effect_modes(&self) -> &SsEffectModes {
        match self {
            ...
            Self::FwEffect(fw_effect) => &fw_effect.effect_modes,
    ...
    pub(in crate::ss) fn get_effect_modes_mut(&mut self) -> &mut SsEffectModes {
        match self {
            ...
            Self::FwEffect(fw_effect) => &mut fw_effect.effect_modes,
    ...
    pub(in crate::ss) fn get_a_item_id(&self) -> EItemId {
        match self {
            ...
            Self::FwEffect(fw_effect) => fw_effect.a_item_id,
    ...
    pub(in crate::ss) fn reload_a_item(&mut self, src: &Src) {
        ...
        match self {
            ...
            Self::FwEffect(fw_effect) => fw_effect.a_item = a_item,
    ...
    pub(in crate::ss) fn get_a_item(&self) -> Result<&ad::ArcItem> {
        match self {
            ...
            Self::FwEffect(fw_effect) => fw_effect.a_item.as_ref(),
