...
impl SsFit {
    pub(in crate::ss) fn debug_consistency_check(&self, ss_view: &SsView, seen_items: &mut Vec<SsItemId>) -> bool {
...
fn check_module_charge(ss_view: &SsView, fit_id: &SsFitId, module: &SsModule, seen_items: &mut Vec<SsItemId>) -> bool {
