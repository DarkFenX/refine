...
pub use crate::{
    sol::{
        ...
        sole_item::{
            ...
            AddImplantError, AddModuleError, AddModuleProjError, AddProjEffectError, AddProjEffectProjError,
            AddRigError, AddSkillError, AddSubsystemError, AddSwEffectError, ChangeDroneProjError,
            ChangeFighterProjError, ChangeModuleProjError, GetAutochargeError, GetBoosterError, GetChargeError,
