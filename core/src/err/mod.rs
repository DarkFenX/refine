...
pub use crate::{
    sol::{
        ...
        sole_item::{
            ...
            AddModuleProjError, AddProjEffectProjError, AddRigError, AddSkillError, AddSubsystemError,
            ...
            GetFitImplantsError, GetFitModulesError, GetFitRigsError, GetFitShipError, GetFitSkillsError,
            GetFitStanceError, GetFitSubsystemsError, GetFwEffectError, GetImplantError, GetItemError, GetModuleError,
            GetProjEffectError, GetRigError, GetSkillError, GetSubsystemError, GetSwEffectError, RemoveBoosterError,
            RemoveCharacterError, RemoveChargeError, RemoveDroneError, RemoveDroneMutationError, RemoveDroneProjError,
