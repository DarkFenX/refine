...
pub use breacher_abs_dmg::BreacherAbsDmgError;
pub use breacher_rel_dmg::BreacherRelDmgError;
pub use charge_found::ChargeFoundError;
pub use em_dmg::EmDmgError;
pub use expl_dmg::ExplDmgError;
...
pub use therm_dmg::ThermDmgError;
pub use total_dmg::TotalDmgError;

mod attr_meta_found;
mod breacher_abs_dmg;
mod breacher_rel_dmg;
mod charge_found;
mod em_dmg;
mod expl_dmg;
mod fighter_count;
