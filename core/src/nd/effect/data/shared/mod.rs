pub(in crate::nd::effect::data) mod base_opc;
pub(in crate::nd::effect::data) mod ilimit;
pub(in crate::nd::effect::data) mod missile_dmg_self_srq;
pub(in crate::nd::effect::data) mod mods;
pub(in crate::nd::effect::data) mod proj_mult;
pub(in crate::nd::effect::data) mod sov_stability_generators;
pub(in crate::nd::effect::data) mod spool;
