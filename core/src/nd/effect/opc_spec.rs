use crate::{
    ad::AAttrId,
    nd::{NEffectProjMultGetterX, NEffectResist},
    ...
    T: Copy
{
    ...
    pub(crate) proj_mult_str: Option<NEffectProjMultGetterX> = None,
    pub(crate) proj_mult_chance: Option<NEffectProjMultGetterX> = None,
