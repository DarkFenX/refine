...
////////////////////////////////////////////////////////////////////////////////////////////////////
pub(in crate::nd::effect::output::spec::proj_getter) fn get_missile_range_mult(
    ctx: SvcCtx,
    calc: &mut Calc,
    projector_uid: UItemId,
    proj_data: UProjData,
) -> PValue {
    let max_velocity = PValue::from_value_clamped(calc.get_item_oattr_ffb_extra(
        ctx,
        projector_uid,
        ctx.ac().max_velocity,
        Value::ZERO,
...
pub(in crate::nd::effect::output::spec::proj_getter) fn get_fof_missile_range_mult(
    ctx: SvcCtx,
    calc: &mut Calc,
    projector_uid: UItemId,
    proj_data: UProjData,
...
pub(in crate::nd::effect::output::spec::proj_getter) fn get_bomb_range_mult(
    ctx: SvcCtx,
    calc: &mut Calc,
    projector_uid: UItemId,
    proj_data: UProjData,
    ...
    let agility =
        PValue::from_value_clamped(calc.get_item_oattr_ffb_extra(ctx, projector_uid, ctx.ac().agility, Value::ZERO));
    let aoe_range = PValue::from_value_clamped(calc.get_item_oattr_ffb_extra(
        ctx,
        projector_uid,
...
// Misc effects
////////////////////////////////////////////////////////////////////////////////////////////////////
pub(in crate::nd::effect::output::spec::proj_getter) fn get_aoe_burst_range_mult(
    ctx: SvcCtx,
    calc: &mut Calc,
    projector_uid: UItemId,
    effect: &REffect,
...
pub(in crate::nd::effect::output::spec::proj_getter) fn get_aoe_dd_range_mult(
    ctx: SvcCtx,
    calc: &mut Calc,
    projector_uid: UItemId,
    proj_data: UProjData,
...
pub(in crate::nd::effect::output::spec::proj_getter) fn get_dd_neut_range_mult(
    ctx: SvcCtx,
    calc: &mut Calc,
    projector_uid: UItemId,
    proj_data: UProjData,
