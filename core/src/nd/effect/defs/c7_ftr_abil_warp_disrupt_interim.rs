...
const EFFECT_AID: AEffectId = AEffectId::FTR_ABIL_WARP_DISRUPT_INTERIM;
...
pub(in crate::nd::effect) fn mk_n_effect() -> NEffect {
    NEffect {
        ...
        adg_assign_effect_fn: Some(|a_items| {
            assign_to_item_with_eff(a_items, AEffectId::FTR_ABIL_WARP_DISRUPT, EFFECT_AID)
        }),
        ..
    }
}
    ...
    AEffect {
        ...
        modifiers: [
            AEffectModifier {
                ...
                affectee_attr_id: AAttrId::FTR_ABIL_WARP_DISRUPT_POINT_STR_INTERIM,
            },
            AEffectModifier {
