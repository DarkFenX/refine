...
use crate::{
    ...
    nd::effect::shared::util::get_item_fit_ship_key,
    svc::{
        SvcCtx,
        calc::{
...
// ADG customizations
pub(in crate::nd::effect) fn mk_prop_mass_mod() -> AEffectModifier {
    AEffectModifier {
...
pub(in crate::nd::effect) fn mk_mwd_sig_mod() -> AEffectModifier {
    AEffectModifier {
...
pub(in crate::nd::effect) fn mk_mjd_sig_mod() -> AEffectModifier {
    AEffectModifier {
...
// Calc customizations
pub(in crate::nd::effect) fn add_prop_speed_mod(rmods: &mut Vec<RawModifier>, affector_espec: EffectSpec) {
