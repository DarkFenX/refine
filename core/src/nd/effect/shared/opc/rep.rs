...
pub(in crate::nd::effect) fn get_local_shield_rep_opc(
    ctx: SvcCtx,
    calc: &mut Calc,
    item_key: UItemKey,
    r_effect: &REffect,
...
pub(in crate::nd::effect) fn get_local_armor_rep_opc(
    ctx: SvcCtx,
    calc: &mut Calc,
    item_key: UItemKey,
    r_effect: &REffect,
...
pub(in crate::nd::effect) fn get_local_hull_rep_opc(
    ctx: SvcCtx,
    calc: &mut Calc,
    item_key: UItemKey,
    r_effect: &REffect,
...
pub(in crate::nd::effect) fn get_outgoing_shield_rep_opc(
    ctx: SvcCtx,
    calc: &mut Calc,
...
pub(in crate::nd::effect) fn get_outgoing_armor_rep_opc(
    ctx: SvcCtx,
    calc: &mut Calc,
    projector_key: UItemKey,
    projector_effect: &REffect,
...
pub(in crate::nd::effect) fn get_outgoing_hull_rep_opc(
    ctx: SvcCtx,
    calc: &mut Calc,
    projector_key: UItemKey,
    projector_effect: &REffect,
...
pub(in crate::nd::effect) fn get_outgoing_cap_rep_opc(
    ctx: SvcCtx,
    calc: &mut Calc,
    projector_key: UItemKey,
    projector_effect: &REffect,
