use crate::{
    ...
    nd::{NProjMultGetter, effect::shared::proj_mult::get_aoe_dd_side_neut_proj_mult},
    rd::REffect,
    svc::{
        SvcCtx,
        calc::Calc,
...
pub(in crate::nd::effect) fn get_generic_neut_opc(
    ctx: SvcCtx,
    calc: &mut Calc,
...
pub(in crate::nd::effect) fn get_aoe_dd_side_neut_opc(
    ctx: SvcCtx,
    calc: &mut Calc,
    projector_key: UItemKey,
    projector_effect: &REffect,
