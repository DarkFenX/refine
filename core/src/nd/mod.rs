...
pub(crate) use effect::{
    ...
    NEffectDmgKind, NEffectLocalOpcSpec, NEffectProjOpcSpec, NEffectProjecteeFilter, NMiningGetter, NNeutGetter,
    NNormalDmgGetter, NOutgoingRepGetter, NProjMultGetter, NSpoolRaw, NSpoolResolver,
};
