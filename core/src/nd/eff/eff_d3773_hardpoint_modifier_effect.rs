...
fn update_effect(a_effect: &mut AEffect) {
    ...
    a_effect.mods.extend([
        make_modifier(ac::attrs::TURRET_HARDPOINT_MODIFIER, ac::attrs::TURRET_SLOTS_LEFT),
        make_modifier(ac::attrs::LAUNCHER_HARDPOINT_MODIFIER, ac::attrs::LAUNCHER_SLOTS_LEFT),
    ]);
}
