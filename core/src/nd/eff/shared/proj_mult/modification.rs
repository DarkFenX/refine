...
pub(in crate::nd::eff) fn get_aoe_dd_mod_proj_attrs(_a_effect: &AEffect) -> [Option<AAttrId>; 2] {
    [Some(ac::attrs::MAX_RANGE), None]
}

pub(in crate::nd::eff) fn get_aoe_burst_mod_proj_attrs(_a_effect: &AEffect) -> [Option<AAttrId>; 2] {
