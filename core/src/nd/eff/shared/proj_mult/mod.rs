...
pub(in crate::nd::eff) use composite::{
    ...
    get_neut_proj_mult, get_noapp_aoe_burst_proj_mult, get_noapp_bomb_proj_mult, get_noapp_full_proj_mult,
    get_noapp_simple_c2s_proj_mult, get_noapp_simple_s2s_proj_mult, get_null_proj_mult, get_turret_proj_mult,
