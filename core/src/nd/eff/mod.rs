...
pub(crate) use shared::{NEffectCharge, NEffectChargeDepl, NEffectChargeLoc, NEffectDmgKind, NEffectProjecteeFilter};
...
mod eff_d6197_energy_nosf_falloff;
mod eff_d6201_doomsday_slash;
mod eff_d6208_micro_jump_portal_drive;
mod eff_d6216_struct_energy_neut_falloff;
...
mod eff_d6472_doomsday_beam_dot;
mod eff_d6473_doomsday_cone_dot;
mod eff_d6474_doomsday_hog;
...
fn get_n_effects() -> Vec<NEffect> {
    vec![
        ...
        eff_d6197_energy_nosf_falloff::mk_n_effect(),
        eff_d6201_doomsday_slash::mk_n_effect(),
        eff_d6208_micro_jump_portal_drive::mk_n_effect(),
        eff_d6216_struct_energy_neut_falloff::mk_n_effect(),
        ...
        eff_d6472_doomsday_beam_dot::mk_n_effect(),
        eff_d6473_doomsday_cone_dot::mk_n_effect(),
        eff_d6474_doomsday_hog::mk_n_effect(),
