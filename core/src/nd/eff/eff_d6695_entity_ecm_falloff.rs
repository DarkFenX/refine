use crate::{
    ...
    ed::EEffectId,
    misc::{Ecm, EffectSpec},
    nd::{NEffect, NEffectHc, eff::shared::proj_mult::get_noapp_simple_s2s_proj_mult},
    rd::REffect,
...
fn internal_get_ecm_opc(
    ...
    let duration_s = calc.get_item_attr_val_extra_opt(ctx, projector_key, &ac::attrs::ECM_JAM_DURATION)? / OF(1000.0);
    ...
    if let Some(projectee_key) = projectee_key {
        ...
        mult *= get_noapp_simple_s2s_proj_mult(ctx, calc, projector_key, projector_effect, projectee_key, proj_data);
