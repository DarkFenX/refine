use crate::{
    ...
    nd::{
        NEffect, NEffectHc,
        eff::shared::{proj_mult::get_proj_mult_simple_s2s, rep_opc::get_remote_cap_rep_opc},
    },
    rd::REffect,
...
pub(super) fn mk_n_effect() -> NEffect {
    NEffect {
        ...
        aid: A_EFFECT_ID,
        hc: NEffectHc {
            remote_cap_rep_opc_getter: Some(internal_get_remote_rep_opc),
            ..
        },
        ..
    }
