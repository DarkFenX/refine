...
impl URig {
    pub(crate) fn new(
        ...
        Self {
            base: UItemBase::new(item_id, type_id, bool_to_state_offline(rig_state), src, reuse_eupdates),
            fit_key,
        }
    }
    // Item base methods
    ...
    pub(crate) fn set_rig_state(&mut self, state: bool, reuse_eupdates: &mut UEffectUpdates, src: &Src) {
