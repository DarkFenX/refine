...
impl UDrone {
    pub(crate) fn new(
        ...
        Self {
            base: UItemBaseMutable::new(item_id, type_id, drone_state.into(), mutation, src, reuse_eupdates),
            fit_key,
            projs: Projs::new(),
        }
    }
    ...
    pub(crate) fn set_drone_state(&mut self, state: MinionState, reuse_eupdates: &mut UEffectUpdates, src: &Src) {
