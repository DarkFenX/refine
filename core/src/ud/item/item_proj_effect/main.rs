...
impl UProjEffect {
    pub(crate) fn new(item_id: ItemId, type_aid: AItemId, proj_effect_state: bool, src: &Src) -> Self {
        Self {
            base: UItemBase::new(item_id, type_aid, bool_to_state_active(proj_effect_state), src),
            projs: UProjs::new(),
        }
    }
    // Item base methods
