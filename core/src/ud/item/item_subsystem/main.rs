...
impl USubsystem {
    pub(crate) fn new(
        ...
        Self {
            base: UItemBase::new(
                item_id,
                type_id,
                bool_to_state_offline(subsystem_state),
                src,
                reuse_eupdates,
            ),
            fit_key,
    ...
    pub(crate) fn set_subsystem_state(&mut self, state: bool, reuse_eupdates: &mut UEffectUpdates, src: &Src) {
