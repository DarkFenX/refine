...
impl USwEffect {
    pub(crate) fn new(
        ...
        Self {
            base: UItemBase::new(item_id, type_id, bool_to_state_active(state), src, reuse_eupdates),
        }
    }
    // Item base methods
    ...
    pub(crate) fn set_sw_effect_state(&mut self, state: bool, reuse_eupdates: &mut UEffectUpdates, src: &Src) {
