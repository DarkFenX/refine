...
impl UFwEffect {
    pub(crate) fn new(item_id: ItemId, type_aid: AItemId, fit_uid: UFitId, fw_effect_state: bool, src: &Src) -> Self {
        Self {
            base: UItemBase::new(item_id, type_aid, bool_to_state_active(fw_effect_state), src),
            fit_uid,
        }
    }
    // Item base methods
