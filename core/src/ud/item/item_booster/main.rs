...
impl UBooster {
    pub(crate) fn new(item_id: ItemId, type_id: AItemId, fit_uid: UFitId, booster_state: bool, src: &Src) -> Self {
        Self {
            base: UItemBase::new(item_id, type_id, bool_to_state_offline(booster_state), src),
            fit_uid,
        }
    }
    // Item base methods
