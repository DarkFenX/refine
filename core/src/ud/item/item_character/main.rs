...
impl UCharacter {
    pub(crate) fn new(item_id: ItemId, type_id: AItemId, fit_uid: UFitId, character_state: bool, src: &Src) -> Self {
        Self {
            base: UItemBase::new(item_id, type_id, bool_to_state_offline(character_state), src),
            fit_uid,
        }
    }
    // Item base methods
