...
impl SolarSystem {
    pub(in crate::api) fn internal_set_character_type_aid(
        &mut self,
        ...
        u_character.set_type_aid(type_aid, &self.u_data.r_data);
...
impl<'a> CharacterMut<'a> {
    ...
    pub fn set_type_id(&mut self, type_id: ItemTypeId) {
        ...
        self.sol
            .internal_set_character_type_aid(self.uid, type_id.into_aid(), &mut reuse_eupdates)
    }
}
