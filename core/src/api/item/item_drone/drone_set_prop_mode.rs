...
impl SolarSystem {
    pub(in crate::api) fn internal_set_drone_prop_mode(&mut self, drone_uid: UItemId, npc_prop: Option<NpcProp>) {
...
impl<'a> DroneMut<'a> {
    ...
    pub fn set_prop_mode(&mut self, prop_mode: Option<NpcProp>) {
