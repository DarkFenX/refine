use crate::{api::FitMut, misc::DpsProfile, sol::SolarSystem, ud::UFitKey};

impl SolarSystem {
    pub(in crate::api) fn internal_set_fit_rah_incoming_dps(&mut self, fit_key: UFitKey, dps_profile: DpsProfile) {
