...
impl AItemListId {
    ...
    pub(crate) const CAPITALS_FREIGHTERS: Self = Self::Custom(ACustomItemListId::from_i32(4));
    pub(crate) const PANIC_ELIGIBLE: Self = Self::Custom(ACustomItemListId::from_i32(5));
}
