...
pub(crate) const STABILITY_GENERATOR_ELECTRIC: AEffectId = AEffectId::Custom(7);
pub(crate) const STABILITY_GENERATOR_PLASMA: AEffectId = AEffectId::Custom(8);
pub(crate) const STABILITY_GENERATOR_EXOTIC: AEffectId = AEffectId::Custom(9);
pub(crate) const STABILITY_GENERATOR_GAMMA: AEffectId = AEffectId::Custom(10);
