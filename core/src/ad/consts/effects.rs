...
pub(crate) const POWER_BOOSTER: AEffectId = AEffectId::Dogma(ece::POWER_BOOSTER);
...
pub(crate) const JUMP_PORTAL_GENERATION: AEffectId = AEffectId::Dogma(ece::JUMP_PORTAL_GENERATION);
...
pub(crate) const JUMP_PORTAL_GENERATION_BO: AEffectId = AEffectId::Dogma(ece::JUMP_PORTAL_GENERATION_BO);
...
pub(crate) const SUPER_WEAPON_AMARR: AEffectId = AEffectId::Dogma(ece::SUPER_WEAPON_AMARR);
pub(crate) const SUPER_WEAPON_CALDARI: AEffectId = AEffectId::Dogma(ece::SUPER_WEAPON_CALDARI);
pub(crate) const SUPER_WEAPON_GALLENTE: AEffectId = AEffectId::Dogma(ece::SUPER_WEAPON_GALLENTE);
pub(crate) const SUPER_WEAPON_MINMATAR: AEffectId = AEffectId::Dogma(ece::SUPER_WEAPON_MINMATAR);
...
pub(crate) const DOOMSDAY_SLASH: AEffectId = AEffectId::Dogma(ece::DOOMSDAY_SLASH);
...
pub(crate) const LIGHTNING_WEAPON: AEffectId = AEffectId::Dogma(ece::LIGHTNING_WEAPON);
...
pub(crate) const STRUCT_MOD_EFFECT_TARGET_PAINTER: AEffectId = AEffectId::Dogma(ece::STRUCT_MOD_EFFECT_TARGET_PAINTER);
...
pub(crate) const REMOTE_TARGET_PAINT_ENTITY: AEffectId = AEffectId::Dogma(ece::REMOTE_TARGET_PAINT_ENTITY);
...
pub(crate) const MISSILE_FLIGHT_TIME: AEffectId = AEffectId::Custom(3);
pub(crate) const NOSF_CAP_USE: AEffectId = AEffectId::Custom(4);
pub(crate) const WARP_DISRUPT_PROBE: AEffectId = AEffectId::Custom(5);
pub(crate) const STASIS_WEB_PROBE: AEffectId = AEffectId::Custom(6);
pub(crate) const WDFG_SCRIPT_DEBUBBLE: AEffectId = AEffectId::Custom(7);
pub(crate) const STABILITY_GENERATOR_ELECTRIC: AEffectId = AEffectId::Custom(8);
pub(crate) const STABILITY_GENERATOR_PLASMA: AEffectId = AEffectId::Custom(9);
pub(crate) const STABILITY_GENERATOR_EXOTIC: AEffectId = AEffectId::Custom(10);
pub(crate) const STABILITY_GENERATOR_GAMMA: AEffectId = AEffectId::Custom(11);
