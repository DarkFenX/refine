...
pub(in crate::ad::gnr) struct KeyDb {
    pub(in crate::ad::gnr) items: RSet<EItemId>,
    pub(in crate::ad::gnr) groups: RSet<EItemGrpId>,
    pub(in crate::ad::gnr) item_lists: RSet<EItemListId>,
    pub(in crate::ad::gnr) attrs: RSet<EAttrId>,
    pub(in crate::ad::gnr) effects: RSet<EEffectId>,
    pub(in crate::ad::gnr) abils: RSet<EAbilId>,
    pub(in crate::ad::gnr) buffs: RSet<EBuffId>,
}
impl KeyDb {
    pub(in crate::ad::gnr) fn new() -> Self {
        Self {
            items: RSet::new(),
            groups: RSet::new(),
            item_lists: RSet::new(),
    ...
    // Primary keys
    pub(in crate::ad::gnr) fn new_pkdb(e_data: &EData) -> Self {
    ...
    // Foreign keys
    pub(in crate::ad::gnr) fn new_fkdb(e_data: &EData, g_supp: &GSupport) -> Self {
