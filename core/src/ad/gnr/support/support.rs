...
pub(in crate::ad::gnr) struct GSupport {
    pub(in crate::ad::gnr) grp_cat_map: RMap<EItemGrpId, EItemCatId>,
    pub(in crate::ad::gnr) attr_unit_map: RMap<EAttrId, EAttrUnitId>,
    pub(in crate::ad::gnr) eff_buff_map: RMap<EEffectId, AEffectBuff>,
    // Buffs which can be used, but are not attached to any effect yet
    pub(in crate::ad::gnr) standalone_buffs: Vec<AEffectBuff>,
}
impl GSupport {
    ...
    pub(in crate::ad::gnr) fn fill(&mut self, e_data: &EData) {
