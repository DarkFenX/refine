...
//! data is loaded, cacheable types are stored in memory, thus it provides extremely fast access,
//! but has noticeable initialization time and memory consumption.
