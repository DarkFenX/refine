...
pub(crate) struct RAttrConsts {
    ...
    pub(crate) disallow_docking: Option<RAttrKey>,
    pub(crate) disallow_drive_jumping: Option<RAttrKey>,
    ...
    pub(crate) disallow_tethering: Option<RAttrKey>,
    ...
    pub(crate) ftr_refueling_time: Option<RAttrKey>,
    ...
    pub(crate) gate_scramble_status: Option<RAttrKey>,
...
impl RAttrConsts {
    pub(in crate::rd) fn new(attr_id_key_map: &RMap<AAttrId, RAttrKey>) -> Self {
        ...
        Self {
            ...
            disallow_docking: attr_id_key_map.get(&ac::attrs::DISALLOW_DOCKING).copied(),
            disallow_drive_jumping: attr_id_key_map.get(&ac::attrs::DISALLOW_DRIVE_JUMPING).copied(),
            ...
            disallow_tethering: attr_id_key_map.get(&ac::attrs::DISALLOW_TETHERING).copied(),
            ...
            ftr_refueling_time: attr_id_key_map.get(&ac::attrs::FTR_REFUELING_TIME).copied(),
            ...
            gate_scramble_status: attr_id_key_map.get(&ac::attrs::GATE_SCRAMBLE_STATUS).copied(),
