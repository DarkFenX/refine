...
fn get_data_version(data_handler: &Box<dyn dh::DataHandler>) -> Option<String> {
...
fn need_cache_regen(data_version: Option<String>, cache_handler: &mut Box<dyn ch::CacheHandler>) -> bool {
...
fn regen_cache(data_handler: &Box<dyn dh::DataHandler>) -> IntResult<ch::Data> {
...
fn update_cache(data_version: Option<String>, cache_handler: &mut Box<dyn ch::CacheHandler>, ch_data: ch::Data) {
