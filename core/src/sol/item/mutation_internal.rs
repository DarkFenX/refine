...
#[derive(Clone)]
pub(in crate::sol) struct SolItemMutationInternal {
...
pub(in crate::sol::item) fn get_attrs_mutated<'a>(
    base: &'a SolItemBase,
    mutation: &'a Option<SolItemMutationInternal>,
...
pub(in crate::sol::item) fn update_a_data_mutated(
    ...
    mutation: &mut Option<SolItemMutationInternal>,
) {
    match mutation {
        Some(mutation) => {
...
fn update_mutated_a_data_internal(src: &Src, base: &mut SolItemBase, mutation: &mut SolItemMutationInternal) -> bool {
