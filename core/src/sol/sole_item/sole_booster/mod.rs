...
pub use sole_get_booster_info::GetBoosterInfoError;
pub use sole_get_fit_booster_infos::GetFitBoosterInfosError;
...
mod sole_get_booster_info;
mod sole_get_fit_booster_infos;
