...
pub(in crate::sol::svc) fn check_fit(uad: &SolUad, fit_id: &SolFitId) -> SolDebugResult {
...
pub(in crate::sol::svc) fn check_effect(uad: &SolUad, effect_id: &EEffectId) -> SolDebugResult {
...
pub(in crate::sol::svc) fn check_attr(uad: &SolUad, attr_id: &EAttrId) -> SolDebugResult {
