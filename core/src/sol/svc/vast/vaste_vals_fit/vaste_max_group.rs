...
fn validate_fast(
    ...
    uad: &Uad,
    calc: &mut Calc,
    max_group_all: &HMapHSet<ad::AItemGrpId, ItemId>,
    max_group_limited: &HMap<ItemId, ad::AItemGrpId>,
...
fn get_actual_item_count(max_group_all: &HMapHSet<ad::AItemGrpId, ItemId>, a_item_grp_id: &ad::AItemGrpId) -> Count {
