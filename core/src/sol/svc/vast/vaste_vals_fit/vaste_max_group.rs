...
fn validate_fast(
    ...
    uad: &Uad,
    calc: &mut Calc,
    max_group_all: &StMapSetL1<ad::AItemGrpId, ItemId>,
    max_group_limited: &StMap<ItemId, ad::AItemGrpId>,
...
fn get_actual_item_count(max_group_all: &StMapSetL1<ad::AItemGrpId, ItemId>, a_item_grp_id: &ad::AItemGrpId) -> Count {
