...
pub(in crate::sol) struct VastFitData {
    ...
    pub(in crate::sol::svc::vast) st_light_fighters: RSet<ItemKey>,
    pub(in crate::sol::svc::vast) st_light_fighters_online: RSet<ItemKey>,
    pub(in crate::sol::svc::vast) st_heavy_fighters: RSet<ItemKey>,
    pub(in crate::sol::svc::vast) st_heavy_fighters_online: RSet<ItemKey>,
    pub(in crate::sol::svc::vast) st_support_fighters: RSet<ItemKey>,
    pub(in crate::sol::svc::vast) st_support_fighters_online: RSet<ItemKey>,
