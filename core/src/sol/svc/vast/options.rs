...
pub(in crate::sol) struct ValOptionsInt {
    ...
    pub(in crate::sol::svc::vast) launched_st_support_fighter_count: ValOptionInt,
    pub(in crate::sol::svc::vast) launched_st_light_fighter_count: ValOptionInt,
    pub(in crate::sol::svc::vast) launched_st_heavy_fighter_count: ValOptionInt,
    ...
    pub(in crate::sol::svc::vast) unlaunchable_st_support_fighter: ValOptionInt,
    pub(in crate::sol::svc::vast) unlaunchable_st_light_fighter: ValOptionInt,
    pub(in crate::sol::svc::vast) unlaunchable_st_heavy_fighter: ValOptionInt,
    ...
    pub(in crate::sol::svc::vast) resist_immunity: ValOptionInt,
}
impl ValOptionsInt {
