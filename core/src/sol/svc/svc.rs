...
use super::{misc::SolRunningEffects, svce_calc::SolSvcCalcData, svce_stats::SolSvcStatsData};
...
pub(in crate::sol) struct SolSvcs {
    ...
    pub(in crate::sol::svc) stats: SolSvcStatsData,
}
impl SolSvcs {
