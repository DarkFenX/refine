...
impl Svc {
    ...
    pub(in crate::sol::svc) fn notify_ship_sec_status_changed(&mut self, uad: &Uad, ship: &Ship) {
        self.calc.ship_sec_status_changed(uad, &ship.get_item_id());
    }
