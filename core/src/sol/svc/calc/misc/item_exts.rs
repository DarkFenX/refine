use crate::{
    defs::SolItemId,
    sol::{
        svc::calc::SolLocationKind,
        uad::item::{SolItem, SolShipKind},
    },
};

impl SolItem {
    pub(in crate::sol::svc::calc) fn get_root_loc_kind(&self) -> Option<SolLocationKind> {
        match self {
    ...
    pub(in crate::sol::svc::calc) fn get_other(&self) -> Option<SolItemId> {
        match self {
            Self::Autocharge(_) => None,
            Self::Booster(_) => None,
