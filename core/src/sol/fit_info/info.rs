...
pub struct SolFitInfo {
    ...
    pub structure: Option<SolItemId>,
    pub stance: Option<SolItemId>,
    pub subsystems: Vec<SolItemId>,
    pub mods_high: Vec<SolItemId>,
    pub mods_mid: Vec<SolItemId>,
    pub mods_low: Vec<SolItemId>,
...
impl SolFitInfo {
    pub(in crate::sol) fn new(
        ...
        structure: Option<SolItemId>,
        stance: Option<SolItemId>,
        subsystems: Vec<SolItemId>,
        mods_high: Vec<SolItemId>,
        mods_mid: Vec<SolItemId>,
        mods_low: Vec<SolItemId>,
        rigs: Vec<SolItemId>,
