...
impl<'a> StubSideEffect<'a> {
    pub(in crate::sol::api) fn new(sol: &'a SolarSystem, key: ItemKey, a_effect_id: ad::AEffectId) -> Self {
...
impl<'a> StubSideEffectMut<'a> {
    pub(in crate::sol::api) fn new(sol: &'a mut SolarSystem, key: ItemKey, a_effect_id: ad::AEffectId) -> Self {
        Self { sol, key, a_effect_id }
    }
    pub fn get_effect_id(&self) -> EffectId {
        self.a_effect_id.into()
