...
impl SolarSystem {
    pub(in crate::sol::api) fn internal_set_charge_a_item_id(
        ...
        SolarSystem::util_remove_charge_with_projs(&self.u_data, &mut self.svc, item_key, u_item, reuse_eupdates);
        self.u_data
            .items
            .get_mut(item_key)
            .get_charge_mut()
        ...
        SolarSystem::util_add_charge_with_projs(&self.u_data, &mut self.svc, item_key, reuse_eupdates);
    }
}
