...
impl SolarSystem {
    pub(in crate::sol::api) fn internal_set_fit_ship(&mut self, fit_key: FitKey, type_id: ItemTypeId) -> ItemKey {
        ...
        let uad_ship = UadShip::new(&self.uad.src, item_id, type_id, fit_key, true);
