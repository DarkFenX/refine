...
pub(in crate::sol) struct Fit {
    ...
    pub(in crate::sol) skills: HMap<ItemTypeId, FitSkill>,
    pub(in crate::sol) implants: HSet<ItemId>,
    pub(in crate::sol) boosters: HSet<ItemId>,
    pub(in crate::sol) ship: Option<ItemId>,
    pub(in crate::sol) stance: Option<ItemId>,
    pub(in crate::sol) subsystems: HSet<ItemId>,
    pub(in crate::sol) mods_high: ItemVec,
    pub(in crate::sol) mods_mid: ItemVec,
    pub(in crate::sol) mods_low: ItemVec,
    pub(in crate::sol) rigs: HSet<ItemId>,
    pub(in crate::sol) services: HSet<ItemId>,
    pub(in crate::sol) drones: HSet<ItemId>,
    pub(in crate::sol) fighters: HSet<ItemId>,
    pub(in crate::sol) fw_effects: HSet<ItemId>,
