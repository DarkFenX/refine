...
impl UadItemBase {
    ...
    pub(in crate::sol::uad::item::base) fn base_set_a_item_id(&mut self, a_item_id: ad::AItemId) {
        self.a_item_id = a_item_id;
    }
    pub(in crate::sol::uad::item::base) fn base_set_a_item(&mut self, a_item: ad::ArcItem) {
        match &mut self.cache {
            Some(cache) => cache.a_item = a_item,
            None => self.cache = Some(ItemBaseCache { a_item }),
        }
    }
    pub(in crate::sol::uad::item::base) fn base_remove_a_item(&mut self) {
        self.cache = None;
    }
    pub(in crate::sol::uad::item::base) fn base_get_a_item(&self) -> Option<&ad::ArcItem> {
