use crate::{
    ...
    sol::uad::item::{SolEffectModes, SolItemBase, SolItemState, bool_to_state_offline, state_to_bool},
    src::Src,
    util::{Named, StMap},
};
...
impl SolRig {
    ...
    pub(in crate::sol) fn get_rig_state(&self) -> bool {
        state_to_bool(self.base.get_state())
    }
    pub(in crate::sol) fn set_rig_state(&mut self, state: bool) {
