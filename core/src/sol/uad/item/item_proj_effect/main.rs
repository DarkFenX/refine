use crate::{
    ...
    sol::uad::item::{SolEffectModes, SolItemBase, SolItemState, SolProjs, bool_to_state_active, state_to_bool},
    src::Src,
    util::{Named, StMap},
};
...
impl SolProjEffect {
    ...
    pub(in crate::sol) fn get_proj_effect_state(&self) -> bool {
        state_to_bool(self.base.get_state())
    }
    pub(in crate::sol) fn set_proj_effect_state(&mut self, state: bool) {
