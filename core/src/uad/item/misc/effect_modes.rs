...
#[derive(Clone)]
pub(in crate::uad::item) struct EffectModes {
...
impl EffectModes {
    ...
    // Query methods
    pub(in crate::uad::item) fn get(&self, a_effect_id: &ad::AEffectId) -> EffectMode {
    ...
    pub(in crate::uad::item) fn set(&mut self, a_effect_id: ad::AEffectId, mode: EffectMode) {
        match mode {
