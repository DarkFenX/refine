...
impl UadItemBase {
    ...
    pub(in crate::uad::item::base) fn base_new_with_r_item(
        item_id: ItemId,
        r_item: rd::RcItem,
        a_state: ad::AState,
        src: &Src,
    ...
    pub(in crate::uad::item) fn get_r_ship_kind(&self) -> Option<rd::RShipKind> {
    ...
    pub(in crate::uad::item::base) fn base_set_r_item(
        &mut self,
        r_item: rd::RcItem,
        reuse_eupdates: &mut UadEffectUpdates,
        src: &Src,
    ...
    pub(in crate::uad::item::base) fn base_get_r_item(&self) -> Option<&rd::RcItem> {
    ...
    fn update_reffs(&mut self, reuse_eupdates: &mut UadEffectUpdates, src: &Src) {
