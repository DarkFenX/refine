use crate::{
    ...
    misc::EffectMode,
    src::Src,
    uad::item::{UadEffectUpdates, UadItemBase, bool_to_state_active, state_to_bool},
    util::{Named, RMap, RSet},
};

#[derive(Clone)]
pub(crate) struct UadFwEffect {
    base: UadItemBase,
    fit_key: FitKey,
}
impl UadFwEffect {
    ...
    pub(crate) fn set_fw_effect_state(&mut self, state: bool, reuse_eupdates: &mut UadEffectUpdates, src: &Src) {
