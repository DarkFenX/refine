...
impl Svc {
    pub(crate) fn get_stat_fit_high_slots(&mut self, u_data: &UData, fit_key: UFitId, fit: &UFit) -> StatSlot {
        self.vast
            .get_fit_data(&fit_key)
            .get_stat_high_slots(SvcCtx::new(u_data, &self.eff_projs), &mut self.calc, fit)
    }
    pub(crate) fn get_stat_fit_mid_slots(&mut self, u_data: &UData, fit_key: UFitId, fit: &UFit) -> StatSlot {
        self.vast
            .get_fit_data(&fit_key)
            .get_stat_mid_slots(SvcCtx::new(u_data, &self.eff_projs), &mut self.calc, fit)
    }
    pub(crate) fn get_stat_fit_low_slots(&mut self, u_data: &UData, fit_key: UFitId, fit: &UFit) -> StatSlot {
        self.vast
            .get_fit_data(&fit_key)
            .get_stat_low_slots(SvcCtx::new(u_data, &self.eff_projs), &mut self.calc, fit)
    }
    pub(crate) fn get_stat_fit_turret_slots(&mut self, u_data: &UData, fit_key: UFitId, fit: &UFit) -> StatSlot {
    ...
    pub(crate) fn get_stat_fit_launcher_slots(&mut self, u_data: &UData, fit_key: UFitId, fit: &UFit) -> StatSlot {
    ...
    pub(crate) fn get_stat_fit_rig_slots(&mut self, u_data: &UData, fit_key: UFitId, fit: &UFit) -> StatSlot {
        self.vast
            .get_fit_data(&fit_key)
            .get_stat_rig_slots(SvcCtx::new(u_data, &self.eff_projs), &mut self.calc, fit)
    }
    pub(crate) fn get_stat_fit_service_slots(&mut self, u_data: &UData, fit_key: UFitId, fit: &UFit) -> StatSlot {
    ...
    pub(crate) fn get_stat_fit_subsystem_slots(&mut self, u_data: &UData, fit_key: UFitId, fit: &UFit) -> StatSlot {
    ...
    pub(crate) fn get_stat_fit_launched_drones(&mut self, u_data: &UData, fit_key: UFitId, fit: &UFit) -> StatSlot {
    ...
    pub(crate) fn get_stat_fit_launched_fighters(&mut self, u_data: &UData, fit_key: UFitId, fit: &UFit) -> StatSlot {
