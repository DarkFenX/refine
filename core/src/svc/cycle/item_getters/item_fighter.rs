...
pub(super) fn get_fighter_cseq_map(
    ...
    //     );
    // }
    // // If there are any self-killer effects, choose the fastest one, and discard all other
    // effects if !self_killers.is_empty() {
...
//         // Burst mode - assume fighter never docks to rearm, and keeps cycling its effects like
...
//         // applied instantly, e.g. micro bomb from LR fighters disappears when fighter is
// recalled),         // but ignore ongoing cooldowns.
...
//                             }),
//                             rearm: Some(FtrEffectRearmInfo {
//                                 time_until_rearm_s: (duration_s + cd_inactivity_s) *
// early_cycle_count as f64
//                                     + duration_s,
//                                 full_rearm_time_s,
//                                 charge_rearm_time_s: effect_data.charge_reload_time_s,
//                             }),
