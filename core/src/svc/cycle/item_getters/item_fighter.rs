...
impl CycleSoftDtFull {
    ...
    // volleys arrived at the same interval as ability duration (14 seconds). So any duration passed
    // into this method shouldn't increase up to 1 server tick, unlike with modules.
