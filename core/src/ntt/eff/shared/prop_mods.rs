...
use crate::{
    ...
    ntt::eff::shared::util::get_item_fit_ship_key,
    svc::{
        SvcCtx,
        calc::{
...
// ADG customizations
pub(in crate::ntt::eff) fn mk_a_modifier_mass() -> ad::AEffectModifier {
    ad::AEffectModifier {
...
pub(in crate::ntt::eff) fn mk_a_modifier_sig() -> ad::AEffectModifier {
    ad::AEffectModifier {
...
// Calc customizations
pub(in crate::ntt::eff) fn calc_add_custom_modifier(rmods: &mut Vec<RawModifier>, affector_espec: EffectSpec) {
