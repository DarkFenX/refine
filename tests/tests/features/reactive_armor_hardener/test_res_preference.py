...
def test_multi(client, consts):
    ...
    assert api_rah.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.82)
    assert api_rah.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.82)
    assert api_rah.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.88)
    api_ship.update()
    assert api_ship.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.594)
    assert api_ship.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.5535)
    assert api_ship.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.5535)
    assert api_ship.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.594)
...
def test_therm_kin_expl(client, consts):
    ...
    assert api_rah.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.82)
    assert api_rah.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.775)
    assert api_rah.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.805)
    api_ship.update()
    assert api_ship.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.675)
    assert api_ship.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.5535)
    assert api_ship.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.523125)
    assert api_ship.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.543375)
...
def test_em_kin_expl(client, consts):
    ...
    api_rah.update()
    assert api_rah.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.805)
    assert api_rah.attrs[eve_basic_info.res_therm_attr_id].modified == approx(1)
    assert api_rah.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.82)
    assert api_rah.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.775)
    api_ship.update()
    assert api_ship.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.543375)
    assert api_ship.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.675)
    assert api_ship.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.5535)
    assert api_ship.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.523125)
...
def test_em_therm_expl(client, consts):
    ...
    assert api_ship.attrs[eve_basic_info.res_em_attr_id].modified == approx(0.543375)
    assert api_ship.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.5535)
    assert api_ship.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.675)
    assert api_ship.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.523125)
...
def test_em_therm_kin(client, consts):
    ...
    assert api_ship.attrs[eve_basic_info.res_therm_attr_id].modified == approx(0.5535)
    assert api_ship.attrs[eve_basic_info.res_kin_attr_id].modified == approx(0.523125)
    assert api_ship.attrs[eve_basic_info.res_expl_attr_id].modified == approx(0.675)
