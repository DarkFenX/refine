...
def test_simple(client, consts):
    ...
    api_fleet_stats = api_fleet.get_stats(options=FleetStatsOptions(dmg=[
        ...
        StatsOptionFitDmg(time=StatTimeSim(time=None), projectee_item_id=api_tgt_ship.id)]))
...
def test_reload_gap_realistic(client, consts):
    ...
    api_fleet_stats = api_fleet.get_stats(options=FleetStatsOptions(dmg=[
        ...
        StatsOptionFitDmg(time=StatTimeBurst(), projectee_item_id=api_tgt_ship.id)]))
    api_fleet_dmg_stats_raw, api_fleet_dmg_stats_applied = api_fleet_stats.dmg
    ...
    api_fleet_stats = api_fleet.get_stats(options=FleetStatsOptions(dmg=[
        StatsOptionFitDmg(time=StatTimeSim(time=0.1)),
        StatsOptionFitDmg(time=StatTimeSim(time=0.1), projectee_item_id=api_tgt_ship.id)]))
    api_fleet_dmg_stats_raw, api_fleet_dmg_stats_applied = api_fleet_stats.dmg
    ...
    api_fleet_stats = api_fleet.get_stats(options=FleetStatsOptions(dmg=[
        StatsOptionFitDmg(time=StatTimeSim(time=0.9)),
        StatsOptionFitDmg(time=StatTimeSim(time=0.9), projectee_item_id=api_tgt_ship.id)]))
    api_fleet_dmg_stats_raw, api_fleet_dmg_stats_applied = api_fleet_stats.dmg
    ...
    api_fleet_stats = api_fleet.get_stats(options=FleetStatsOptions(dmg=[
        StatsOptionFitDmg(time=StatTimeSim(time=1.1)),
        StatsOptionFitDmg(time=StatTimeSim(time=1.1), projectee_item_id=api_tgt_ship.id)]))
    api_fleet_dmg_stats_raw, api_fleet_dmg_stats_applied = api_fleet_stats.dmg
    ...
    api_fleet_stats = api_fleet.get_stats(options=FleetStatsOptions(dmg=[
        StatsOptionFitDmg(time=StatTimeSim(time=976.1)),
        StatsOptionFitDmg(time=StatTimeSim(time=976.1), projectee_item_id=api_tgt_ship.id)]))
    api_fleet_dmg_stats_raw, api_fleet_dmg_stats_applied = api_fleet_stats.dmg
    ...
    api_fleet_stats = api_fleet.get_stats(options=FleetStatsOptions(dmg=[
        StatsOptionFitDmg(time=StatTimeSim(time=990.1)),
        StatsOptionFitDmg(time=StatTimeSim(time=990.1), projectee_item_id=api_tgt_ship.id)]))
    api_fleet_dmg_stats_raw, api_fleet_dmg_stats_applied = api_fleet_stats.dmg
    ...
    api_fleet_stats = api_fleet.get_stats(options=FleetStatsOptions(dmg=[
        StatsOptionFitDmg(time=StatTimeSim(time=991.1)),
        StatsOptionFitDmg(time=StatTimeSim(time=991.1), projectee_item_id=api_tgt_ship.id)]))
    api_fleet_dmg_stats_raw, api_fleet_dmg_stats_applied = api_fleet_stats.dmg
...
def test_cycle_and_reload_gaps(client, consts):
    ...
    api_fleet_stats = api_fleet.get_stats(options=FleetStatsOptions(dmg=[
        StatsOptionFitDmg(time=StatTimeSim(time=629.999999999)),
        StatsOptionFitDmg(time=StatTimeSim(time=629.999999999), projectee_item_id=api_tgt_ship.id)]))
    api_fleet_dmg_stats_raw, api_fleet_dmg_stats_applied = api_fleet_stats.dmg
    assert api_fleet_dmg_stats_raw.dps.breacher == [approx(599.206349), approx(0.005992063)]
    assert api_fleet_dmg_stats_raw.volley.breacher == [approx(1000), approx(0.01)]
    assert api_fleet_dmg_stats_applied.dps.breacher == approx(361.111111)
    ...
    api_fleet_stats = api_fleet.get_stats(options=FleetStatsOptions(dmg=[
        StatsOptionFitDmg(time=StatTimeSim(time=1889.999999999)),
        StatsOptionFitDmg(time=StatTimeSim(time=1889.999999999), projectee_item_id=api_tgt_ship.id)]))
    api_fleet_dmg_stats_raw, api_fleet_dmg_stats_applied = api_fleet_stats.dmg
    assert api_fleet_dmg_stats_raw.dps.breacher == [approx(599.206349), approx(0.005992063)]
    assert api_fleet_dmg_stats_raw.volley.breacher == [approx(1000), approx(0.01)]
    assert api_fleet_dmg_stats_applied.dps.breacher == approx(361.111111)
    ...
    api_fleet_stats = api_fleet.get_stats(options=FleetStatsOptions(dmg=[
        StatsOptionFitDmg(time=StatTimeSim(time=852.2)),
        StatsOptionFitDmg(time=StatTimeSim(time=852.2), projectee_item_id=api_tgt_ship.id)]))
    api_fleet_dmg_stats_raw, api_fleet_dmg_stats_applied = api_fleet_stats.dmg
    ...
    api_fleet_stats = api_fleet.get_stats(options=FleetStatsOptions(dmg=[
        StatsOptionFitDmg(time=StatTimeSim(time=2112.2)),
        StatsOptionFitDmg(time=StatTimeSim(time=2112.2), projectee_item_id=api_tgt_ship.id)]))
    api_fleet_dmg_stats_raw, api_fleet_dmg_stats_applied = api_fleet_stats.dmg
