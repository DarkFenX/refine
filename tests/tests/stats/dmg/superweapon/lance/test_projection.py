...
def test_range(client, consts):
    ...
    # Action
    api_tgt_ship.change_ship(coordinates=(0, 212299, 0))
    ...
    # putting target at ~202400 meters surface-to-surface range, and then moving target out of
    ...
    assert api_module_nonproj_dmg_stats.volley == [approx(103125), 0, 0, 0]
    # Action
    api_tgt_ship.change_ship(coordinates=(0, 212301, 0))
...
def test_dd_attr_range_optimal_absent(client, consts):
    ...
    assert api_module_nonproj_dmg_stats.volley == [approx(103125), 0, 0, 0]
    # Action
    api_tgt_ship.change_ship(coordinates=(0, 12299, 0))
    # Verification
    api_module_proj_dmg_stats = api_src_module_proj.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_module_proj_dmg_stats.dps == [approx(6445.3125), 0, 0, 0]
    ...
    assert api_module_nonproj_dmg_stats.volley == [approx(103125), 0, 0, 0]
    # Action
    api_tgt_ship.change_ship(coordinates=(0, 12301, 0))
    # Verification
    api_module_proj_dmg_stats = api_src_module_proj.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_module_proj_dmg_stats.dps == [0, 0, 0, 0]
