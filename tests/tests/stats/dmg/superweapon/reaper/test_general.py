...
def test_time(client, consts):
    ...
    api_fleet_dmg_stats = api_fleet.get_stats(options=FleetStatsOptions(
        dmg=[StatsOptionFitDmg(time=StatTimeSim(time=9.9))])).dmg.one()
    ...
    assert api_fit_dmg_stats.volley == [0, 0, 0, 0]
    api_module_dmg_stats = api_module.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(time=StatTimeSim(time=9.9))])).dmg.one()
    ...
    api_fleet_dmg_stats = api_fleet.get_stats(options=FleetStatsOptions(
        dmg=[StatsOptionFitDmg(time=StatTimeSim(time=10.1))])).dmg.one()
    ...
    assert api_fit_dmg_stats.volley == [0, 0, 0, approx(206250)]
    api_module_dmg_stats = api_module.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(time=StatTimeSim(time=10.1))])).dmg.one()
    ...
    api_fleet_dmg_stats = api_fleet.get_stats(options=FleetStatsOptions(
        dmg=[StatsOptionFitDmg(time=StatTimeSim(time=20.1))])).dmg.one()
    ...
    assert api_fit_dmg_stats.volley == [0, 0, 0, approx(206250)]
    api_module_dmg_stats = api_module.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(time=StatTimeSim(time=20.1))])).dmg.one()
    assert api_module_dmg_stats.dps == [0, 0, 0, approx(10261.19403)]
    assert api_module_dmg_stats.volley == [0, 0, 0, approx(206250)]
    # Verification - sim with time before damage of second cycle
    api_fleet_dmg_stats = api_fleet.get_stats(options=FleetStatsOptions(
        dmg=[StatsOptionFitDmg(time=StatTimeSim(time=249.9))])).dmg.one()
    ...
    assert api_fit_dmg_stats.volley == [0, 0, 0, approx(206250)]
    api_module_dmg_stats = api_module.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(time=StatTimeSim(time=249.9))])).dmg.one()
    assert api_module_dmg_stats.dps == [0, 0, 0, approx(825.330132)]
    assert api_module_dmg_stats.volley == [0, 0, 0, approx(206250)]
    # Verification - sim with time after damage of second cycle
    api_fleet_dmg_stats = api_fleet.get_stats(options=FleetStatsOptions(
        dmg=[StatsOptionFitDmg(time=StatTimeSim(time=250.1))])).dmg.one()
    ...
    assert api_fit_dmg_stats.volley == [0, 0, 0, approx(206250)]
    api_module_dmg_stats = api_module.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(time=StatTimeSim(time=250.1))])).dmg.one()
