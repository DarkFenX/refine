...
def test_range(client, consts):
    ...
    api_fighter_proj_dmg_stats = api_src_fighter_proj.get_stats(options=ItemStatsOptions(dmg=[
        StatsOptionItemDmg(projectee_item_id=api_tgt_ship.id, charges=consts.ApiStatItemCharges.include),
    ])).dmg.one()
    ...
    api_fighter_nonproj_dmg_stats = api_src_fighter_nonproj.get_stats(options=ItemStatsOptions(dmg=[
        StatsOptionItemDmg(projectee_item_id=api_tgt_ship.id, charges=consts.ApiStatItemCharges.include),
    ])).dmg.one()
