...
def test_range(client, consts):
    ...
    assert api_fleet_dmg_stats.dps == [0, 0, approx(279.34176), 0]
    assert api_fleet_dmg_stats.volley == [0, 0, approx(1117.36704), 0]
    api_src_fit_dmg_stats = api_src_fit.get_stats(options=FitStatsOptions(
        dmg=[StatsOptionFitDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_src_fit_dmg_stats.dps == [0, 0, approx(279.34176), 0]
    assert api_src_fit_dmg_stats.volley == [0, 0, approx(1117.36704), 0]
    ...
    api_fleet_dmg_stats = api_fleet.get_stats(options=FleetStatsOptions(
        dmg=[StatsOptionFitDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_fleet_dmg_stats.dps == [0, 0, approx(108.71776), 0]
    assert api_fleet_dmg_stats.volley == [0, 0, approx(434.87104), 0]
    api_src_fit_dmg_stats = api_src_fit.get_stats(options=FitStatsOptions(
        dmg=[StatsOptionFitDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_src_fit_dmg_stats.dps == [0, 0, approx(108.71776), 0]
    assert api_src_fit_dmg_stats.volley == [0, 0, approx(434.87104), 0]
    api_drone_proj_dmg_stats = api_src_drone_proj.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_drone_proj_dmg_stats.dps == [0, 0, approx(54.35888), 0]
    assert api_drone_proj_dmg_stats.volley == [0, 0, approx(217.43552), 0]
    api_drone_nonproj_dmg_stats = api_src_drone_nonproj.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_drone_nonproj_dmg_stats.dps == [0, 0, approx(54.35888), 0]
    assert api_drone_nonproj_dmg_stats.volley == [0, 0, approx(217.43552), 0]
    # Action
    api_tgt_ship.change_ship(coordinates=(0, 16250, 0))
    # Verification - 2 falloffs
    api_fleet_dmg_stats = api_fleet.get_stats(options=FleetStatsOptions(
        dmg=[StatsOptionFitDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_fleet_dmg_stats.dps == [0, 0, approx(15.85926), 0]
    assert api_fleet_dmg_stats.volley == [0, 0, approx(63.43704), 0]
    api_src_fit_dmg_stats = api_src_fit.get_stats(options=FitStatsOptions(
        dmg=[StatsOptionFitDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_src_fit_dmg_stats.dps == [0, 0, approx(15.85926), 0]
    assert api_src_fit_dmg_stats.volley == [0, 0, approx(63.43704), 0]
    api_drone_proj_dmg_stats = api_src_drone_proj.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_drone_proj_dmg_stats.dps == [0, 0, approx(7.92963), 0]
    assert api_drone_proj_dmg_stats.volley == [0, 0, approx(31.71852), 0]
    api_drone_nonproj_dmg_stats = api_src_drone_nonproj.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_drone_nonproj_dmg_stats.dps == [0, 0, approx(7.92963), 0]
    assert api_drone_nonproj_dmg_stats.volley == [0, 0, approx(31.71852), 0]
    # Action
    api_tgt_ship.change_ship(coordinates=(0, 22000, 0))
    # Verification - more than 3 falloffs, still some damage applied
    api_fleet_dmg_stats = api_fleet.get_stats(options=FleetStatsOptions(
        dmg=[StatsOptionFitDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_fleet_dmg_stats.dps == [0, 0, approx(0.8507453), 0]
    assert api_fleet_dmg_stats.volley == [0, 0, approx(3.402981), 0]
    api_src_fit_dmg_stats = api_src_fit.get_stats(options=FitStatsOptions(
        dmg=[StatsOptionFitDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_src_fit_dmg_stats.dps == [0, 0, approx(0.8507453), 0]
    assert api_src_fit_dmg_stats.volley == [0, 0, approx(3.402981), 0]
    api_drone_proj_dmg_stats = api_src_drone_proj.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_drone_proj_dmg_stats.dps == [0, 0, approx(0.4253726), 0]
    assert api_drone_proj_dmg_stats.volley == [0, 0, approx(1.701491), 0]
    api_drone_nonproj_dmg_stats = api_src_drone_nonproj.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_drone_nonproj_dmg_stats.dps == [0, 0, approx(0.4253726), 0]
    assert api_drone_nonproj_dmg_stats.volley == [0, 0, approx(1.701491), 0]
...
def test_application(client, consts):
    ...
    api_fleet_dmg_stats = api_fleet.get_stats(options=FleetStatsOptions(
        dmg=[StatsOptionFitDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_fleet_dmg_stats.dps == [0, 0, approx(27.113054), 0]
    assert api_fleet_dmg_stats.volley == [0, 0, approx(108.452217), 0]
    api_src_fit_dmg_stats = api_src_fit.get_stats(options=FitStatsOptions(
        dmg=[StatsOptionFitDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_src_fit_dmg_stats.dps == [0, 0, approx(27.113054), 0]
    assert api_src_fit_dmg_stats.volley == [0, 0, approx(108.452217), 0]
    api_drone_proj_dmg_stats = api_src_drone_proj.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_drone_proj_dmg_stats.dps == [0, 0, approx(13.556527), 0]
    assert api_drone_proj_dmg_stats.volley == [0, 0, approx(54.226108), 0]
    api_drone_nonproj_dmg_stats = api_src_drone_nonproj.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_drone_nonproj_dmg_stats.dps == [0, 0, approx(13.556527), 0]
    assert api_drone_nonproj_dmg_stats.volley == [0, 0, approx(54.226108), 0]
    # Action
    api_tgt_ship.change_ship(coordinates=(0, 3178, 0))
    # Verification - easier to hit at a bit higher range
    api_fleet_dmg_stats = api_fleet.get_stats(options=FleetStatsOptions(
        dmg=[StatsOptionFitDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_fleet_dmg_stats.dps == [0, 0, approx(244.321028), 0]
    assert api_fleet_dmg_stats.volley == [0, 0, approx(977.284111), 0]
    api_src_fit_dmg_stats = api_src_fit.get_stats(options=FitStatsOptions(
        dmg=[StatsOptionFitDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_src_fit_dmg_stats.dps == [0, 0, approx(244.321028), 0]
    assert api_src_fit_dmg_stats.volley == [0, 0, approx(977.284111), 0]
    api_drone_proj_dmg_stats = api_src_drone_proj.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_drone_proj_dmg_stats.dps == [0, 0, approx(122.160514), 0]
    assert api_drone_proj_dmg_stats.volley == [0, 0, approx(488.642055), 0]
    api_drone_nonproj_dmg_stats = api_src_drone_nonproj.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_drone_nonproj_dmg_stats.dps == [0, 0, approx(122.160514), 0]
    assert api_drone_nonproj_dmg_stats.volley == [0, 0, approx(488.642055), 0]
    # Action
    api_tgt_ship.change_ship(movement=(0, 0, 1))
    # Verification - hard to hit at high speed
    api_fleet_dmg_stats = api_fleet.get_stats(options=FleetStatsOptions(
        dmg=[StatsOptionFitDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_fleet_dmg_stats.dps == [0, 0, approx(21.747335), 0]
    assert api_fleet_dmg_stats.volley == [0, 0, approx(86.989339), 0]
    api_src_fit_dmg_stats = api_src_fit.get_stats(options=FitStatsOptions(
        dmg=[StatsOptionFitDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_src_fit_dmg_stats.dps == [0, 0, approx(21.747335), 0]
    assert api_src_fit_dmg_stats.volley == [0, 0, approx(86.989339), 0]
    api_drone_proj_dmg_stats = api_src_drone_proj.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_drone_proj_dmg_stats.dps == [0, 0, approx(10.873667), 0]
    assert api_drone_proj_dmg_stats.volley == [0, 0, approx(43.49467), 0]
    api_drone_nonproj_dmg_stats = api_src_drone_nonproj.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_drone_nonproj_dmg_stats.dps == [0, 0, approx(10.873667), 0]
    assert api_drone_nonproj_dmg_stats.volley == [0, 0, approx(43.49467), 0]
    # Action
    ...
    api_fleet_dmg_stats = api_fleet.get_stats(options=FleetStatsOptions(
        dmg=[StatsOptionFitDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_fleet_dmg_stats.dps == [0, 0, approx(272.272103), 0]
    assert api_fleet_dmg_stats.volley == [0, 0, approx(1089.088412), 0]
    api_src_fit_dmg_stats = api_src_fit.get_stats(options=FitStatsOptions(
        dmg=[StatsOptionFitDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_src_fit_dmg_stats.dps == [0, 0, approx(272.272103), 0]
    assert api_src_fit_dmg_stats.volley == [0, 0, approx(1089.088412), 0]
    api_drone_proj_dmg_stats = api_src_drone_proj.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_drone_proj_dmg_stats.dps == [0, 0, approx(136.136051), 0]
    assert api_drone_proj_dmg_stats.volley == [0, 0, approx(544.544206), 0]
    api_drone_nonproj_dmg_stats = api_src_drone_nonproj.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_drone_nonproj_dmg_stats.dps == [0, 0, approx(136.136051), 0]
    assert api_drone_nonproj_dmg_stats.volley == [0, 0, approx(544.544206), 0]
    # Action
    ...
    api_fleet_dmg_stats = api_fleet.get_stats(options=FleetStatsOptions(
        dmg=[StatsOptionFitDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_fleet_dmg_stats.dps == [0, 0, approx(274.678174), 0]
    assert api_fleet_dmg_stats.volley == [0, 0, approx(1098.712696), 0]
    api_src_fit_dmg_stats = api_src_fit.get_stats(options=FitStatsOptions(
        dmg=[StatsOptionFitDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_src_fit_dmg_stats.dps == [0, 0, approx(274.678174), 0]
    assert api_src_fit_dmg_stats.volley == [0, 0, approx(1098.712696), 0]
    api_drone_proj_dmg_stats = api_src_drone_proj.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_drone_proj_dmg_stats.dps == [0, 0, approx(137.339087), 0]
    assert api_drone_proj_dmg_stats.volley == [0, 0, approx(549.356348), 0]
    api_drone_nonproj_dmg_stats = api_src_drone_nonproj.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    ...
    api_fleet_dmg_stats = api_fleet.get_stats(options=FleetStatsOptions(
        dmg=[StatsOptionFitDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_fleet_dmg_stats.dps == [0, 0, approx(277.494088), 0]
    assert api_fleet_dmg_stats.volley == [0, 0, approx(1109.976352), 0]
    api_src_fit_dmg_stats = api_src_fit.get_stats(options=FitStatsOptions(
        dmg=[StatsOptionFitDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_src_fit_dmg_stats.dps == [0, 0, approx(277.494088), 0]
    assert api_src_fit_dmg_stats.volley == [0, 0, approx(1109.976352), 0]
    api_drone_proj_dmg_stats = api_src_drone_proj.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_drone_proj_dmg_stats.dps == [0, 0, approx(138.747044), 0]
    assert api_drone_proj_dmg_stats.volley == [0, 0, approx(554.988176), 0]
    api_drone_nonproj_dmg_stats = api_src_drone_nonproj.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_drone_nonproj_dmg_stats.dps == [0, 0, approx(138.747044), 0]
    assert api_drone_nonproj_dmg_stats.volley == [0, 0, approx(554.988176), 0]
    # Action
    ...
    api_fleet_dmg_stats = api_fleet.get_stats(options=FleetStatsOptions(
        dmg=[StatsOptionFitDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_fleet_dmg_stats.dps == [0, 0, approx(266.207424), 0]
    assert api_fleet_dmg_stats.volley == [0, 0, approx(1064.829694), 0]
    api_src_fit_dmg_stats = api_src_fit.get_stats(options=FitStatsOptions(
        dmg=[StatsOptionFitDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_src_fit_dmg_stats.dps == [0, 0, approx(266.207424), 0]
    assert api_src_fit_dmg_stats.volley == [0, 0, approx(1064.829694), 0]
    api_drone_proj_dmg_stats = api_src_drone_proj.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_drone_proj_dmg_stats.dps == [0, 0, approx(133.103712), 0]
    assert api_drone_proj_dmg_stats.volley == [0, 0, approx(532.414847), 0]
    api_drone_nonproj_dmg_stats = api_src_drone_nonproj.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    ...
    api_fleet_dmg_stats = api_fleet.get_stats(options=FleetStatsOptions(
        dmg=[StatsOptionFitDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_fleet_dmg_stats.dps == [0, 0, approx(247.350615), 0]
    assert api_fleet_dmg_stats.volley == [0, 0, approx(989.40246), 0]
    api_src_fit_dmg_stats = api_src_fit.get_stats(options=FitStatsOptions(
        dmg=[StatsOptionFitDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_src_fit_dmg_stats.dps == [0, 0, approx(247.350614), 0]
    assert api_src_fit_dmg_stats.volley == [0, 0, approx(989.40246), 0]
    api_drone_proj_dmg_stats = api_src_drone_proj.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_drone_proj_dmg_stats.dps == [0, 0, approx(123.675307), 0]
    assert api_drone_proj_dmg_stats.volley == [0, 0, approx(494.70123), 0]
    api_drone_nonproj_dmg_stats = api_src_drone_nonproj.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_drone_nonproj_dmg_stats.dps == [0, 0, approx(123.675307), 0]
...
def test_crit(client, consts):
    ...
    assert api_drone_stats_default.dps == [0, 0, approx(54.35888), 0]
    assert api_drone_stats_default.volley == [0, 0, approx(217.43552), 0]
    assert api_drone_stats_excluded.dps == [0, 0, approx(51.686432), 0]
    assert api_drone_stats_excluded.volley == [0, 0, approx(206.745729), 0]
    assert api_drone_stats_included.dps == [0, 0, approx(54.35888), 0]
    assert api_drone_stats_included.volley == [0, 0, approx(217.43552), 0]
    # Action
    api_tgt_ship.change_ship(coordinates=(0, 21250, 0))
    ...
    api_drone_stats = api_src_drone.get_stats(options=ItemStatsOptions(dmg=[
        ...
        StatsOptionItemDmg(crits=consts.ApiStatCrits.include, projectee_item_id=api_tgt_ship.id)]))
    api_drone_stats_default, api_drone_stats_excluded, api_drone_stats_included = api_drone_stats.dmg
    assert api_drone_stats_default.dps == [0, 0, approx(0.80625), 0]
    assert api_drone_stats_default.volley == [0, 0, approx(3.225), 0]
    assert api_drone_stats_excluded.dps == [0, 0, approx(0.1353114), 0]
    assert api_drone_stats_excluded.volley == [0, 0, approx(0.5412455), 0]
    assert api_drone_stats_included.dps == [0, 0, approx(0.80625), 0]
    assert api_drone_stats_included.volley == [0, 0, approx(3.225), 0]
...
def test_tgt_npc_prop_mode(client, consts):
    ...
    assert api_drone_proj_dmg_stats.dps == [0, 0, approx(57.874072), 0]
    assert api_drone_proj_dmg_stats.volley == [0, 0, approx(231.496286), 0]
    api_drone_nonproj_dmg_stats = api_src_drone_nonproj.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(projectee_item_id=api_tgt_drone.id)])).dmg.one()
    ...
    api_drone_proj_dmg_stats = api_src_drone_proj.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(projectee_item_id=api_tgt_drone.id)])).dmg.one()
    assert api_drone_proj_dmg_stats.dps == [0, 0, approx(120.271915), 0]
    assert api_drone_proj_dmg_stats.volley == [0, 0, approx(481.08766), 0]
    api_drone_nonproj_dmg_stats = api_src_drone_nonproj.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(projectee_item_id=api_tgt_drone.id)])).dmg.one()
...
def test_drone_effect_range_falloff_absent(client, consts):
    ...
    api_drone_proj_dmg_stats = api_src_drone_proj.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_drone_proj_dmg_stats.dps == [0, 0, 0, 0]
    assert api_drone_proj_dmg_stats.volley == [0, 0, 0, 0]
    api_drone_nonproj_dmg_stats = api_src_drone_nonproj.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_drone_nonproj_dmg_stats.dps == [0, 0, 0, 0]
    assert api_drone_nonproj_dmg_stats.volley == [0, 0, 0, 0]
...
def test_drone_attr_speed_chase_absent(client, consts):
    ...
    api_drone_proj_dmg_stats = api_src_drone_proj.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_drone_proj_dmg_stats.dps == [0, 0, approx(135.249975), 0]
    assert api_drone_proj_dmg_stats.volley == [0, 0, approx(540.999898), 0]
    api_drone_nonproj_dmg_stats = api_src_drone_nonproj.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(projectee_item_id=api_tgt_ship.id)])).dmg.one()
    assert api_drone_nonproj_dmg_stats.dps == [0, 0, approx(135.249975), 0]
    assert api_drone_nonproj_dmg_stats.volley == [0, 0, approx(540.999898), 0]
