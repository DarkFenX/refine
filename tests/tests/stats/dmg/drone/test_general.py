...
def test_state(client, consts):
    ...
    assert api_fleet_dmg_stats.dps == [0, approx(135.915), approx(198.645), 0]
    assert api_fleet_dmg_stats.volley == [0, approx(543.66), approx(794.58), 0]
    api_fit_dmg_stats = api_fit.get_stats(options=FitStatsOptions(dmg=True)).dmg.one()
    assert api_fit_dmg_stats.dps == [0, approx(135.915), approx(198.645), 0]
    assert api_fit_dmg_stats.volley == [0, approx(543.66), approx(794.58), 0]
    api_drone_dmg_stats = api_drone.get_stats(options=ItemStatsOptions(dmg=True)).dmg.one()
    assert api_drone_dmg_stats.dps == [0, approx(135.915), approx(198.645), 0]
    ...
    assert api_drone_dmg_ignored.dps == [0, approx(135.915), approx(198.645), 0]
    assert api_drone_dmg_ignored.volley == [0, approx(543.66), approx(794.58), 0]
    # Action
...
def test_stacking(client, consts):
    ...
    # Verification
    api_fleet_dmg_stats = api_fleet.get_stats(options=FleetStatsOptions(dmg=True)).dmg.one()
    assert api_fleet_dmg_stats.dps == [0, approx(271.83), approx(516.63), approx(174.42)]
    assert api_fleet_dmg_stats.volley == [0, approx(1087.32), approx(2066.52), approx(697.68)]
    api_fit1_dmg_stats = api_fit1.get_stats(options=FitStatsOptions(dmg=True)).dmg.one()
    assert api_fit1_dmg_stats.dps == [0, approx(135.915), approx(317.985), approx(174.42)]
    assert api_fit1_dmg_stats.volley == [0, approx(543.66), approx(1271.94), approx(697.68)]
    api_fit2_dmg_stats = api_fit2.get_stats(options=FitStatsOptions(dmg=True)).dmg.one()
    assert api_fit2_dmg_stats.dps == [0, approx(135.915), approx(198.645), 0]
    assert api_fit2_dmg_stats.volley == [0, approx(543.66), approx(794.58), 0]
...
def test_item_kind(client, consts):
    ...
    assert api_fleet_dmg_default.dps == [approx(101.184), approx(135.915), approx(198.645), 0]
    assert api_fleet_dmg_default.volley == [approx(404.736), approx(543.66), approx(794.58), 0]
    assert api_fleet_dmg_mobile.dps == [0, approx(135.915), approx(198.645), 0]
    assert api_fleet_dmg_mobile.volley == [0, approx(543.66), approx(794.58), 0]
    assert api_fleet_dmg_sentry.dps == [approx(101.184), 0, 0, 0]
    assert api_fleet_dmg_sentry.volley == [approx(404.736), 0, 0, 0]
    ...
    assert api_fit_dmg_default.dps == [approx(101.184), approx(135.915), approx(198.645), 0]
    assert api_fit_dmg_default.volley == [approx(404.736), approx(543.66), approx(794.58), 0]
    assert api_fit_dmg_mobile.dps == [0, approx(135.915), approx(198.645), 0]
    assert api_fit_dmg_mobile.volley == [0, approx(543.66), approx(794.58), 0]
    assert api_fit_dmg_sentry.dps == [approx(101.184), 0, 0, 0]
    assert api_fit_dmg_sentry.volley == [approx(404.736), 0, 0, 0]
...
def test_time(client, consts):
    ...
    assert api_fleet_dmg_stats.dps == [0, approx(543.66), approx(794.58), 0]
    assert api_fleet_dmg_stats.volley == [0, approx(543.66), approx(794.58), 0]
    api_fit_dmg_stats = api_fit.get_stats(options=FitStatsOptions(
        dmg=[StatsOptionFitDmg(time=StatTimeSim(time=1))])).dmg.one()
    assert api_fit_dmg_stats.dps == [0, approx(543.66), approx(794.58), 0]
    assert api_fit_dmg_stats.volley == [0, approx(543.66), approx(794.58), 0]
    api_drone_dmg_stats = api_drone.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(time=StatTimeSim(time=1))])).dmg.one()
    assert api_drone_dmg_stats.dps == [0, approx(543.66), approx(794.58), 0]
    assert api_drone_dmg_stats.volley == [0, approx(543.66), approx(794.58), 0]
    # Verification - sim with time before second hit
    api_fleet_dmg_stats = api_fleet.get_stats(options=FleetStatsOptions(
        dmg=[StatsOptionFitDmg(time=StatTimeSim(time=3))])).dmg.one()
    assert api_fleet_dmg_stats.dps == [0, approx(181.22), approx(264.86), 0]
    assert api_fleet_dmg_stats.volley == [0, approx(543.66), approx(794.58), 0]
    api_fit_dmg_stats = api_fit.get_stats(options=FitStatsOptions(
        dmg=[StatsOptionFitDmg(time=StatTimeSim(time=3))])).dmg.one()
    assert api_fit_dmg_stats.dps == [0, approx(181.22), approx(264.86), 0]
    assert api_fit_dmg_stats.volley == [0, approx(543.66), approx(794.58), 0]
    api_drone_dmg_stats = api_drone.get_stats(options=ItemStatsOptions(
        dmg=[StatsOptionItemDmg(time=StatTimeSim(time=3))])).dmg.one()
    assert api_drone_dmg_stats.dps == [0, approx(181.22), approx(264.86), 0]
    assert api_drone_dmg_stats.volley == [0, approx(543.66), approx(794.58), 0]
    # Verification - sim with time after second hit
    api_fleet_dmg_stats = api_fleet.get_stats(options=FleetStatsOptions(
        dmg=[StatsOptionFitDmg(time=StatTimeSim(time=5))])).dmg.one()
    assert api_fleet_dmg_stats.dps == [0, approx(217.464), approx(317.832), 0]
    assert api_fleet_dmg_stats.volley == [0, approx(543.66), approx(794.58), 0]
    api_fit_dmg_stats = api_fit.get_stats(options=FitStatsOptions(
        dmg=[StatsOptionFitDmg(time=StatTimeSim(time=5))])).dmg.one()
    assert api_fit_dmg_stats.dps == [0, approx(217.464), approx(317.832), 0]
    assert api_fit_dmg_stats.volley == [0, approx(543.66), approx(794.58), 0]
    api_drone_dmg_stats = api_drone.get_stats(options=ItemStatsOptions(
