...
def test_projection_range_and_resists(client, consts):
    ...
    assert api_tgt_ship_stats.incoming_jam.one() == [0, 0]
    # Action
    api_tgt_ship.change_ship(type_id=eve_tgt_ship4_id, coordinates=(0, 240220, 0))
...
def test_time(client, consts):
    eve_module_id, eve_src_struct_id, eve_tgt_ship1_id, eve_tgt_ship2_id, _, _ = setup_targeted_test(
