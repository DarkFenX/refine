...
def test_module_mjd(client, consts):
    # Most restrictions are checked in other test, see test_restrictions::test_mjd
...
def test_module_mjfg(client, consts):
    # Most restrictions are checked in other test, see test_restrictions::test_mjfg*
    eve_sig_radius_attr_id = client.mk_eve_attr(id_=consts.EveAttr.sig_radius)
    eve_sig_radius_bonus_attr_id = client.mk_eve_attr(id_=consts.EveAttr.sig_radius_bonus_percent)
