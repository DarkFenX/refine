...
def test_child_module(client, consts):
    ...
    eve_module1_id = client.mk_eve_item(grp_id=eve_grp_id, attrs={eve_affectee_attr_id: 7.5})
    eve_module2_id = client.mk_eve_item(grp_id=eve_grp_id, attrs={eve_affectee_attr_id: 5})
    ...
    # Verification
    assert api_module.update().attrs[eve_affectee_attr_id].modified == approx(25)
    # Action
