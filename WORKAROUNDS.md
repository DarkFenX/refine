...
- axum custom error messages are using relatively cumbersome [with_rejection recipe](https://github.com/tokio-rs/axum/blob/main/examples/customize-extractor-error/src/with_rejection.rs); change it to something more appropriate once [issue #1116](https://github.com/tokio-rs/axum/issues/1116) is implemented.
